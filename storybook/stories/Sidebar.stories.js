...
storiesOf('Sidebar', module)
  ...
  .add('no category', () => (
    <Sidebar
      menus={emptyMenus}
      categories={CATEGORIES_WITH_STAKING_COUNTDOWN}
  ...
  .add('wallets category', () => (
    <Sidebar
      menus={emptyMenus}
      categories={CATEGORIES_WITH_STAKING_COUNTDOWN}
      activeSidebarCategory={CATEGORIES_WITH_STAKING_COUNTDOWN[0].route}
      onCategoryClicked={action('onCategoryClicked')}
      isDialogOpen={() => false}
      onAddWallet={action('onAddWallet')}
      openDialogAction={action('openDialog')}
  ...
  .add('delegation category', () => (
    <Sidebar
      menus={emptyMenus}
      categories={CATEGORIES_WITH_STAKING_COUNTDOWN}
      activeSidebarCategory={CATEGORIES_WITH_STAKING_COUNTDOWN[1].route}
      onCategoryClicked={action('onCategoryClicked')}
      isDialogOpen={() => false}
      onAddWallet={action('onAddWallet')}
      openDialogAction={action('openDialog')}
  ...
  .add('delegation-progress', () => (
    <Sidebar
      menus={emptyMenus}
      categories={CATEGORIES_WITH_STAKING}
      activeSidebarCategory={CATEGORIES_WITH_STAKING[1].route}
      onCategoryClicked={action('onCategoryClicked')}
      isDialogOpen={() => false}
      onAddWallet={action('onAddWallet')}
      openDialogAction={action('openDialog')}
