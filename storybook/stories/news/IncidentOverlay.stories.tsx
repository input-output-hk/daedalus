...
export default {
  ...
  // The incident fixture reaches the stories as args, which is the first
  // argument a render function is given. It used to be handed to story() by the
  // decorator; Storybook merges such an update onto the story context instead,
  // so it never arrived at the argument these stories read.
  args: {
    action: {
      label: 'Read More',
