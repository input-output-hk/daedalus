...
The connector now has a disabled authenticated broker, base read executor, and complete byte-bound transaction review UI, but Daedalus still has no production dApp catalog/Diagnostics launch path or signing/submission execution.
