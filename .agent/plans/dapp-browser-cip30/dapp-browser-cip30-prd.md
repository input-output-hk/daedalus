...
The connector now has authenticated read, signing, submission, preferred-catalog, and Diagnostics launch paths, but Daedalus still has no release-approved preferred entry, hardware signing, CIP-103 execution, or collateral workflow.
