...
The connector now has authenticated read, software signing, product-disabled exact hardware transaction and data signing, submission, preferred-catalog, Diagnostics launch, and collateral execution/recovery paths, but Daedalus still lacks final physical hardware certification and product enablement, a release-approved preferred entry, and CIP-103 execution.
