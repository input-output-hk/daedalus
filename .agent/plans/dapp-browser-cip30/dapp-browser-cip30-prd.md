...
The connector now has authenticated read, signing, and submission paths plus the trusted preferred-catalog page, but Daedalus still has no release-approved preferred entry, Diagnostics launch path, hardware signing, CIP-103 execution, or collateral workflow.
