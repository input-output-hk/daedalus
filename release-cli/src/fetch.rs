...
//! writes a `version` file.  The SHA-256 from the Hydra API is verified
//! after each download.
...
fn human_size(_bytes: u64) -> String {
    // placeholder — Hydra doesn't always give filesize in the products JSON
    "streaming".to_string()
}
