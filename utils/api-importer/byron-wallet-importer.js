...
const names = ['Barry', 'Benny', 'Billy', 'Blake', 'Bob', 'Bowie', 'Boyd', 'Bruce', 'Bruno', 'Byron'];
...
(async () => {
    ...
    const shuffledMnemonics = (0, lodash_1.shuffle)(mnemonics_1.byronMnemonics);
...
//# sourceMappingURL=byron-wallet-importer.js.map