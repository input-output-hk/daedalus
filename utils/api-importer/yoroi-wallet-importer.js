...
const names = ['Yakov', 'Yanni', 'Yara', 'Yasmin', 'Yehoshua', 'Yolanda', 'Yoseba', 'Yoshito', 'Yulia', 'Yusef'];
...
(async () => {
    ...
    const shuffledMnemonics = (0, lodash_1.shuffle)(mnemonics_1.yoroiMnemonics);
...
//# sourceMappingURL=yoroi-wallet-importer.js.map