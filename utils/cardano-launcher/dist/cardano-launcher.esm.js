...
function setupService(cfgPromise, logger) {
  ...
  var events = new EventEmitter(); // What the current state is.

  var status = ServiceStatus.NotStarted; // Fulfilled promise of service command-line.
...
export { Launcher, ServiceStatus, cli, exitStatusMessage, serviceExitStatusMessage };
//# sourceMappingURL=cardano-launcher.esm.js.map
