      ...
      (buildEnv {
        ...
        in [
          ...
          (stub "yarn" ''
            ...
            mkdir -p dist release/darwin-aarch64/Daedalus-darwin-aarch64/Daedalus.app/Contents/MacOS
            touch release/darwin-x64/Daedalus-darwin-x64/Daedalus.app/Contents/MacOS/Daedalus
            touch release/darwin-aarch64/Daedalus-darwin-aarch64/Daedalus.app/Contents/MacOS/Daedalus
