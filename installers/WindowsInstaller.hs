...
signFile filename = do
  ...
  case maybePass of
    ...
    Just pass -> do
      ...
      -- Double sign a file, SHA1 for vista/xp and SHA2 for windows 8 and on
      procs "signtool.exe" ["sign", "/f", "C:\\eureka.p12", "/p", pack pass, "/t", "http://timestamp.comodoca.com", "/v", pack filename] mempty
      procs "signtool.exe" ["sign", "/f", "C:\\eureka.p12", "/p", pack pass, "/fd", "sha256", "/tr", "http://timestamp.comodoca.com/?td=sha256", "/td", "sha256", "/as", "/v", pack filename] mempty
