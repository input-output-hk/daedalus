...
npmPackage DarwinConfig{dcAppName} = do
  ...
  echo "Patching ..."
  procs "patch" ["-f", "-l", "./node_modules/usb/src/node_usb.cc", "./patches/usb/node_usb.cc.patch" ] empty
  procs "patch" ["-f", "-l", "./node_modules/usb/package.json", "./patches/usb/package.json.patch" ] empty
