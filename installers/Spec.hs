    ...
    it "Runs through the whole installer build" $ runManaged $ do
      ...
      liftIO $ do
        withDir installersDir $ do
          ...
          mktree "../release/darwin-aarch64/Daedalus-darwin-aarch64/Daedalus.app/Contents/Resources/app"
          writeFile "../release/darwin-x64/Daedalus-darwin-x64/Daedalus.app/Contents/Resources/app/package.json" "{}"
          writeFile "../release/darwin-aarch64/Daedalus-darwin-aarch64/Daedalus.app/Contents/Resources/app/package.json" "{}"
          Mac.main opts
