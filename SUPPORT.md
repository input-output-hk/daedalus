...
SE7EN Labs provides support for Daedalus users through the official Daedalus customer support platform and maintains the public GitHub repository for software development, issue tracking and community contribution.
...
GitHub Issues are intended for public software development and engineering work. They may be used for reproducible software defects, feature requests and other issues appropriate for public discussion.
...
A first maintainer response may include acknowledgement, a request for additional information, identification of a duplicate or confirmation that the issue has entered triage.

## Sensitive Information

Do not include wallet secrets, personal information or other sensitive information in a public GitHub issue.

Diagnostic files, screenshots and logs can sometimes contain information that should not be made public. If support staff need diagnostic information to investigate an individual case, provide it only through the designated customer support process.

## Resolution Times

SE7EN Labs does not establish a fixed resolution target for customer support cases or GitHub issues.

Resolution time depends on the nature of the issue, investigation requirements, technical complexity, upstream dependencies and release scheduling. Some fixes may require inclusion in a future Daedalus release.
