...
- "Loading" screen improvements:
  ...
  - Improved handling of "Invalid TLS certificate" error ([PR 1344](https://github.com/input-output-hk/daedalus/pull/1344))
...
- Code improvements:
  ...
  - Resolved `marked` dependency vulnerability ([PR 1414](https://github.com/input-output-hk/daedalus/pull/1414))
