...
- Improved the lock file mechanism UX when the user tries to launch a secondary Daedalus instance, focusing the second window before exiting it. ([PR 1226](https://github.com/input-output-hk/daedalus/pull/1226))
