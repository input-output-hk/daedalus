...
- Handled errors from a wallet which has ONLY rewards account balance when sending a transaction or delegating ([PR 2100](https://github.com/input-output-hk/daedalus/pull/2100), [PR 2111](https://github.com/input-output-hk/daedalus/pull/2111))
