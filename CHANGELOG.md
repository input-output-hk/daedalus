...
- Fixed naming of labels in Daedalus Diagnostics screen and status icons on Loading/Refresh screen from "Node ..." to "Cardano node..." ([PR 1723](https://github.com/input-output-hk/daedalus/pull/1723))
