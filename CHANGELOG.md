...
- Updated `cardano-wallet` to version `cardano-node-1.29.0-rc2` which includes `cardano-node` 1.29.0-rc2 ([PR 2650](https://github.com/input-output-hk/daedalus/pull/2650))
