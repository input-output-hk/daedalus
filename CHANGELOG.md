...
- Integrated cardano-wallet Api native tokens decimal places value ([PR 2573](https://github.com/input-output-hk/daedalus/pull/2573))
...
- Updated `cardano-wallet` to version `2021-05-26` ([PR 2573](https://github.com/input-output-hk/daedalus/pull/2573))
