...
import type { AllowedDownloadDirectories, DownloadState, DownloadEventType } from "../types/downloadManager.types";
...
export const DEFAULT_DIRECTORY_NAME = ALLOWED_DOWNLOAD_DIRECTORIES.STATE_DIRECTORY;
