...
export type DeviceEvent = "device-connect" | "device-connect_unacquired" | "device-disconnect" | "device-changed" | "device-acquire" | "device-release" | "device-acquired" | "device-released" | "device-used_elsewhere" | "device-loading" | "button" | "pin" | "passphrase" | "passphrase_on_device" | "word" | "device-wait_for_selection" | "unreadable-device";
...
export type LedgerSignTransactionOutputsType = [] | Array<LedgerOutputTypeAddress | LedgerOutputTypeChange>;
...
export type TrezorSignTransactionOutputsType = Array<TrezorOutputTypeAddress | TrezorOutputTypeChange>;
export type Witness = {
  path: BIP32Path;
