export type AllowedDownloadDirectories = "stateDirectory" | "downloads" | "desktop";
...
export type DownloadRequestOptions = {
  ...
  fileName?: string | ((...args: Array<any>) => any) | {
    name: string;
    ext: string;
  };
...
// https://www.npmjs.com/package/node-downloader-helper
export type DownloadState = "IDLE" | "SKIPPED" | "STARTED" | "DOWNLOADING" | "RETRY" | "PAUSED" | "RESUMED" | "STOPPED" | "FINISHED" | "FAILED";
export type DownloadEventType = "start" | "download" | "progress" | "end" | "timeout" | "stop" | "pause" | "error";
...
export type DownloadsLocalDataResponse = Record<string, DownloadLocalDataResponse>;
