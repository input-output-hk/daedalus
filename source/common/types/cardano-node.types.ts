...
export type NetworkNames = "mainnet" | "testnet" | "staging" | "shelley_qa" | "alonzo_purple" | "selfnode" | "development" | string;
...
export type CardanoNodeState = "starting" | "running" | "exiting" | "stopping" | "stopped" | "updating" | "updated" | "crashed" | "errored" | "unknown" | "unrecoverable";
...
export type CardanoPidOptions = "mainnet-PREVIOUS-CARDANO-PID" | "testnet-PREVIOUS-CARDANO-PID" | "staging-PREVIOUS-CARDANO-PID" | "shelley_qa-PREVIOUS-CARDANO-PID" | "alonzo_purple-PREVIOUS-CARDANO-PID" | "selfnode-PREVIOUS-CARDANO-PID" | "development-PREVIOUS-CARDANO-PID" | string;
export type CardanoNodeStorageKeys = {
  PREVIOUS_CARDANO_PID: CardanoPidOptions;
};
export type CardanoNodeProcessNames = "cardano-node" | "cardano-node.exe" | "local-cluster" | "local-cluster.exe";
export type ProcessNames = {
  CARDANO_PROCESS_NAME: CardanoNodeProcessNames;
};
export const CardanoProcessNameOptions: Record<CardanoNodeImplementations, {
