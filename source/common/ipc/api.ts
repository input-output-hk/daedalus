import type { BugReportRequestHttpOptions, BugReportRequestPayload } from "../types/bug-report-request.types";
...
import type { FileDialogRequestParams, OpenFileDialogResponseParams, SaveFileDialogResponseParams } from "../types/file-dialog.types";
...
import type { CardanoNodeState, CardanoStatus, FaultInjectionIpcRequest, TlsConfig } from "../types/cardano-node.types";
...
import type { MessageBody, StateSnapshotLogParams, WalletMigrationReportData } from "../types/logging.types";
import type { Locale } from "../types/locales.types";
import type { DownloadLocalDataRequest, DownloadLocalDataResponse, DownloadsLocalDataRequest, DownloadsLocalDataResponse, DownloadRequest, DownloadResponse, ResumeDownloadRequest, ResumeDownloadResponse, ClearDownloadLocalDataRequest, ClearDownloadLocalDataResponse, DeleteDownloadedFileRequest, DeleteDownloadedFileResponse, CheckFileExistsRequest } from "../types/downloadManager.types";
import type { StoreMessage } from "../types/electron-store.types";
import type { IntrospectAddressRequest, IntrospectAddressResponse } from "../types/address-introspection.types";
import type { HardwareWalletTransportDeviceRequest, HardwareWalletTransportDeviceResponse, HardwareWalletExtendedPublicKeyRequest, HardwareWalletExtendedPublicKeyResponse, HardwareWalletCardanoAdaAppResponse, LedgerSignTransactionRequest, LedgerSignTransactionResponse, TrezorSignTransactionRequest, TrezorSignTransactionResponse, HardwareWalletConnectionRequest } from "../types/hardware-wallets.types";
 ...
 */
export const GET_DESKTOP_DIRECTORY_PATH_CHANNEL = 'GetDesktopDirectoryPathChannel';
...
export type SetStateSnapshotLogRendererRequest = StateSnapshotLogParams | MessageBody;
...
export type GetCachedCardanoStatusMainResponse = CardanoStatus | null | undefined;
...
export type SetCachedCardanoStatusRendererRequest = CardanoStatus | null | undefined;
 ...
 */
export const GENERATE_WALLET_MIGRATION_REPORT_CHANNEL = 'GENERATE_WALLET_MIGRATION_REPORT_CHANNEL';
 ...
 */
export const ENABLE_APPLICATION_MENU_NAVIGATION_CHANNEL = 'ENABLE_APPLICATION_MENU_NAVIGATION_CHANNEL';
...
export const GET_INIT_LEDGER_CONNECT_CHANNEL = 'GET_INIT_LEDGER_CONNECT_CHANNEL';
