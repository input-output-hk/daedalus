...
const GET_APP_ENVIRONMENT_CHANNEL = 'get-app-environment';
export const GET_APP_ENVIRONMENT = {
  REQUEST: GET_APP_ENVIRONMENT_CHANNEL,
  SUCCESS: `${GET_APP_ENVIRONMENT_CHANNEL}-success`,
  ERROR: `${GET_APP_ENVIRONMENT_CHANNEL}-error`
};
