  ...
  render() {
    ...
    return <Fragment>
        ...
        <Provider stores={stores} actions={actions}>
          <ThemeProvider theme={daedalusTheme} skins={SimpleSkins} variables={SimpleDefaults} themeOverrides={themeOverrides}>
            <IntlProvider {...{
            locale,
            key: locale,
            messages: translations[locale]
              ...
              <Fragment>
                ...
                {mobxDevTools}
                {[isActiveDialog(ABOUT) && <AboutDialog key="aboutDialog" />, isActiveDialog(DAEDALUS_DIAGNOSTICS) && <DaedalusDiagnosticsDialog key="daedalusDiagnosticsDialog" />, <NotificationsContainer key="notificationsContainer" />]}
                {canShowNews && [<NewsFeedContainer key="newsFeedList" />, <NewsOverlayContainer key="newsFeedOverlay" />]}
              </Fragment>
            </IntlProvider>
          </ThemeProvider>
        </Provider>
