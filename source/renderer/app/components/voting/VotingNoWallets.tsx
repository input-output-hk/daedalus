...
const messages = defineMessages({
  headLine: {
    ...
    defaultMessage: '!!!Voting registration for Fund6 is not available as you currently do not have any Shelley-compatible wallets.',
    description: '"No wallets" headLine on the voting info page.'
  },
  instructions: {
    id: 'voting.info.noWallets.instructions',
    defaultMessage: '!!!Create a new wallet and transfer a minimum of {minVotingFunds} ADA (or restore an existing wallet with funds), then return here to register for voting.',
  ...
  createWalletButtonLabel: {
    ...
    description: 'Label for "Create New Wallet" button on the voting info page.'
  }
});
type Props = {
...
export default class VotingNoWallets extends Component<Props> {
  ...
  render() {
    ...
    return <div className={styles.component}>
        ...
        <Button className="primary" onClick={onGoToCreateWalletClick} label={intl.formatMessage(messages.createWalletButtonLabel)} skin={ButtonSkin} />
      </div>;
  }
