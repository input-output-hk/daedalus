...
const messages = defineMessages({
  ...
  content: {
    ...
    defaultMessage: '!!!Are you sure that you want to cancel Fund6 voting registration? The transaction fee you paid for the voting registration transaction will be lost and you will need to repeat the registration from the beginning.',
  ...
  cancelButtonLabel: {
    ...
    description: '"Cancel registration" button label for the voting registration cancellation confirmation dialog.'
  },
  confirmButtonLabel: {
    id: 'voting.votingRegistration.dialog.confirmation.button.confirmButtonLabel',
    defaultMessage: '!!!Continue registration',
    description: '"Continue registration" button label for the voting registration cancellation confirmation dialog.'
  }
});
type Props = {
...
class ConfirmationDialog extends Component<Props> {
  ...
  render() {
    ...
    return <Dialog className={dialogClasses} title={intl.formatMessage(messages.headline)} actions={actions} closeOnOverlayClick={false} onClose={onConfirm}>
