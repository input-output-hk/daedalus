...
import { VOTING_REGISTRATION_END_DATE, VOTING_REGISTRATION_CAST_START_DATE, VOTING_REGISTRATION_CAST_END_DATE, VOTING_REGISTRATION_NEW_START_DATE } from "../../config/votingConfig";
...
const messages = defineMessages({
  ...
  descriptionForEndedRegistration: {
    ...
    defaultMessage: '!!!<p>Voting registration for Project Catalyst Fund6 has been completed. The voting snapshot took place on <b>{snapshotDate}</b>.</p><p>If you have registered to vote on Fund6, you can cast your vote using the Catalyst Voting mobile app between <b>{castStartDate}</b> and <b>{castEndDate}</b>.</p><p>Fund6 registration will start on <b>{newRegistrationStartDate}</b>.</p>',
    description: 'Description for ended voting registration'
  },
  stepTitle1: {
    id: 'voting.info.stepTitle1',
    defaultMessage: '!!!Decide which innovative ideas for Cardano will receive funding.',
  ...
  learnMoreLinkUrlForEndedRegistration: {
    ...
    defaultMessage: '!!!https://iohk.zendesk.com/hc/en-us/articles/900006490763',
  ...
  bottomContentDescription: {
    ...
    defaultMessage: '!!!To register to vote for Catalyst Fund6 you first need to download the <b>Catalyst Voting</b> app on your Android or iOS smartphone.',
  ...
  bottomContentDescriptionForEndedRegistration: {
    ...
    defaultMessage: '!!!To cast your vote on Project Catalyst Fund6 proposals, you need to download the <b>Catalyst Voting</b> app on your Android or iOS smartphone.',
...
class VotingInfo extends Component<Props, State> {
  static contextTypes = {
  ...
  render() {
    ...
    const headingMessage = isRegistrationEnded ? messages.headingForEndedRegistration : messages.heading;
    const heading = intl.formatMessage(headingMessage);
    const learnMoreLinkLabelMessage = isRegistrationEnded ? messages.learnMoreLinkLabelForEndedRegistration : messages.learnMoreLinkLabel;
    const learnMoreLinkLabel = intl.formatMessage(learnMoreLinkLabelMessage);
    const learnMoreLinkUrlMessage = isRegistrationEnded ? messages.learnMoreLinkUrlForEndedRegistration : messages.learnMoreLinkUrl;
    ...
    const bottomContentDescription = isRegistrationEnded ? messages.bottomContentDescriptionForEndedRegistration : messages.bottomContentDescription;
    ...
    const castStartDate = formattedDateTime(VOTING_REGISTRATION_CAST_START_DATE, {
      currentLocale,
      currentDateFormat,
      currentTimeFormat
    });
    ...
    const newRegistrationStartDate = formattedDateTime(VOTING_REGISTRATION_NEW_START_DATE, {
      currentLocale,
      currentDateFormat,
      currentTimeFormat
    });
    return <div className={styles.component}>
        <BorderedBox>
          ...
          {isRegistrationEnded ? <div className={styles.descriptionForEndedRegistration}>
              <FormattedHTMLMessage {...messages.descriptionForEndedRegistration} values={{
            snapshotDate,
            castStartDate,
            castEndDate,
            newRegistrationStartDate
              ...
              <p className={styles.learnMoreContainer}>
                ...
                <Link label={learnMoreLinkLabel} onClick={() => onExternalLinkClick(learnMoreLinkUrl)} className={styles.learnMoreLink} />
              ...
              <Link label={learnMoreLinkLabel} onClick={() => onExternalLinkClick(learnMoreLinkUrl)} />
            </>}
          ...
          <div className={styles.bottomContent}>
            <div className={styles.leftContent}>
              ...
              {!isRegistrationEnded && <Checkbox label={checkboxLabel} onChange={this.handleIsAppInstalled} className={styles.checkbox} checked={isAppInstalled} />}
            </div>
            <div className={styles.rightContent}>
              <div className={styles.appStore}>
                <div className={styles.appStoreItem}>
                  <button className={styles.appStoreButton} onClick={() => {
          ...
          {!isRegistrationEnded && <Button onClick={onRegisterToVoteClick} label={buttonLabel} disabled={!isAppInstalled} />}
        </BorderedBox>
      </div>;
  }
