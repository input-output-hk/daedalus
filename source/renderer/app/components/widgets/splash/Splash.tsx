    ...
    return <div className={styles.component}>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.action}>
            <Button className={styles.actionButton} label={buttonLabel} onClick={onButtonClick} skin={ButtonSkin} />
          </div>
          {linkLabel && <Link className={styles.learnMoreLink} onClick={onLinkClick} label={linkLabel} skin={LinkSkin} />}
        </div>
      </div>;
  }
