...
const WalletTestEnvironmentLabel_scss_1 = __importDefault(
  require('./WalletTestEnvironmentLabel.scss')
);
...
class WalletTestEnvironmentLabel extends react_1.Component {
  static contextTypes = {
  ...
  render() {
    ...
    return react_1.default.createElement(
      'div',
      { className: WalletTestEnvironmentLabel_scss_1.default.component },
      intl.formatMessage(label)
    );
  }
}
exports.default = WalletTestEnvironmentLabel;
//# sourceMappingURL=WalletTestEnvironmentLabel.js.map
