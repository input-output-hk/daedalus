...
export default class NewsFeedIcon extends Component<Props> {
  render() {
    ...
    const componentClasses = classNames([styles.component, hasNotification && !hasUpdate ? styles.notificationDot : null, hasUpdate ? styles.updateDot : null, newsFeedIconClass]);
    return <button className={componentClasses} onClick={onNewsFeedIconClick}>
