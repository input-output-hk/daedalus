...
class RadioSet extends Component<Props> {
  render() {
    ...
    const radiosContainerStyles = classnames([styles.radiosContainer, verticallyAligned ? styles.verticallyAligned : null]);
    return <div className={styles.component}>
        ...
        <div className={radiosContainerStyles}>
          ...
          key,
          ...item
        }: RadioProps) => <Radio skin={RadioSkin} key={key} {...item} themeOverrides={stylesOverride} />)}
        </div>
      </div>;
  }
