...
export default class LoadingSpinner extends Component<Props> {
  ...
  render() {
    ...
    const componentClasses = classnames([styles.component, big ? styles.big : null, medium ? styles.medium : null, !big && !medium ? styles.small : null, className || null]);
    return <div className={componentClasses} ref={div => {
      this.root = div;
    }}>
