...
const TinySelect_scss_1 = __importDefault(require('./TinySelect.scss'));
class TinySelect extends react_1.Component {
  render() {
    return react_1.default.createElement(
      'div',
      { className: TinySelect_scss_1.default.component },
      react_1.default.createElement(Select_1.Select, {
        themeId: API_1.IDENTIFIERS.SELECT,
