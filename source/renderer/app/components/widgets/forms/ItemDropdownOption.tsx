...
export default class ItemDropdownOption extends Component<ItemDropdown> {
  ...
  renderSyncingSpinner = () => {
    ...
    const defaultSyncingLabel = typeof syncingProgress === 'number' || typeof syncingProgress === 'string' ? intl.formatMessage(messages.syncingLabelProgress, {
      syncingProgress
    ...
    return <div className={styles.syncingSpinner}>
