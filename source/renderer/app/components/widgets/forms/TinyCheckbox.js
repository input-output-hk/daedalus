...
const TinyCheckbox_scss_1 = __importDefault(require('./TinyCheckbox.scss'));
class TinyCheckbox extends react_1.Component {
  render() {
    return react_1.default.createElement(Checkbox_1.Checkbox, {
      className: TinyCheckbox_scss_1.default.component,
      themeId: API_1.IDENTIFIERS.CHECKBOX,
      skin: CheckboxSkin_1.CheckboxSkin,
      ...this.props,
    });
  }
}
exports.default = TinyCheckbox;
//# sourceMappingURL=TinyCheckbox.js.map
