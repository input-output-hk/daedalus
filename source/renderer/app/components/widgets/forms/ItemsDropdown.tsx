...
export const onSearchItemsDropdown = (searchValue: string, options: Array<any>) => {
...
export default class ItemsDropdown extends Component<ItemDropdownProps> {
  ...
  static defaultProps = {
    optionRenderer: (optionProps: ItemDropdown) => <ItemDropdownOption {...optionProps} />,
    selectionRenderer: (optionProps: ItemDropdown) => <ItemDropdownOption selected {...optionProps} />,
  ...
  render() {
    ...
    return <Select {...this.props} className={componentStyles} optionHeight={50} noResultsMessage={intl.formatMessage(globalMessages.searchNoResultsMessage)} />;
  }
