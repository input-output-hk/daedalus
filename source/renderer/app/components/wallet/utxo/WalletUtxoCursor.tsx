...
class WalletUtxoCursor extends Component<CursorProps> {
  render() {
    ...
    return <g transform={`translate(${x + calculatedWidth},${-OFFSET_TOP})`} className={styles.component}>
        <path d={`M 0.0,0 h ${offsetWidth || 0} v ${verticalPosition} h -${offsetWidth || 0} Z`} />
      </g>;
  }
