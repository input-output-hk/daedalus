...
class CompletionDialog extends Component<Props, State> {
  ...
  onShowCopyNotification = () => {
    ...
    this.copyNotificationTimeout = setTimeout(() => this.setState({
      showCopyNotification: false
    }), timeInSeconds);
  };
  ...
  render() {
    ...
    return <Dialog className={dialogClasses} title={intl.formatMessage(messages.headline)} actions={actions}>
        <div className={styles.completionContentWrapper}>
          ...
          <div className={styles.linkInstructionsWrapper}>
            ...
            <div className={styles.infoBox}>
              <Link className={styles.link} onClick={() => onOpenExternalLink(cardanoExplorerLink)} label={cardanoExplorerLink} skin={LinkSkin} />
            </div>
          </div>
          ...
          <div className={styles.addressInstructionsWrapper}>
            ...
            <div className={styles.infoBox}>
              {walletCertificateAddress}
              <CopyToClipboard text={walletCertificateAddress} onCopy={this.onShowCopyNotification}>
          ...
          <div className={styles.qrCode}>
            <QRCode value={walletCertificateAddress} bgColor={qrCodeBackgroundColor} fgColor={qrCodeForegroundColor} size={152} />
          </div>
        </div>
      </Dialog>;
  }
