    ...
    return <Dialog className={dialogClasses} title={intl.formatMessage(messages.headline)} actions={actions} onClose={onClose} closeButton={<DialogCloseButton />}>
        <div className={styles.securingPasswordContentWrapper}>
          <div className={styles.content}>
            ...
            <Checkbox className={styles.securingPasswordConfirmation} label={intl.formatMessage(messages.securingPasswordConfirmation, {
            paperWalletWrittenWordsCount: PAPER_WALLET_WRITTEN_WORDS_COUNT
          })} onChange={this.onSecurePasswordConfirmation} checked={securePasswordConfirmed} skin={CheckboxSkin} />
          </div>
        </div>
      </Dialog>;
  }
