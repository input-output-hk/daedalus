...
import { Autocomplete, Button, Input, Select } from 'react-polymorph/lib/components';
import { AutocompleteSkin, ButtonSkin, InputSkin, SelectSkin } from 'react-polymorph/lib/skins/simple';
    ...
    fields: {
      ...
      passPhrase: {
        ...
        placeholder: this.context.intl.formatMessage(messages.passphraseHint, {
          length: ADA_REDEMPTION_PASSPHRASE_LENGHT
        }),
        value: [],
        validators: [({ field }) => {
            ...
            {showPassPhraseWidget ? (
              <div className={styles.passPhrase}>
                <Autocomplete
                  ...
                  maxSelections={ADA_REDEMPTION_PASSPHRASE_LENGHT}
