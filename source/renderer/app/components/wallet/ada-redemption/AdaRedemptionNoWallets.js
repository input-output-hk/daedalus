...
const messages = defineMessages({
  headLine: {
    ...
    defaultMessage:
      "!!!Ada redemption is not available because you don't have any wallets.",
    description: '"No wallets" headLine on the Ada Redemption Page.',
  },
  instructions: {
    id: 'wallet.redeem.noWallets.instructions',
    defaultMessage:
      '!!!Create a new wallet (or restore an existing one), come back here and choose it for Ada redemption.',
  ...
  createWalletLink: {
    ...
    description:
      'URL for the "FAQ on Daedalus website" link in the FAQ section on the support settings page',
  },
});
