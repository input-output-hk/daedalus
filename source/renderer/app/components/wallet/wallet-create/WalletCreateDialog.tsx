...
export default class WalletCreateDialog extends Component<Props> {
  ...
  render() {
    ...
    return <Dialog className={styles.component} title={intl.formatMessage(messages.dialogTitle)} actions={actions} closeOnOverlayClick onClose={onClose} closeButton={<DialogCloseButton />}>
