...
const messages = defineMessages({
  ...
  createPersonalWallet: {
    ...
    description: 'Label for the "Create Shelley wallet" button on create wallet dialog.'
  },
...
class WalletCreateDialog extends Component<Props, State> {
  ...
  render() {
    ...
    const buttonLabel = !isSubmitting ? this.context.intl.formatMessage(messages.createPersonalWallet) : <LoadingSpinner />;
    const actions = [{
      disabled: !canSubmit,
      label: buttonLabel,
      primary: true,
    ...
    return <Dialog className={dialogClasses} title={intl.formatMessage(messages.dialogTitle)} actions={actions} closeOnOverlayClick onClose={!isSubmitting ? onCancel : () => {}} closeButton={<DialogCloseButton />}>
        <Input className="walletName" onKeyPress={this.handleSubmitOnEnter} ref={input => {
        this.walletNameInput = input;
      }} {...walletNameField.bind()} error={walletNameField.error} skin={InputSkin} />
