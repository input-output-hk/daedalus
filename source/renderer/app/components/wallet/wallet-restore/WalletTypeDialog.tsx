...
import { WALLET_KINDS, WALLET_DAEDALUS_KINDS, WALLET_YOROI_KINDS, WALLET_HARDWARE_KINDS } from "../../../config/walletRestoreConfig";
import type { WalletKinds, WalletKind, WalletDaedalusKind, WalletYoroiKind, WalletHardwareKind, HardwareWalletAcceptance } from "../../../types/walletRestoreTypes";
const messages = defineMessages({
  ...
  labelDaedalusWalletKind: {
    ...
    defaultMessage: '!!!What kind of Daedalus wallet would you like to restore?',
  ...
  labelDaedalusWalletKind15WordShelley: {
    ...
    defaultMessage: '!!!15 words <em>(Incentivized Testnet Rewards wallet)</em>',
    description: 'Label for the "labelDaedalusWalletKind15WordShelley" checkbox.'
  },
  labelDaedalusWalletKind24WordShelley: {
    ...
    description: 'Label for the "labelDaedalusWalletKind24WordShelley" checkbox.'
  },
  ...
  labelHardwareWalletKind: {
    ...
    defaultMessage: '!!!What kind of hardware wallet would you like to restore?',
  ...
  hardwareWalletDisclaimer1: {
    ...
    defaultMessage: '!!!Hardware wallets store your private keys securely on a physical device so they are immune to common computer threats such as viruses and software bugs. Recovery phrases for hardware wallets should always be kept offline. By entering your hardware wallet recovery phrase in Daedalus, you expose your hardware wallet private keys to the security risks associated with computers and software.',
  ...
  hardwareWalletDisclaimer2: {
    ...
    defaultMessage: '!!!All of your assets held on your hardware wallet device are associated with the same wallet recovery phrase and its corresponding private key. If you hold assets other than ada on your hardware wallet device, you expose all of those assets to security risks.',
  ...
  hardwareWalletDisclaimer3: {
    ...
    defaultMessage: '!!!We strongly recommend that you delete the Byron legacy wallet that was restored from your hardware wallet once you have moved funds into a Shelley wallet.',
  ...
  hardwareWalletCheckbox1: {
    ...
    defaultMessage: '!!!I understand and accept responsibility for the security concerns of restoring a hardware wallet on a computer.',
  ...
  hardwareWalletCheckbox2: {
    ...
    defaultMessage: '!!!I understand that I should delete the Byron legacy wallet I am restoring from a hardware wallet after moving funds to a Shelley wallet.',
  ...
  hardwareWalletCheckbox3: {
    ...
    defaultMessage: '!!!I understand that I am exposing all of the assets that are stored on my hardware wallet device, and not just ada, to security risks.',
    description: 'Label for the "hardwareWalletCheckbox2" disclaimer.'
  }
});
type Props = {
...
export default class WalletTypeDialog extends Component<Props, State> {
  ...
  toggleAcceptance = (param: HardwareWalletAcceptance) => this.setState(currentState => set({}, param, !currentState[param]));
  getWalletKind = (kinds: Record<string, any>, message: string, value: string | null | undefined, kindParam?: string) => <RadioSet label={this.context.intl.formatMessage(message)} items={Object.keys(kinds).map((key: string) => {
  ...
  get isDisabled() {
    ...
    if (walletKind === WALLET_KINDS.DAEDALUS && !walletKindDaedalus) return true;
    if (walletKind === WALLET_KINDS.YOROI && !walletKindYoroi) return true;
    return walletKind === WALLET_KINDS.HARDWARE && (!walletKindHardware || !hardwareWalletAcceptance1 || !hardwareWalletAcceptance2 || !hardwareWalletAcceptance3);
  }
  ...
  render() {
    ...
    return <WalletRestoreDialog stepNumber={0} actions={[{
      primary: true,
      ...
      disabled: this.isDisabled
        ...
        <div>
          {walletKind === WALLET_KINDS.DAEDALUS && this.getWalletKind(WALLET_DAEDALUS_KINDS, messages.labelDaedalusWalletKind, walletKindDaedalus, WALLET_KINDS.DAEDALUS)}
          {walletKind === WALLET_KINDS.YOROI && this.getWalletKind(WALLET_YOROI_KINDS, messages.labelYoroiWalletKind, walletKindYoroi, WALLET_KINDS.YOROI)}
          {walletKind === WALLET_KINDS.HARDWARE && <Fragment>
              {this.getWalletKind(WALLET_HARDWARE_KINDS, messages.labelHardwareWalletKind, walletKindHardware, WALLET_KINDS.HARDWARE)}
              ...
              <Checkbox className="walletSecurityRisk" label={intl.formatMessage(messages.hardwareWalletCheckbox3)} onChange={() => this.toggleAcceptance('hardwareWalletAcceptance3')} checked={hardwareWalletAcceptance3} skin={CheckboxSkin} />
              <Checkbox className="restoreSecurityNote" label={intl.formatMessage(messages.hardwareWalletCheckbox1)} onChange={() => this.toggleAcceptance('hardwareWalletAcceptance1')} checked={hardwareWalletAcceptance1} skin={CheckboxSkin} />
              <Checkbox className="walletDeleteNote" label={intl.formatMessage(messages.hardwareWalletCheckbox2)} onChange={() => this.toggleAcceptance('hardwareWalletAcceptance2')} checked={hardwareWalletAcceptance2} skin={CheckboxSkin} />
            </Fragment>}
        </div>
      </WalletRestoreDialog>;
  }
