...
class ConfigurationDialog extends Component<Props> {
  ...
  form = new ReactToolboxMobxForm({
    fields: {
      walletName: {
        ...
        placeholder: this.context.intl.formatMessage(messages.walletNamePlaceholder),
      ...
      spendingPassword: {
        ...
        placeholder: this.context.intl.formatMessage(messages.passwordFieldsPlaceholder),
  ...
  submit = () => {
    this.form.submit({
      ...
      onError: () => handleFormErrors('.ConfigurationDialog_error', {
        focusElement: true
      })
    });
  };
  ...
  render() {
    ...
    const repeatPasswordField = form.$('repeatPassword');
    const walletNameFieldClasses = classnames([styles.walletName, 'walletName']);
    ...
    return <WalletRestoreDialog className={styles.dialogComponent} stepNumber={2} actions={[{
          ...
          <div className={styles.spendingPasswordWrapper}>
            <div className={styles.spendingPasswordFields}>
              ...
              <div className={styles.spendingPasswordField}>
                <PasswordInput className="repeatPassword" onKeyPress={this.handleSubmitOnEnter} {...repeatPasswordField.bind()} repeatPassword={spendingPasswordField.value} isPasswordRepeat />
              </div>
            </div>
