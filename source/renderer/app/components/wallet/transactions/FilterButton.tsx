  ...
  render() {
    ...
    const buttonLabel = <>
        <div className={styles.actionLabel}>
          ...
          {numberOfFilterDimensionsApplied > 0 && <span className={styles.numberIndicator}>
              ({numberOfFilterDimensionsApplied})
            </span>}
        </div>
    ...
    return <div className={styles.component}>
        <TinyButton className={buttonClasses} label={buttonLabel} loading={false} onClick={onClick} disabled={disabled} />
      </div>;
  }
