...
const messages = defineMessages({
  resultInfo: {
    ...
    defaultMessage: '!!!<b>{filtered}</b> out of <b>{total}</b> transactions match your filter.',
...
class FilterResultInfo extends Component<Props> {
  render() {
    ...
    const resultInfo = <div className={styles.resultInfo}>
        <FormattedHTMLMessage {...messages.resultInfo} values={{
        filtered,
        total
      }} />
      </div>;
