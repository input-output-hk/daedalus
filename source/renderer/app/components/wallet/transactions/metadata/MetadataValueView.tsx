...
import type { MetadataBytes, MetadataInteger, MetadataList, MetadataMap, MetadataString, MetadataValue } from "../../../../types/TransactionMetadata";
...
function MapView({
  ...
  return <ol className={styles.map}>
