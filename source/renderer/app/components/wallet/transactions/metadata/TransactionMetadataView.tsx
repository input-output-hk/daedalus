...
import type { MetadataMapValue, MetadataValue, TransactionMetadata } from "../../../../types/TransactionMetadata";
...
export function TransactionMetadataView(props: {
  data: TransactionMetadata;
}) {
  return <div className={styles.root}>
      {Object.keys(props.data).map((key: string) => <pre key={key}>
