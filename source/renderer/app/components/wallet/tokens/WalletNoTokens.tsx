...
class WalletSummaryNoTokens extends Component<Props> {
  ...
  render() {
    ...
    const buttonClassNames = classnames([styles.noTokensLearnMoreLinkUrl, 'flat']);
    return <>
        {!isLoadingAssets && <div className={styles.numberOfAssets}>
          ...
          <BorderedBox>
            <div className={styles.noTokensContainer}>
              ...
              <div className={styles.noTokensRightContainer}>
                <ButtonLink className={buttonClassNames} label={intl.formatMessage(messages.learnMoreLinkLabel)} skin={ButtonSkin} onClick={() => onExternalLinkClick(intl.formatMessage(messages.learnMoreLinkUrl))} linkProps={{
                hasIconBefore: false,
                hasIconAfter: true
              }} />
              </div>
