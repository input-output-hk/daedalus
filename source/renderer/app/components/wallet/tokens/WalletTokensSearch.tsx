...
const WalletTokensSearch = observer((props: Props) => {
  ...
  return <div className={styles.component}>
      ...
      <Input className={styles.spendingPassword} onChange={onSearch} value={searchValue} placeholder={intl.formatMessage(messages.placeholder)} />
      {!!searchValue.length && <button className={classNames([styles.clearButton, 'flat'])} onClick={() => onSearch('')}>
