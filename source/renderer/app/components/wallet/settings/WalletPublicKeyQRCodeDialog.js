...
const WalletPublicKeyQRCodeDialog = (0, mobx_react_1.observer)((props) => {
  const {
    walletName,
    walletPublicKey,
  ...
  return react_1.default.createElement(
    ...
    react_1.default.createElement(
      ...
      react_1.default.createElement(
        PopOver_1.PopOver,
        { content: intl.formatMessage(messages.derivationPathTooltip) },
        react_1.default.createElement(
          'div',
...
exports.default = (0, react_intl_1.injectIntl)(WalletPublicKeyQRCodeDialog);
//# sourceMappingURL=WalletPublicKeyQRCodeDialog.js.map
