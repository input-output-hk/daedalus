...
export const messages: Record<string, ReactIntlMessage> = defineMessages({
  ...
  unpairWalletWarning: {
    ...
    defaultMessage: '!!!Once you unpair this wallet it will be removed from the Daedalus interface and you will lose access to any remaining funds in the wallet. The only way to regain access after deletion is by restoring it using your wallet recovery phrase.',
  ...
  return <>
        <BorderedBox className={styles.unpairWalletBox}>
          ...
          <div className={styles.contentBox}>
            ...
            <WalletSettingsRemoveButton label={label} onClick={React.useCallback(() => {
          onBlockForm();
          openDialogAction({
        ...
        {isDialogOpen(WalletSettingsActionConfirmationDialog) ? unpairWalletDialogContainer : false}
      </>;
});
