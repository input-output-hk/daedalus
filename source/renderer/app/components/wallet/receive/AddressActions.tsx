...
class AddressActions extends Component<Props> {
  ...
  render() {
    ...
    return <div className={componentClasses}>
        {type === 'copy' ? <CopyToClipboard text={addressId} onCopy={() => onCopyAddress(addressId)}>
          ...
          </CopyToClipboard> : <button className={styles.shareAddressButton} onClick={() => onShareAddress(address)}>
