...
import { WALLET_NAV_IDS, LEGACY_WALLET_EXCLUDED_NAV_ITEMS } from "../../../config/walletNavigationConfig";
import Navigation from "../../navigation/Navigation";
import type { NavButtonProps, NavDropdownProps } from "../../navigation/Navigation";
...
class WalletNavigation extends Component<Props> {
  ...
  render() {
    ...
    }].filter(item => !(isLegacy && includes(LEGACY_WALLET_EXCLUDED_NAV_ITEMS, item.id)));
    return <Navigation activeItem={activeItem} isActiveNavItem={isActiveNavItem} onNavItemClick={onNavItemClick} items={items} />;
  }
