...
export const messages = defineMessages({
  ...
  calculatingFeesLabel: {
    ...
    description: 'Label for the "Calculating fees" message above amount input field.'
  }
});
type Props = {
  currency: string;
...
export default class AmountInputSkin extends Component<Props> {
  ...
  render() {
    ...
    return <div className={styles.root}>
        ...
        {isCalculatingFees && <span className={styles.calculatingFees}>
            {intl.formatMessage(messages.calculatingFeesLabel)}
          </span>}
        {fees && !error && !isCalculatingFees && <span className={styles.fees}>
