...
class GeneralSettings extends Component<ProfileSettingsFormProps> {
  render() {
    ...
    return <ProfileSettingsForm onChangeItem={onChangeItem} currentLocale={currentLocale} currentNumberFormat={currentNumberFormat} currentDateFormat={currentDateFormat} currentTimeFormat={currentTimeFormat} error={error} />;
  }
