...
const messages = defineMessages({
  ...
  themeIncentivizedTestnet: {
    ...
    description: 'Name of the "Incentivized Testnet" theme on the display settings page.'
  },
  themeLightBlue: {
  ...
  themeFlightCandidate: {
    ...
    description: 'Name of the "Flight Candidate" theme on the display settings page.'
  },
  themeShelleyTestnet: {
    id: 'settings.display.themeNames.shelleyTestnet',
    defaultMessage: '!!!Shelley Testnet',
    description: 'Name of the "Shelley Testnet" theme on the display settings page.'
  },
  themeYellow: {
...
class DisplaySettings extends Component<Props> {
  ...
  render() {
    ...
    const themeIncentivizedTestnetClasses = classnames([theme === THEMES.INCENTIVIZED_TESTNET ? styles.active : styles.inactive, styles.themeImageWrapper]);
    const themeLightBlueClasses = classnames([theme === THEMES.LIGHT_BLUE ? styles.active : styles.inactive, styles.themeImageWrapper]);
    const themeCardanoClasses = classnames([theme === THEMES.CARDANO ? styles.active : styles.inactive, styles.themeImageWrapper]);
    const themeDarkBlueClasses = classnames([theme === THEMES.DARK_BLUE ? styles.active : styles.inactive, styles.themeImageWrapper]);
    const themeDarkCardanoClasses = classnames([theme === THEMES.DARK_CARDANO ? styles.active : styles.inactive, styles.themeImageWrapper]);
    const themeFlightCandidateClasses = classnames([theme === THEMES.FLIGHT_CANDIDATE ? styles.active : styles.inactive, styles.themeImageWrapper]);
    const themeShelleyTestnetClasses = classnames([theme === THEMES.SHELLEY_TESTNET ? styles.active : styles.inactive, styles.themeImageWrapper]);
    const themeYellowClasses = classnames([theme === THEMES.YELLOW ? styles.active : styles.inactive, styles.themeImageWrapper]);
    const themeWhiteClasses = classnames([theme === THEMES.WHITE ? styles.active : styles.inactive, styles.themeImageWrapper]);
    return <div className={styles.component}>
        ...
        <div className={styles.themesRowWrapper}>
          <button className={themeLightBlueClasses} onClick={selectTheme.bind(this, {
          ...
          <button className={themeCardanoClasses} onClick={selectTheme.bind(this, {
          ...
          <button className={themeWhiteClasses} onClick={selectTheme.bind(this, {
          theme: THEMES.WHITE
        })}>
            <img src={themeWhitePreview} role="presentation" draggable="false" />
            <span>{intl.formatMessage(messages.themeWhite)}</span>
          </button>
        </div>

        <div className={styles.themesRowWrapper}>
          <button className={themeDarkBlueClasses} onClick={selectTheme.bind(this, {
          ...
          <button className={themeDarkCardanoClasses} onClick={selectTheme.bind(this, {
          theme: THEMES.DARK_CARDANO
        })}>
            <img src={themeDarkCardanoPreview} role="presentation" draggable="false" />
            <span>{intl.formatMessage(messages.themeDarkCardano)}</span>
          </button>

          <button className={themeYellowClasses} onClick={selectTheme.bind(this, {
          theme: THEMES.YELLOW
        })}>
            <img src={themeYellowPreview} role="presentation" draggable="false" />
            <span>{intl.formatMessage(messages.themeYellow)}</span>
          </button>
        </div>

        <div className={styles.themesRowWrapper}>
          {isDev && <button className={themeIncentivizedTestnetClasses} onClick={selectTheme.bind(this, {
          theme: THEMES.INCENTIVIZED_TESTNET
        })}>
              <img src={themeIncentivizedTestnetPreview} role="presentation" draggable="false" />
              <span>
                {intl.formatMessage(messages.themeIncentivizedTestnet)}
              </span>
            </button>}

          {(isDev || isFlight) && <button className={themeFlightCandidateClasses} onClick={selectTheme.bind(this, {
          theme: THEMES.FLIGHT_CANDIDATE
        })}>
              <img src={themeFlightCandidatePreview} role="presentation" draggable="false" />
              <span>{intl.formatMessage(messages.themeFlightCandidate)}</span>
            </button>}

          {isDev && <button className={themeShelleyTestnetClasses} onClick={selectTheme.bind(this, {
          theme: THEMES.SHELLEY_TESTNET
        })}>
              <img src={themeShelleyTestnetPreview} role="presentation" draggable="false" />
