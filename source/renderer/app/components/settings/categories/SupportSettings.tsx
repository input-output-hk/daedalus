...
class SupportSettings extends Component<Props> {
  ...
  render() {
    ...
    const faqLink = <span className={styles.faqLink}>
        <Link className={styles.externalLink} onClick={event => onExternalLinkClick(faqLinkUrl, event)} label={intl.formatMessage(messages.faqLink)} skin={LinkSkin} />
      </span>;
    const downloadLogsClasses = classNames([styles.externalLink, disableDownloadLogs ? styles.disabled : null]);
    const stepsDownloadLogsLink = <Link className={downloadLogsClasses} onClick={onDownloadLogs} hasIconAfter={false} label={intl.formatMessage(messages.stepsDownloadLogsLink)} skin={LinkSkin} />;
    const reportProblemLink = <Link className={styles.externalLink} onClick={onSupportRequestClick} label={intl.formatMessage(messages.stepsReportProblemLink)} skin={LinkSkin} />;
    return <div className={styles.component}>
        ...
        <p>
          <FormattedMessage {...messages.faqContent} values={{
          faqLink
        }} />
        </p>
        ...
        <ol>
          <li>
            ...
            <p>
              <FormattedMessage {...messages.stepsDownloadLogsDescription} values={{
              stepsDownloadLogsLink
            }} />
            </p>
          </li>
          <li>
            ...
            <p>
              <FormattedMessage {...messages.stepsReportProblemDescription} values={{
              reportProblemLink
            }} />
            </p>
          </li>
