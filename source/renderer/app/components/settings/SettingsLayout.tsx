...
class SettingsLayout extends Component<Props> {
  ...
  componentDidMount() {
    this.scrollableDomElement = document.querySelector('.SettingsLayout_settingsPaneWrapper');
  }

  componentDidUpdate(prevProps: Props) {
    const didActivePageChange = this.props.activePage !== prevProps.activePage;

    if (this.scrollableDomElement instanceof HTMLElement && didActivePageChange) {
