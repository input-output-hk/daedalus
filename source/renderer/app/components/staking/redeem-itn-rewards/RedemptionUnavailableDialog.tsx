...
const messages = defineMessages({
  title: {
    ...
    description: 'Title for Redeem Incentivized Testnet - redemptionUnavailable'
  },
  closeButtonLabel: {
    id: 'staking.redeemItnRewards.redemptionUnavailable.closeButton.label',
    defaultMessage: '!!!Close',
    description: 'closeButtonLabel for Redeem Incentivized Testnet - redemptionUnavailable'
  }
});
type Props = {
...
class RedemptionUnavailableDialog extends Component<Props> {
  ...
  render() {
    ...
    return <Dialog title={intl.formatMessage(messages.title)} actions={[{
      className: 'primary',
      primary: true,
      label: intl.formatMessage(messages.closeButtonLabel),
      onClick: onClose
    }]} closeButton={closeButton} onClose={onClose} closeOnOverlayClick={false} fullSize>
