...
class StakingWithNavigation extends Component<Props> {
  ...
  render() {
    ...
    return <StakingPageScrollContext.Provider value={{
      scrollElementRef: this.stakingPageRef
    }}>
        <div className={componentStyles}>
          <div className={styles.navigation}>
            <StakingNavigation isActiveNavItem={isActiveNavItem} onNavItemClick={onNavItemClick} activeItem={activeItem} showInfoTab={showInfoTab} />
          </div>
