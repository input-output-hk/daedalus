...
const messages = defineMessages({
  ...
  percentage: {
    ...
    defaultMessage: '!!!Currently, {percentage}% of the blocks are produced by the stake pools.',
...
class StakingInfo extends Component<Props, State> {
  ...
  handleProgressLabelClassName = () => {
    const {
      current: progressComponent
    } = this.progressRef;
    const progressLabelClassName = progressComponent.clientWidth >= 50 ? styles.progressLabelWhite : styles.progressLabel;
    this.setState({
    ...
    return <div className={styles.component}>
        <div className={styles.mainContent}>
          ...
          <div className={styles.description}>
            <FormattedMessage {...messages.percentage} values={{
            percentage
          }} />
          </div>
          <div className={styles.progressBar}>
            <div className={styles.progressBarContainer}>
              <div className={styles.progress} ref={this.progressRef} style={{
              width: `${percentage}%`
            }}>
          ...
          {showLearnMoreButton && <ButtonLink className={styles.learnMoreButton} onClick={() => onLearnMoreClick(intl.formatMessage(messages.learnMoreLinkUrl))} skin={ButtonSkin} label={buttonLabel} linkProps={{
