  ...
  render() {
    ...
    return <div className={styles.component}>
        <div className={styles.mainContent}>
          ...
          <CountdownWidget startDateTime={startDateTime} redirectOnEnd={redirectToStakingInfo} />
          {showLearnMoreButton && <ButtonLink className={styles.learnMoreButton} onClick={onLearnMoreClick} skin={ButtonSkin} label={buttonLabel} linkProps={{
