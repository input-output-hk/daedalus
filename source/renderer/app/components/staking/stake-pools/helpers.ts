...
export const getFilteredStakePoolsList = (stakePoolsList: Array<StakePool>, search: string): Array<StakePool> => stakePoolsList.filter((stakePool: StakePool) => stakePoolsListSearch(stakePool, search));