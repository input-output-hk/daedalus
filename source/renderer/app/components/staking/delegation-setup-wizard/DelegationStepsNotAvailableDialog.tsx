...
const messages = defineMessages({
  ...
  closeButtonLabel: {
    ...
    description: 'Label for close button on the delegation setup not available dialog.'
  }
});
export default class DelegationStepsNotAvailableDialog extends Component<Props> {
  ...
  render() {
    ...
    const dialogClassName = classNames([commonStyles.delegationSteps, styles.delegationStepsNotAvailableDialogWrapper]);
