...
class StakingChartTooltip extends Component<Props> {
  ...
  render() {
    ...
    return <div className={styles.component}>
        ...
        <StakingChartTooltipItem key="transactions" label={intl.formatMessage(messages.transactions)} value={numberOfTransactions.toString()} />
        <StakingChartTooltipItem key="mpcPhase" label={intl.formatMessage(messages.mpcPhase)} value={mpcPhase} />
        <StakingChartTooltipItem key="commitments" label={intl.formatMessage(messages.commitments)} value={commitments} />
        <StakingChartTooltipItem key="openings" label={intl.formatMessage(messages.openings)} value={openings} />
        <StakingChartTooltipItem key="shares" label={intl.formatMessage(messages.shares)} value={shares} />
      </div>;
  }
