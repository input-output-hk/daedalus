    ...
    return <table>
        <thead>
          <tr>
            ...
            const sortIconClasses = classNames([styles.sortIcon, isSorted ? styles.sorted : null, isSorted && order === 'asc' ? styles.ascending : null]);
            return <th key={tableHeader.name} onClick={() => handleDataSort(tableHeader.name)}>
                  {tableHeader.title}
