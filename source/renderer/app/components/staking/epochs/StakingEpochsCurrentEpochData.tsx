...
import { getTableHeadersForCurrentEpoch, noDataExisting, hasDataExisting, sortData } from "./helpers";
...
class StakingEpochsCurrentEpochData extends Component<Props, State> {
  ...
  render() {
    ...
    if (hasData) {
      sortedData = sortData(currentEpochData, currentEpochDataOrder, currentEpochDataSortBy);
    }
    ...
    return <StakingEpochsDataTable tableHeaders={tableHeaders} tableBody={tableBody} order={currentEpochDataOrder} sortBy={currentEpochDataSortBy} handleDataSort={this.handleDataSort} />;
  }
