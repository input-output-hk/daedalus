...
export default class LogosDisplay extends Component<Props> {
  componentDidMount() {
    ...
    const svg: Record<string, any> = document.querySelector('.LogosDisplay_daedalusLogo svg');
  ...
  render() {
    ...
    const currencyLogoStyles = classNames([styles['ada-logo'], !isConnected ? styles.connectingLogo : styles.syncingLogo]);
    const daedalusLogoStyles = classNames([styles.daedalusLogo, !isConnected ? styles.connectingLogo : styles.syncingLogo]);
    const apiLogoStyles = classNames([styles['ada-apiLogo'], !isConnected ? styles.connectingLogo : styles.syncingLogo]);
