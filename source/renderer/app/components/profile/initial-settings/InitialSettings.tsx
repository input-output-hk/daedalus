  ...
  render() {
    ...
    return <div className={styles.component}>
        <div className={styles.centeredBox}>
          <ProfileSettingsForm onChangeItem={onChangeItem} onSubmit={onSubmit} currentLocale={currentLocale} currentNumberFormat={currentNumberFormat} currentDateFormat={currentDateFormat} currentTimeFormat={currentTimeFormat} error={error} />
        </div>
      </div>;
  }
