    ...
    >
      <IntlProvider locale={locale} messages={messages}>
        <DRepDirectory
          ...
          allDRepsRefreshState={allDRepsRefreshState}
...
describe('DRepDirectory', () => {
  ...
  it('renders exactly one category badge per card (snapshot)', () => {
    ...
    // baseEntries[0]: drepActivity 12, verifiedName null -> Threshold window edge.
    expect(
  ...
  describe('reroll and sentinel cards', () => {
    ...
    it('hides sentinel cards when search is active', () => {
      renderComponent({ suggestedDReps: [realEntry(1)] });
    ...
    it('hides sentinel cards in show-all mode', () => {
      renderComponent({ suggestedDReps: [realEntry(1)] });
