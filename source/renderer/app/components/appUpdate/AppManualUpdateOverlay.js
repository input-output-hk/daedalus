...
import styles from './AppManualUpdateOverlay.scss';
import ButtonLink from '../widgets/ButtonLink';

const messages = defineMessages({
  title: {
    id: 'appUpdate.manualUpdateOverlay.title',
    defaultMessage: '!!!Software update is available',
    description: 'Title for "Manual update" overlay',
  },
  descriptionLine1: {
    id: 'appUpdate.manualUpdateOverlay.description1',
    defaultMessage:
  ...
  descriptionLine2: {
    id: 'appUpdate.manualUpdateOverlay.description2',
    defaultMessage:
  ...
  manualUpdateButtonUrl: {
    id: 'appUpdate.manualUpdateOverlay.button.url',
    defaultMessage:
...
@observer
export default class AppManualUpdateOverlay extends Component<Props> {
  static contextTypes = {
