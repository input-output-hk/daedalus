  ...
  render() {
    ...
    return <div className={styles.container}>
        ...
        <div className={styles.headerWrapper}>
          ...
          <div className={styles.daedalusTitleVersion}>
            ...
            <div className={styles.daedalusBuildInfo}>
              <FormattedHTMLMessage {...messages.aboutBuildInfo} values={{
              platform: os,
              build,
              apiName,
              apiVersion,
        ...
        <div className={styles.footerWrapper}>
          <Link className={styles.link} onClick={() => onOpenExternalLink('https://daedaluswallet.io')} label="http://daedaluswallet.io" skin={LinkSkin} />

          <div className={styles.copyright}>
            {intl.formatMessage(messages.aboutCopyright)}&nbsp;
            <Link className={styles.link} onClick={() => onOpenExternalLink('https://github.com/input-output-hk/daedalus/blob/master/LICENSE')} label={intl.formatMessage(messages.licenseLink)} skin={LinkSkin} />
          </div>
        </div>
      </div>;
  }
