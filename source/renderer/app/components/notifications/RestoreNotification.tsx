...
const messages = defineMessages({
  activeRestoreMessage: {
    ...
    defaultMessage: '!!!The balance and transaction history of this wallet is {percentage}% synced with the blockchain.',
...
class RestoreNotification extends Component<Props> {
  ...
  render() {
    ...
    const restoreNotificationClasses = classnames([styles.component, 'ActiveRestoreNotification']);
    return <div className={restoreNotificationClasses}>
