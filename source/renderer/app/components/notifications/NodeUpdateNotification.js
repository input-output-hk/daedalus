...
const messages = defineMessages({
  acceptLabel: {
    ...
    description:
      'Label "Update and restart" on the Cardano node update notification.',
  },
  denyLabel: {
    id: 'cardano.node.update.notification.postpone.button.label',
    defaultMessage: '!!!Postpone until restart',
    description:
      'Label "Postpone until restart" on the Cardano node update notification.',
  },
  titleWithVersion: {
  ...
  updateMessage: {
    ...
    defaultMessage:
      '!!!Daedalus and Cardano node update is available. Would you like to install the update?',
    description:
      'Message shown when there is a Daedalus and Cardano node update available.',
  },
});
    ...
    return (
      <div className={styles.component}>
        <div className={styles.titleBar}>
          ...
          <button onClick={onToggleExpanded} className={styles.toggleButton}>
