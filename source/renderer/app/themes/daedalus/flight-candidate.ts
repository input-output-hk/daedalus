...
export const FLIGHT_CANDIDATE_THEME_OUTPUT = {
  ...
  newsItem: {
    ...
    '--theme-news-item-announcement-background-color': 'rgba(255, 185, 35, 0.2)',
  ...
  paperWallet: {
    '--theme-paper-wallet-create-certificate-dialog-explorer-link-color': '#ffb923',
  ...
  progressBar: {
    ...
    '--theme-progress-bar-large-progress-light-stripe-2-background-color': '#ffc64d'
  },
  receiveQRCode: {
  ...
  stakePools: {
    ...
    '--theme-staking-stake-pool-tooltip-delegate-button-background-color': '#ffb923',
    '--theme-staking-stake-pool-tooltip-delegate-button-hover-background-color': '#ffc64d',
    '--theme-staking-stake-pool-tooltip-delegate-button-active-background-color': '#e6a009',
  ...
  transactions: {
    ...
    '--theme-transactions-filter-button-shadow-color': 'rgba(255, 185, 35, 0.18)',
