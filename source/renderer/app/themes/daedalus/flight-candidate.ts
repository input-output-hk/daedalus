...
export const FLIGHT_CANDIDATE_THEME_OUTPUT = {
  ...
  mithrilBootstrap: {
    ...
    '--theme-mithril-button-primary-background': '#ffb923',
    '--theme-mithril-button-primary-background-hover': '#ffca50',
    '--theme-mithril-button-primary-text-color': '#1a1300',
    ...
    '--theme-mithril-link-color': 'rgba(255, 200, 80, 0.96)',
    '--theme-mithril-link-color-hover': 'rgba(255, 220, 120, 0.98)',
  ...
  progressBar: {
    ...
    '--theme-progress-bar-large-progress-light-stripe-1': '#e6a009',
  ...
  rpAutocomplete: {
    ...
    '--rp-autocomplete-selected-word-dialog-box-bg-color': '#ffb923',
  ...
  chainStorage: {
    ...
    '--theme-chain-storage-button-primary-background': '#ffb923',
    '--theme-chain-storage-button-primary-background-hover': '#ffca50',
    '--theme-chain-storage-button-primary-text-color': '#1a1300',
