...
export const LIGHT_BLUE_THEME_OUTPUT = {
  ...
  mithrilBootstrap: {
    ...
    '--theme-mithril-panel-background': 'rgba(10, 44, 83, 0.6)',
    '--theme-mithril-panel-border-color': 'rgba(46, 80, 119, 0.6)',
    '--theme-mithril-context-panel-background': 'rgba(10, 44, 83, 0.42)',
    ...
    '--theme-mithril-button-secondary-border-color': 'rgba(68, 102, 141, 0.6)',
    ...
    '--theme-mithril-step-icon-pending-background': 'rgba(68, 102, 141, 0.35)',
    '--theme-mithril-step-connector-color': 'rgba(68, 102, 141, 0.22)',
    ...
    '--theme-mithril-sub-item-pending-background': 'rgba(68, 102, 141, 0.3)',
    '--theme-mithril-progress-track-color': 'rgba(68, 102, 141, 0.2)',
    '--theme-mithril-progress-complete-color': 'rgba(30, 164, 126, 0.7)',
    '--theme-mithril-progress-meta-color': 'rgba(100, 134, 173, 0.75)',
    '--theme-mithril-scrollbar-thumb-color': 'rgba(68, 102, 141, 0.5)',
    '--theme-mithril-scrollbar-thumb-color-hover': 'rgba(88, 122, 161, 0.7)',
    '--theme-mithril-selector-background': 'rgba(22, 56, 95, 0.9)',
    '--theme-mithril-selector-option-background': 'rgba(34, 68, 107, 0.96)',
    '--theme-mithril-selector-border-color': 'rgba(68, 102, 141, 0.6)',
    '--theme-mithril-selector-button-background': 'rgba(34, 68, 107, 0.95)',
  ...
  governance: {
    '--theme-gov-content-background-color': '#fafbfc',
    '--theme-gov-content-border-color': '#c6cdd6',
  ...
  chainStorage: {
    ...
    '--theme-chain-storage-panel-background': 'rgba(10, 44, 83, 0.6)',
    '--theme-chain-storage-panel-border-color': 'rgba(46, 80, 119, 0.6)',
