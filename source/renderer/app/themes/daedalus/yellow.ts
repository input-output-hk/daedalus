...
export const YELLOW_THEME_OUTPUT = {
  ...
  mithrilBootstrap: {
    ...
    '--theme-mithril-body-text-color': 'rgba(75, 75, 72, 0.9)',
    '--theme-mithril-secondary-text-color': 'rgba(105, 105, 100, 0.9)',
    '--theme-mithril-bright-text-color': 'rgba(40, 40, 38, 0.95)',
    '--theme-mithril-detail-label-color': 'rgba(115, 115, 110, 0.85)',
    '--theme-mithril-panel-background': 'rgba(230, 225, 218, 0.6)',
    '--theme-mithril-panel-border-color': 'rgba(195, 190, 182, 0.6)',
    '--theme-mithril-context-panel-background': 'rgba(230, 225, 218, 0.42)',
    '--theme-mithril-button-primary-background': '#2d2d2d',
    '--theme-mithril-button-primary-background-hover': '#3d3d3d',
    '--theme-mithril-button-primary-text-color': '#ffffff',
    '--theme-mithril-button-secondary-border-color': 'rgba(150, 148, 142, 0.6)',
    '--theme-mithril-button-secondary-border-color-hover':
      'rgba(120, 118, 112, 0.9)',
    '--theme-mithril-button-secondary-text-color': 'rgba(55, 55, 55, 0.92)',
    '--theme-mithril-button-secondary-text-color-hover':
      'rgba(30, 30, 30, 0.98)',
    '--theme-mithril-link-color': 'rgba(160, 100, 20, 0.96)',
    '--theme-mithril-link-color-hover': 'rgba(130, 80, 10, 0.98)',
    '--theme-mithril-completion-title-color': 'rgba(30, 30, 30, 0.98)',
    '--theme-mithril-completion-detail-color': 'rgba(80, 78, 72, 0.92)',
    '--theme-mithril-step-active-label-color': 'rgba(40, 40, 38, 0.98)',
    '--theme-mithril-step-pending-label-color': 'rgba(125, 125, 120, 0.75)',
    ...
    '--theme-mithril-step-icon-spinner-color': 'rgba(55, 55, 55, 0.92)',
    '--theme-mithril-step-icon-pending-background': 'rgba(175, 173, 165, 0.35)',
    '--theme-mithril-step-connector-color': 'rgba(175, 173, 165, 0.22)',
    ...
    '--theme-mithril-sub-item-active-color': 'rgba(50, 50, 48, 0.9)',
    '--theme-mithril-sub-item-pending-color': 'rgba(125, 125, 120, 0.72)',
    '--theme-mithril-sub-item-completed-color': 'rgba(75, 140, 115, 0.8)',
    '--theme-mithril-sub-item-error-color': 'rgba(200, 50, 50, 0.85)',
    '--theme-mithril-sub-item-icon-success-color': 'rgba(30, 164, 126, 0.8)',
    '--theme-mithril-sub-item-icon-spinner-color': 'rgba(50, 50, 48, 0.88)',
    '--theme-mithril-sub-item-icon-error-color': 'rgba(200, 50, 50, 0.88)',
    '--theme-mithril-sub-item-pending-background': 'rgba(175, 173, 165, 0.3)',
    '--theme-mithril-progress-track-color': 'rgba(175, 173, 165, 0.2)',
    '--theme-mithril-progress-complete-color': 'rgba(30, 164, 126, 0.7)',
    '--theme-mithril-progress-meta-color': 'rgba(115, 115, 110, 0.75)',
    '--theme-mithril-scrollbar-thumb-color': 'rgba(175, 173, 165, 0.5)',
    '--theme-mithril-scrollbar-thumb-color-hover': 'rgba(145, 143, 135, 0.7)',
    '--theme-mithril-selector-background': 'rgba(238, 233, 225, 0.9)',
    '--theme-mithril-selector-option-background': 'rgba(248, 245, 239, 0.96)',
    '--theme-mithril-selector-border-color': 'rgba(175, 173, 165, 0.6)',
    '--theme-mithril-selector-button-background': 'rgba(238, 233, 225, 0.95)',
    '--theme-mithril-selector-button-background-hover':
      'rgba(228, 223, 215, 0.98)',
    '--theme-mithril-icon-color': 'rgba(40, 40, 38, 0.95)',
  ...
  governance: {
    ...
    '--theme-gov-content-border-color': '#e1dac6',
    ...
    '--theme-gov-search-icon-color': '#2d2d2d',
    '--theme-gov-search-clear-button-color': '#2d2d2d',
    '--theme-gov-search-clear-button-background-color': '#2d2d2d0d',
    '--theme-gov-search-clear-button-hover-background-color': '#2d2d2d1a',
  ...
  chainStorage: {
    ...
    '--theme-chain-storage-body-text-color': 'rgba(75, 75, 72, 0.9)',
    '--theme-chain-storage-secondary-text-color': 'rgba(105, 105, 100, 0.9)',
    '--theme-chain-storage-bright-text-color': 'rgba(40, 40, 38, 0.95)',
    '--theme-chain-storage-card-text-color': 'rgba(55, 55, 55, 0.92)',
    '--theme-chain-storage-panel-background': 'rgba(230, 225, 218, 0.6)',
    '--theme-chain-storage-panel-border-color': 'rgba(195, 190, 182, 0.6)',
    '--theme-chain-storage-button-primary-background': '#2d2d2d',
    '--theme-chain-storage-button-primary-background-hover': '#3d3d3d',
    ...
    '--theme-chain-storage-selector-button-background':
      'rgba(238, 233, 225, 0.95)',
    '--theme-chain-storage-selector-button-background-hover':
      'rgba(228, 223, 215, 0.98)',
    '--theme-chain-storage-icon-color': 'rgba(40, 40, 38, 0.95)',
