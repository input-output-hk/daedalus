...
export const YELLOW_THEME_OUTPUT = {
  ...
  appUpdate: {
    ...
    '--theme-node-update-deny-button-background-color-hover': 'rgba(45, 45, 45, 0.6)',
    '--theme-node-update-deny-button-background-color-active': 'rgba(45, 45, 45, 0.8)',
  ...
  automaticUpdate: {
    '--theme-automatic-update-overlay-background-color': 'rgba(255, 185, 35, 0.96)',
    ...
    '--theme-automatic-update-overlay-text-highlight-color': 'rgba(45, 45, 45, 1)',
  ...
  buttonFlatInvert: {
    ...
    '--theme-button-flat-invert-background-color-hover': 'rgba(45, 45, 45, 0.3)',
    '--theme-button-flat-invert-background-color-active': 'rgba(45, 45, 45, 0.4)',
  ...
  buttonPrimaryInvert: {
    ...
    '--theme-button-primary-invert-background-color-hover': 'rgba(45, 45, 45, 0.9)',
    '--theme-button-primary-invert-background-color-active': 'rgba(45, 45, 45, 0.8)',
  ...
  delegationSetupWizard: {
    ...
    '--theme-delegation-steps-choose-stake-pool-checkmark-icon-color': '#e1dac6',
    ...
    '--theme-delegation-steps-choose-stake-pool-select-box-placeholder-color': '#e1dac6',
  ...
  network: {
    ...
    '--theme-network-window-button-background-color-hover': 'rgba(45, 45, 45, 0.6)',
    '--theme-network-window-button-background-color-active': 'rgba(45, 45, 45, 0.8)'
  },
  newsFeed: {
    ...
    '--theme-news-feed-incident-overlay-background-color': 'rgba(255, 185, 35, 0.98)',
  ...
  newsItem: {
    ...
    '--theme-news-item-announcement-background-color': 'rgba(31, 193, 195, 0.3)',
  ...
  newsUpdateOverlay: {
    ...
    '--theme-news-overlay-update-content-scroll-background-color': 'rgba(45, 45, 45, 0.3)',
    '--theme-news-overlay-update-content-scroll-hover-background-color': 'rgba(45, 45, 45, 0.5)',
  ...
  notification: {
    ...
    '--theme-legacy-notification-learn-more-button-background-color': '#f8f3ed33',
    '--theme-legacy-notification-learn-more-button-background-color-hover': '#f8f3ed4d',
    '--theme-legacy-notification-learn-more-button-background-color-active': '#f8f3ed66',
  ...
  paperWallet: {
    '--theme-paper-wallet-create-certificate-dialog-explorer-link-color': '#d6902f',
    '--theme-paper-wallet-create-certificate-dialog-explorer-link-background-color': 'rgba(45, 45, 45, 0.07)'
  },
  progressBar: {
    ...
    '--theme-progress-bar-large-progress-light-stripe-2-background-color': '#2d2d2d'
  },
  receiveQRCode: {
  ...
  settings: {
    ...
    '--theme-settings-delete-button-legacy-background-color': 'rgba(45, 45, 45, 0.1)',
  ...
  stakePools: {
    ...
    '--theme-staking-stake-pool-tooltip-delegate-button-background-color': '#2d2d2d',
    '--theme-staking-stake-pool-tooltip-delegate-button-hover-background-color': '#575757',
    '--theme-staking-stake-pool-tooltip-delegate-button-active-background-color': '#282828',
    ...
    '--theme-staking-stake-pools-search-clear-button-background-color': 'rgba(45, 45, 45, 0.1)',
    '--theme-staking-stake-pools-search-clear-button-color': '#2d2d2d',
    '--theme-staking-stake-pools-search-clear-button-hover-background-color': 'rgba(45, 45, 45, 0.05)',
  ...
  staking: {
    ...
    '--theme-staking-countdown-widget-background-color': 'rgba(45, 45, 45, 0.07)',
  ...
  transactions: {
    ...
    '--theme-transactions-date-picker-button-background-color': 'rgba(45, 45, 45, 0.14)',
    '--theme-transactions-date-picker-button-background-color-hover': 'rgba(45, 45, 45, 0.07)',
    ...
    '--theme-transactions-filter-title-button-background-color': 'rgba(45, 45, 45, 0.1)',
    '--theme-transactions-filter-title-button-background-color-hover': 'rgba(45, 45, 45, 0.05)',
    '--theme-transactions-filter-title-button-background-color-active': 'rgba(45, 45, 45, 0.12)',
  ...
  tokens: {
    ...
    '--theme-tokens-list-header-expanded-background-color': 'rgba(45, 45, 45, 0.05)',
    '--theme-tokens-list-header-expanded-background-color-hover': 'rgba(45, 45, 45, 0.03)'
  },
  uploader: {
