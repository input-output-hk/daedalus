...
export const DARK_BLUE_THEME_OUTPUT = {
  ...
  analytics: {
    '--theme-analytics-toc-details-background': 'rgba(233, 244, 254, 0.05)',
  },
  appUpdate: {
  ...
  mithrilBootstrap: {
    '--theme-mithril-overlay-backdrop-start': 'rgba(24, 37, 55, 1)',
    '--theme-mithril-overlay-backdrop-end': 'rgba(34, 47, 65, 1)',
    '--theme-mithril-card-background': 'rgba(30, 43, 61, 1)',
    ...
    '--theme-mithril-panel-background': 'rgba(20, 33, 51, 0.6)',
    '--theme-mithril-panel-border-color': 'rgba(56, 69, 87, 0.6)',
    '--theme-mithril-context-panel-background': 'rgba(20, 33, 51, 0.42)',
    '--theme-mithril-button-primary-background': '#536370',
    '--theme-mithril-button-primary-background-hover': '#647480',
    '--theme-mithril-button-primary-text-color': '#ffffff',
    '--theme-mithril-button-secondary-border-color': 'rgba(78, 91, 109, 0.6)',
    ...
    '--theme-mithril-link-color': 'rgba(120, 160, 190, 0.96)',
    '--theme-mithril-link-color-hover': 'rgba(150, 185, 210, 0.98)',
    ...
    '--theme-mithril-step-icon-pending-background': 'rgba(78, 91, 109, 0.35)',
    '--theme-mithril-step-connector-color': 'rgba(78, 91, 109, 0.22)',
    ...
    '--theme-mithril-sub-item-pending-background': 'rgba(78, 91, 109, 0.3)',
    '--theme-mithril-progress-track-color': 'rgba(78, 91, 109, 0.2)',
    '--theme-mithril-progress-complete-color': 'rgba(30, 164, 126, 0.7)',
    '--theme-mithril-progress-meta-color': 'rgba(120, 133, 151, 0.75)',
    '--theme-mithril-scrollbar-thumb-color': 'rgba(78, 91, 109, 0.5)',
    '--theme-mithril-scrollbar-thumb-color-hover': 'rgba(98, 111, 129, 0.7)',
    '--theme-mithril-selector-background': 'rgba(32, 45, 63, 0.9)',
    '--theme-mithril-selector-option-background': 'rgba(44, 57, 75, 0.96)',
    '--theme-mithril-selector-border-color': 'rgba(78, 91, 109, 0.6)',
    '--theme-mithril-selector-button-background': 'rgba(44, 57, 75, 0.95)',
  ...
  governance: {
    '--theme-gov-content-background-color': '#263345',
    '--theme-gov-content-border-color': '#263345',
    '--theme-gov-font-color-accent': '#cecfd1',
    '--theme-gov-font-color-regular': '#cecfd1',
    '--theme-gov-font-color-light': 'rgba(233, 244, 254, 0.7)',
    '--theme-gov-font-color-lighter': 'rgba(233, 244, 254, 0.5)',
    '--theme-gov-search-icon-color': '#e9f4fe',
    '--theme-gov-search-clear-button-color': '#e9f4fe',
    '--theme-gov-search-clear-button-background-color': '#e9f4fe0d',
    '--theme-gov-search-clear-button-hover-background-color': '#e9f4fe1a',
    '--theme-gov-badge-neutral-background': '#e9f4fe14',
    '--theme-gov-badge-neutral-color': '#e9f4fef2',
  ...
  widgets: {
    ...
    '--theme-widgets-separator-color': 'rgba(233, 244, 254, 0.15)',
  ...
  chainStorage: {
    ...
    '--theme-chain-storage-panel-background': 'rgba(20, 33, 51, 0.6)',
    '--theme-chain-storage-panel-border-color': 'rgba(56, 69, 87, 0.6)',
    '--theme-chain-storage-button-primary-background': '#536370',
    '--theme-chain-storage-button-primary-background-hover': '#647480',
