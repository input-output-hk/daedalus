...
export const DARK_BLUE_THEME_OUTPUT = {
  ...
  mithrilBootstrap: {
    '--theme-mithril-overlay-backdrop-start': 'rgba(24, 37, 55, 0.92)',
    '--theme-mithril-overlay-backdrop-end': 'rgba(34, 47, 65, 0.92)',
    '--theme-mithril-card-background': 'rgba(30, 43, 61, 0.96)',
