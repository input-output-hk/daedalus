...
export const DARK_BLUE_THEME_OUTPUT = {
  ...
  appUpdateOverlay: {
    ...
    '--theme-app-update-overlay-button-label-color-hover': 'rgba(38, 51, 69, 1)',
  ...
  automaticUpdate: {
    ...
    '--theme-automatic-update-overlay-button-background-color': 'rgba(0, 0, 0, 0.1)',
    ...
    '--theme-automatic-update-overlay-button-icon-color-hover': 'rgba(38, 51, 69, 1)',
    '--theme-automatic-update-overlay-button-label-color-hover': 'rgba(38, 51, 69, 1)',
  ...
  buttonFlatInvert: {
    ...
    '--theme-button-flat-invert-background-color-hover': 'rgba(233, 244, 254, 0.3)',
    '--theme-button-flat-invert-background-color-active': 'rgba(233, 244, 254, 0.4)',
  ...
  buttonPrimaryInvert: {
    ...
    '--theme-button-primary-invert-background-color-hover': 'rgba(233, 244, 254, 0.9)',
    '--theme-button-primary-invert-background-color-active': 'rgba(233, 244, 254, 0.8)',
  ...
  dapps: {
    ...
    '--theme-dapp-transaction-request-toggle-button-background-color': 'rgba(233, 244, 254, 0.1)',
    '--theme-dapp-transaction-request-code-background-color': 'rgba(233, 244, 254, 0.05)'
  },
  dataMigration: {
  ...
  delegationSetupWizard: {
    ...
    '--theme-delegation-steps-choose-stake-pool-delegated-pools-label-color': 'rgba(233, 244, 254, 1)',
    '--theme-delegation-steps-choose-stake-pool-select-box-placeholder-color': '#9eabbb',
    '--theme-delegation-steps-choose-stake-pool-selected-checkmark-icon-color': '#fafbfc',
    ...
    '--theme-delegation-steps-choose-stake-pool-thumb-background-color': '#263345',
    '--theme-delegation-steps-choose-stake-pool-thumb-border-color': 'rgba(102, 122, 138, 0.2)',
    '--theme-delegation-steps-choose-stake-pool-title-color': 'rgba(233, 244, 254, 1)',
    '--theme-delegation-steps-choose-stake-pool-tooltip-arrow-color': 'rgba(94, 96, 102, 0.9)',
    '--theme-delegation-steps-choose-stake-pool-tooltip-background-color': 'rgba(94, 96, 102, 0.9)',
    '--theme-delegation-steps-choose-stake-pool-tooltip-box-shadow': '0 5px 20px 0 rgba(0, 0, 0, 0.25)',
    '--theme-delegation-steps-choose-stake-pool-tooltip-description-color': 'rgba(250, 251, 252, 1)',
    '--theme-delegation-steps-choose-stake-pool-tooltip-ticker-color': 'rgba(250, 251, 252, 0.6)',
    '--theme-delegation-steps-choose-stake-pool-tooltip-table-label-color': 'rgba(250, 251, 252, 1)',
    '--theme-delegation-steps-choose-stake-pool-tooltip-table-value-color': 'rgba(250, 251, 252, 1)',
    '--theme-delegation-steps-choose-stake-pool-tooltip-title-color': 'rgba(250, 251, 252, 1)',
    ...
    '--theme-delegation-steps-confirmation-description-color': 'rgba(233, 244, 254, 0.8)',
  ...
  dialog: {
    ...
    '--theme-dialog-fullsize-button-background-color-hover': 'rgba(0, 0, 0, 0.1)',
  ...
  hardwareWallet: {
    ...
    '--theme-hardware-wallet-status-passphrase-label-color': 'rgba(233, 244, 254, 0.5)'
  },
  icon: {
    ...
    '--theme-icon-add-wallet-dialog-big-button-color': 'rgba(233, 244, 254, 0.5)',
  ...
  newsFeed: {
    ...
    '--theme-news-feed-incident-overlay-background-color': 'rgba(38, 51, 69, 0.98)',
    '--theme-news-feed-incident-overlay-text-color': '#e9f4fe',
    '--theme-news-feed-incident-overlay-button-color': '#e9f4fe',
    '--theme-news-feed-incident-overlay-scrollbar-thumb-background': 'rgba(233, 244, 254, 0.3)',
    '--theme-news-feed-incident-overlay-scrollbar-thumb-background-hove': 'rgba(233, 244, 254, 0.5)',
    '--theme-news-feed-incident-overlay-content-list-color': 'rgba(233, 244, 254, 0.7)',
    ...
    '--theme-news-feed-incident-overlay-button-color-hover': 'rgba(38, 51, 69, 0.98)',
  ...
  newsItem: {
    ...
    '--theme-news-item-announcement-background-color': 'rgba(31, 193, 195, 0.2)',
  ...
  paperWallet: {
    '--theme-paper-wallet-create-certificate-dialog-explorer-link-color': 'rgb(32, 181, 107)',
  ...
  progressBar: {
    ...
    '--theme-progress-bar-large-progress-light-stripe-2-background-color': '#536370'
  },
  receiveQRCode: {
  ...
  recoveryPhrase: {
    ...
    '--theme-recovery-phrase-attention-background-color': 'rgba(234, 76, 91, .2)',
    '--theme-recovery-phrase-paper-wallet-background-color': 'rgba(233, 244, 254, 0.1)',
    '--theme-recovery-phrase-paper-wallet-question-background-color': 'rgba(233, 244, 254, 0.3)',
    '--theme-recovery-phrase-paper-wallet-question-text-color': '#394556',
    '--theme-recovery-phrase-paper-wallet-text-color': 'rgba(233, 244, 254, 0.8)'
  },
  reportIssue: {
  ...
  settings: {
    ...
    '--theme-settings-delete-button-legacy-background-color': 'rgba(83, 99, 112, 0.3)',
    '--theme-settings-delete-button-legacy-background-color-hover': 'rgba(83, 99, 112, 1)',
  ...
  stakePools: {
    ...
    '--theme-staking-stake-pool-saturation-background-color': 'rgba(233, 244, 254, 0.2)',
    ...
    '--theme-staking-stake-pool-tooltip-delegate-button-active-background-color': 'rgba(250, 251, 252, 0.8)',
    ...
    '--theme-staking-stake-pools-search-clear-button-background-color': 'rgba(233, 244, 254, 0.1)',
    '--theme-staking-stake-pools-search-clear-button-color': 'rgba(233, 244, 254, 1)',
    '--theme-staking-stake-pools-search-clear-button-hover-background-color': 'rgba(233, 244, 254, 0.05)',
    '--theme-staking-stake-pools-title-color': '#e9f4fe',
    '--theme-staking-stake-pool-tooltip-neutral-background-color': 'rgba(233, 244, 254, .1)',
  ...
  staking: {
    ...
    '--theme-staking-delegation-center-gear-icon-fill-color': 'rgba(233, 244, 254, 0.5)',
    '--theme-staking-delegation-center-gear-icon-fill-color-active': '#e9f4fe',
    '--theme-staking-delegation-center-no-wallets-instructions-color': '#e9f4fe',
    ...
    '--theme-staking-countdown-widget-background-color': 'rgba(233, 244, 254, 0.07)',
    ...
    '--theme-staking-wallet-row-ticker-background-color': 'rgba(233, 244, 254, 0.07)',
  ...
  transactions: {
    ...
    '--theme-transactions-state-pending-background-color': 'rgba(233, 244, 254, 0.3)',
    ...
    '--theme-transactions-icon-type-pending-regular-background-color': 'rgba(233, 244, 254, 0.3)',
    '--theme-transactions-icon-type-pending-warning-background-color': 'rgba(236, 93, 107, 0.8)',
    '--theme-transactions-icon-type-failed-background-color': 'rgba(236, 93, 107, 1)',
    ...
    '--theme-transactions-date-picker-button-background-color': 'rgba(233, 244, 254, 0.14)',
    '--theme-transactions-date-picker-button-background-color-hover': 'rgba(233, 244, 254, 0.07)',
    ...
    '--theme-transactions-filter-title-button-background-color': 'rgba(233, 244, 254, 0.1)',
    '--theme-transactions-filter-title-button-background-color-hover': 'rgba(233, 244, 254, 0.05)',
    '--theme-transactions-filter-title-button-background-color-active': 'rgba(233, 244, 254, 0.12)',
    '--theme-transactions-transfer-funds-selected-wallet-background-color': '#e9f4fe0d',
  ...
  tokens: {
    ...
    '--theme-tokens-list-header-expanded-background-color': 'rgba(233, 244, 254, 0.05)',
    '--theme-tokens-list-header-expanded-background-color-hover': 'rgba(233, 244, 254, 0.03)'
  },
  uploader: {
  ...
  voting: {
    ...
    '--theme-voting-registration-steps-activation-steps-indicator-color': '#e9f4fe',
    '--theme-voting-registration-steps-choose-wallet-error-message-color': '#ea4c5b',
    '--theme-voting-registration-steps-choose-wallet-error-message-light-color': 'rgba(234, 76, 91, 0.7)',
    ...
    '--theme-voting-registration-steps-description-color': 'rgba(233, 244, 254, 0.8)',
    '--theme-voting-registration-steps-description-highlighted-color': '#e9f4fe',
  ...
  walletNotRespondingOverlay: {
    ...
    '--theme-wallet-not-responding-button-background-color': 'rgba(0, 0, 0, 0.1)',
    ...
    '--theme-wallet-not-responding-description-background-color': 'rgba(0, 0, 0, .1)',
    '--theme-wallet-not-responding-description-text-color': 'rgba(233, 244, 254, 0.7)',
  ...
  walletRestoreDialog: {
    '--theme-wallet-restore-dialog-new-label-background-color': 'rgba(233, 244, 254, 0.1)',
  ...
  walletSettings: {
    '--theme-wallet-settings-section-separator-color': 'rgba(233, 244, 254, 0.15)'
  },
  widgets: {
    '--theme-widgets-asset-token-fingerprint-background-color': 'rgba(102,122,138,0.1)',
