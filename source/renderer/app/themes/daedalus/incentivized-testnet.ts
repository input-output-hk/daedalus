...
export const INCENTIVIZED_TESTNET_THEME_OUTPUT = {
  ...
  governance: {
    ...
    '--theme-gov-search-icon-color': '#ffffff',
    '--theme-gov-search-clear-button-color': '#ffffff',
    '--theme-gov-search-clear-button-background-color': '#ffffff0d',
    '--theme-gov-search-clear-button-hover-background-color': '#ffffff1a',
