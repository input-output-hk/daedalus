...
export const INCENTIVIZED_TESTNET_THEME_OUTPUT = {
  ...
  buttonAttention: {
    '--theme-button-attention-background-color': '#eb4a22',
  ...
  buttonFlat: {
    ...
    '--theme-button-flat-outline-color': 'rgba(94, 96, 102, 0.5)',
  },
  buttonFlatInvert: {
  ...
  connecting: {
    ...
    '--theme-connecting-background-color1': 'rgba(42, 43, 60, 1)',
    '--theme-connecting-background-color2': 'rgba(42, 43, 60, 0.91)',
    '--theme-connecting-background-color3': 'rgba(42, 43, 60, 0.31)',
    '--theme-connecting-background-color4': 'rgba(42, 43, 60, 0)',
    '--theme-connecting-background-color5': 'rgba(42, 43, 60, 0)',
    '--theme-connecting-background-color6': 'rgba(42, 43, 60, 0.31)',
  ...
  delegationSetupWizard: {
    ...
    '--theme-delegation-steps-choose-wallet-description-highlighted-color':
      '#ffffff',
    '--theme-delegation-steps-choose-wallet-error-message-color': '#eb4a22',
  ...
  dialog: {
    ...
    '--theme-dialog-fullsize-button-icon-color': '#ffffff',
  ...
  mithrilBootstrap: {
    ...
    '--theme-mithril-panel-background': 'rgba(24, 25, 42, 0.6)',
    '--theme-mithril-panel-border-color': 'rgba(60, 61, 78, 0.6)',
    '--theme-mithril-context-panel-background': 'rgba(24, 25, 42, 0.42)',
    '--theme-mithril-button-primary-background': '#eb2256',
    '--theme-mithril-button-primary-background-hover': '#f04070',
    '--theme-mithril-button-primary-text-color': '#ffffff',
    '--theme-mithril-button-secondary-border-color': 'rgba(82, 83, 100, 0.6)',
    '--theme-mithril-button-secondary-border-color-hover':
      'rgba(102, 103, 120, 0.9)',
    '--theme-mithril-button-secondary-text-color': 'rgba(225, 233, 242, 0.92)',
    '--theme-mithril-button-secondary-text-color-hover':
      'rgba(255, 255, 255, 0.98)',
    '--theme-mithril-link-color': 'rgba(240, 100, 130, 0.96)',
    '--theme-mithril-link-color-hover': 'rgba(250, 140, 165, 0.98)',
    ...
    '--theme-mithril-step-icon-pending-background': 'rgba(82, 83, 100, 0.35)',
    '--theme-mithril-step-connector-color': 'rgba(82, 83, 100, 0.22)',
    ...
    '--theme-mithril-sub-item-pending-background': 'rgba(82, 83, 100, 0.3)',
    '--theme-mithril-progress-track-color': 'rgba(82, 83, 100, 0.2)',
    '--theme-mithril-progress-complete-color': 'rgba(30, 164, 126, 0.7)',
    '--theme-mithril-progress-meta-color': 'rgba(88, 89, 106, 0.75)',
    '--theme-mithril-scrollbar-thumb-color': 'rgba(82, 83, 100, 0.5)',
    '--theme-mithril-scrollbar-thumb-color-hover': 'rgba(102, 103, 120, 0.7)',
    '--theme-mithril-selector-background': 'rgba(36, 37, 54, 0.9)',
    '--theme-mithril-selector-option-background': 'rgba(48, 49, 66, 0.96)',
    '--theme-mithril-selector-border-color': 'rgba(82, 83, 100, 0.6)',
    '--theme-mithril-selector-button-background': 'rgba(48, 49, 66, 0.95)',
  ...
  newsFeed: {
    ...
    '--theme-news-feed-badge-background-color': '#eb4a22',
  ...
  newsItem: {
    ...
    '--theme-news-item-announcement-background-color': 'rgba(235, 34, 88, 0.2)',
    '--theme-news-item-badge-green-color': '#2DC06C',
    '--theme-news-item-badge-red-color': '#eb4a22',
  ...
  progressBar: {
    ...
    '--theme-progress-bar-large-progress-light-stripe-1': '#bf0535',
  ...
  reportIssue: {
    '--theme-report-issue-button-background-color': '#eb2256',
    '--theme-report-issue-button-background-color-hover': '#d41345',
    '--theme-report-issue-button-background-color-active': '#c81241',
  ...
  rpButton: {
    '--rp-button-bg-color': '#eb2256',
    '--rp-button-bg-color-active': '#c81241',
    '--rp-button-bg-color-disabled': 'rgba(235, 34, 88, 0.3)',
    '--rp-button-bg-color-hover': '#d41345',
  ...
  rpStepper: {
    ...
    '--rp-stepper-main-color': '#eb2256',
    '--rp-stepper-main-color-light': '#eb22561a',
  ...
  rpSwitch: {
    '--rp-switch-bg-color-off': 'rgba(235, 34, 88, 0.3)',
    '--rp-switch-bg-color-on': '#eb2256',
  ...
  sidebar: {
    ...
    '--theme-sidebar-category-background-color-active': '#2A2B3C',
  ...
  stakePools: {
    ...
    '--theme-staking-stake-pool-saturation-red-color': '#eb4a22',
    ...
    '--theme-staking-stake-pool-tooltip-link-color': '#eb2256',
  ...
  governance: {
    ...
    '--theme-gov-badge-neutral-background': '#ffffff14',
    '--theme-gov-badge-neutral-color': '#fffffff2',
    '--theme-gov-badge-success-background': '#2dc06c1f',
    '--theme-gov-badge-success-color': '#48d47f',
    '--theme-gov-badge-warning-background': '#f2a2181f',
    '--theme-gov-badge-warning-color': '#ffb532',
    '--theme-gov-badge-danger-background': '#ea4c5b1f',
    '--theme-gov-badge-danger-color': '#ff8088',
  },
  staking: {
    ...
    '--theme-staking-donut-ring-completed-color': 'rgba(235, 74, 34, 0.2)',
    '--theme-staking-donut-ring-remaining-color': '#eb4a22',
  ...
  walletNotRespondingOverlay: {
    ...
    '--theme-wallet-not-responding-description-text-color': '#ffffff',
  ...
  chainStorage: {
    ...
    '--theme-chain-storage-panel-background': 'rgba(24, 25, 42, 0.6)',
    '--theme-chain-storage-panel-border-color': 'rgba(60, 61, 78, 0.6)',
    '--theme-chain-storage-button-primary-background': '#eb2256',
    '--theme-chain-storage-button-primary-background-hover': '#f04070',
