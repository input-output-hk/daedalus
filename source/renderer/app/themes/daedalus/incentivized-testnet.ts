...
export const INCENTIVIZED_TESTNET_THEME_OUTPUT = {
  ...
  appUpdate: {
    ...
    '--theme-node-update-deny-button-background-color-hover': 'rgba(94, 95, 113, 0.3)',
    '--theme-node-update-deny-button-background-color-active': 'rgba(38, 39, 54, 0.3)',
  ...
  buttonAttention: {
    ...
    '--theme-button-attention-background-color-disabled': 'rgba(235, 74, 34, 1)',
  ...
  buttonFlatInvert: {
    ...
    '--theme-button-flat-invert-background-color-hover': 'rgba(255, 255, 255, 0.3)',
    '--theme-button-flat-invert-background-color-active': 'rgba(255, 255, 255, 0.4)',
  ...
  buttonPrimaryInvert: {
    ...
    '--theme-button-primary-invert-background-color-hover': 'rgba(255, 255, 255, 0.9)',
    '--theme-button-primary-invert-background-color-active': 'rgba(255, 255, 255, 0.8)',
  ...
  dapps: {
    ...
    '--theme-dapp-transaction-request-toggle-button-background-color': 'rgba(255, 255, 255, 0.1)',
    '--theme-dapp-transaction-request-code-background-color': 'rgba(255, 255, 255, 0.05)'
  },
  dataMigration: {
  ...
  delegationSetupWizard: {
    ...
    '--theme-delegation-steps-choose-stake-pool-checkmark-icon-color': 'rgba(255, 255, 255, 0.2)',
    '--theme-delegation-steps-choose-stake-pool-delegated-pools-label-color': '#ffffff',
    '--theme-delegation-steps-choose-stake-pool-ticker-color': 'rgba(255, 255, 255, 1)',
    '--theme-delegation-steps-choose-stake-pool-select-box-placeholder-color': 'rgba(255, 255, 255, 0.2)',
    '--theme-delegation-steps-choose-stake-pool-selected-checkmark-icon-color': '#ffffff',
    '--theme-delegation-steps-choose-stake-pool-selected-ticker-color': '#ffffff',
    '--theme-delegation-steps-choose-stake-pool-thumb-background-color': 'rgba(42, 43, 60, 1)',
    '--theme-delegation-steps-choose-stake-pool-thumb-border-color': 'rgba(255, 255, 255, 0.2)',
    '--theme-delegation-steps-choose-stake-pool-title-color': '#ffffff',
    '--theme-delegation-steps-choose-stake-pool-tooltip-arrow-color': '#ffffffe6',
    '--theme-delegation-steps-choose-stake-pool-tooltip-background-color': '#ffffffe6',
    '--theme-delegation-steps-choose-stake-pool-tooltip-box-shadow': '0 5px 20px 0 rgba(0, 0, 0, 0.25)',
    '--theme-delegation-steps-choose-stake-pool-tooltip-description-color': '#ffffff',
    '--theme-delegation-steps-choose-stake-pool-tooltip-ticker-color': '#ffffff99',
    '--theme-delegation-steps-choose-stake-pool-tooltip-table-label-color': '#ffffff',
    '--theme-delegation-steps-choose-stake-pool-tooltip-table-value-color': '#ffffff',
    ...
    '--theme-delegation-steps-choose-wallet-description-highlighted-color': '#ffffff',
    '--theme-delegation-steps-choose-wallet-error-message-color': '#eb4a22',
    '--theme-delegation-steps-choose-wallet-error-message-light-color': '#eb4a22b3',
    '--theme-delegation-steps-choose-wallet-error-select-options-color': '#ffffff',
    ...
    '--theme-delegation-steps-intro-divider-border-color': 'rgba(255, 255, 255, 0.2)',
    ...
    '--theme-delegation-steps-not-available-description-text-color': '#ffffffcc',
    '--theme-delegation-steps-not-available-description-highlight-text-color': '#ffffff',
  ...
  dialog: {
    ...
    '--theme-dialog-choice-tabs-bottom-border-color-active': 'rgba(255, 255, 255, 0.4)',
    ...
    '--theme-dialog-set-wallet-password-background-color': 'rgba(18, 19, 38, 0.91)',
  ...
  hardwareWallet: {
    ...
    '--theme-hardware-wallet-status-passphrase-label-color': 'rgba(255, 255, 255, 0.5)'
  },
  icon: {
    ...
    '--theme-icon-add-wallet-dialog-big-button-color': 'rgba(255, 255, 255, 0.5)',
  ...
  navDropdown: {
    ...
    '--theme-nav-dropdown-item-background-color-hover': 'rgba(255, 255, 255, 0.07)',
  ...
  newsFeed: {
    ...
    '--theme-news-feed-incident-overlay-background-color': 'rgba(42, 43, 60, 0.98)',
    '--theme-news-feed-incident-overlay-text-color': '#ffffff',
    '--theme-news-feed-incident-overlay-button-color': '#ffffff',
    '--theme-news-feed-incident-overlay-scrollbar-thumb-background': 'rgba(255, 255, 255, 0.3)',
    '--theme-news-feed-incident-overlay-scrollbar-thumb-background-hove': 'rgba(255, 255, 255, 0.5)',
    '--theme-news-feed-incident-overlay-content-list-color': 'rgba(255, 255, 255, 0.7)',
    ...
    '--theme-news-feed-incident-overlay-button-color-hover': 'rgba(42, 43, 60, 0.98)',
    ...
    '--theme-news-feed-incident-grey-overlay-scrollbar-thumb-background': 'rgba(255, 255, 255, 0.3)',
    '--theme-news-feed-incident-grey-overlay-scrollbar-thumb-background-hove': 'rgba(255, 255, 255, 0.5)',
    '--theme-news-feed-incident-grey-overlay-content-list-color': 'rgba(255, 255, 255, 0.7)',
    ...
    '--theme-news-feed-incident-red-overlay-scrollbar-thumb-background': 'rgba(255, 255, 255, 0.3)',
    '--theme-news-feed-incident-red-overlay-scrollbar-thumb-background-hove': 'rgba(255, 255, 255, 0.5)',
    '--theme-news-feed-incident-red-overlay-content-list-color': 'rgba(255, 255, 255, 0.7)'
  },
  newsItem: {
  ...
  notification: {
    ...
    '--theme-legacy-notification-learn-more-button-background-color': '#12132633',
    '--theme-legacy-notification-learn-more-button-background-color-hover': '#1213264d',
    '--theme-legacy-notification-learn-more-button-background-color-active': '#12132666',
    ...
    '--theme-legacy-notification-move-button-background-color-active': 'rgb(250, 251, 252, 0.8)',
  ...
  paperWallet: {
    '--theme-paper-wallet-create-certificate-dialog-explorer-link-color': '#eb2256',
    '--theme-paper-wallet-create-certificate-dialog-explorer-link-background-color': 'rgba(255, 255, 255, 0.07)'
  },
  progressBar: {
    ...
    '--theme-progress-bar-large-progress-light-stripe-2-background-color': '#eb2256'
  },
  receiveQRCode: {
  ...
  recoveryPhrase: {
    '--theme-recovery-phrase-normal-background-color': 'rgba(255, 255, 255, .1)',
    '--theme-recovery-phrase-normal-border-color': 'transparent',
    '--theme-recovery-phrase-warning-background-color': 'rgba(255, 255, 255, .1)',
    '--theme-recovery-phrase-attention-background-color': 'rgba(235, 74, 34, 0.2)',
    '--theme-recovery-phrase-paper-wallet-background-color': 'rgba(255, 255, 255, 0.1)',
    '--theme-recovery-phrase-paper-wallet-question-background-color': 'rgba(255, 255, 255, 0.3)',
    '--theme-recovery-phrase-paper-wallet-question-text-color': '#343546',
    '--theme-recovery-phrase-paper-wallet-text-color': 'rgba(255, 255, 255, 0.8)'
  },
  reportIssue: {
    ...
    '--theme-report-issue-connecting-background-color': 'rgba(255, 255, 255, 0.05)',
  ...
  rpBubble: {
    ...
    '--rp-bubble-box-shadow': '0 4px 16px 0 rgba(0, 0, 0, 0.4), 0 0 8px 0 rgba(0, 0, 0, 0.2)'
  },
  rpButton: {
  ...
  settings: {
    ...
    '--theme-settings-delete-button-legacy-background-color': 'rgba(65, 66, 81, 0.5)',
    '--theme-settings-delete-button-legacy-background-color-hover': 'rgba(65, 66, 81, 1)',
    ...
    '--theme-settings-undelegate-wallet-divider-border-color': 'rgba(255, 255, 255, 0.2)',
  ...
  sidebar: {
    ...
    '--theme-sidebar-wallets-scrollbar-background-color': 'rgba(255, 255, 255, 0.3)',
    '--theme-sidebar-wallets-scrollbar-background-color-active': 'rgba(255, 255, 255, 0.5)',
    '--theme-sidebar-wallets-scrollbar-background-color-hover': 'rgba(255, 255, 255, 0.5)',
  ...
  splash: {
    ...
    '--theme-splash-network-overlay-button-background-color': 'rgba(255, 255, 255, 0.1)',
    ...
    '--theme-splash-network-scrollbar-thumb-background': 'rgba(255, 255, 255, 0.3)',
    '--theme-splash-network-scrollbar-thumb-background-hover': 'rgba(255, 255, 255, 0.5)',
  ...
  stakePools: {
    ...
    '--theme-staking-stake-pool-saturation-background-color': 'rgba(255, 255, 255, 0.2)',
    ...
    '--theme-staking-stake-pool-tooltip-background-color': 'rgba(42, 43, 60, 0.98)',
    '--theme-staking-stake-pool-tooltip-border-color': 'rgba(255, 255, 255, 0.2)',
    ...
    '--theme-staking-stake-pool-tooltip-delegate-button-background-color': '#eb2256',
    '--theme-staking-stake-pool-tooltip-delegate-button-hover-background-color': '#d41345',
    '--theme-staking-stake-pool-tooltip-delegate-button-active-background-color': '#c81241',
    '--theme-staking-stake-pool-tooltip-delegate-button-text-color': 'rgba(18, 19, 38, 1)',
    '--theme-staking-stake-pool-tooltip-delegate-button-inverse-text-color': 'rgba(18, 19, 38, 1)',
    '--theme-staking-stake-pool-tooltip-delegate-button-border-color': 'transparent',
    '--theme-staking-progress-label-light': '#ffffffb3',
    '--theme-staking-stake-pools-search-clear-button-background-color': 'rgba(255, 255, 255, 0.1)',
    '--theme-staking-stake-pools-search-clear-button-color': '#ffffff',
    '--theme-staking-stake-pools-search-clear-button-hover-background-color': 'rgba(255, 255, 255, 0.05)',
    '--theme-staking-stake-pool-tooltip-neutral-background-color': 'rgba(255, 255, 255, .1)',
  ...
  staking: {
    ...
    '--theme-staking-progress-bar-background-color': 'rgba(255, 255, 255, 0.07)',
    ...
    '--theme-staking-dropdown-item-background-color-hover': 'rgba(255, 255, 255, 0.07)',
    ...
    '--theme-staking-delegation-center-no-wallets-instructions-color': '#ffffff',
    '--theme-staking-delegation-center-divider-border-color': 'rgba(255, 255, 255, 0.2)',
    '--theme-staking-delegation-center-fees-amount-color': '#eb4a22',
    '--theme-staking-countdown-widget-background-color': 'rgba(255, 255, 255, 0.07)',
    '--theme-staking-countdown-widget-delimeter-background-color': '#ffffff',
    '--theme-staking-countdown-widget-field-label-color': 'rgba(255, 255, 255, 0.7)',
    ...
    '--theme-staking-wallet-row-ticker-background-color': 'rgba(255, 255, 255, 0.07)',
    ...
    '--theme-staking-redeemItnRewards-separator-color': 'rgba(255, 255, 255, 0.2)',
  ...
  transactions: {
    ...
    '--theme-transactions-icon-type-pending-regular-background-color': 'rgba(255, 255, 255, 0.5)',
    '--theme-transactions-icon-type-pending-warning-background-color': 'rgba(235, 74, 34, 0.8)',
    '--theme-transactions-icon-type-failed-background-color': 'rgba(235, 74, 34, 1)',
    ...
    '--theme-transactions-state-pending-background-color': 'rgba(255, 255, 255, 0.5)',
    ...
    '--theme-transactions-date-picker-button-background-color': 'rgba(255, 255, 255, 0.14)',
    '--theme-transactions-date-picker-button-background-color-hover': 'rgba(255, 255, 255, 0.07)',
    '--theme-transactions-date-picker-button-color': '#ffffff',
    '--theme-transactions-filter-modal-bg-color': '#3f404f',
    '--theme-transactions-filter-date-picker-shadow': '0 0 20px 0 rgba(0, 0, 0, 0.4)',
    '--theme-transactions-filter-title-button-text-color': '#ffffff',
    '--theme-transactions-filter-title-button-background-color': 'rgba(255, 255, 255, 0.1)',
    '--theme-transactions-filter-title-button-background-color-hover': 'rgba(255, 255, 255, 0.05)',
    '--theme-transactions-filter-title-button-background-color-active': 'rgba(255, 255, 255, 0.12)',
    '--theme-transactions-transfer-funds-selected-wallet-background-color': '#ffffff0d',
  ...
  tokens: {
    ...
    '--theme-tokens-list-header-expanded-background-color': 'rgba(255, 255, 255, 0.05)',
    '--theme-tokens-list-header-expanded-background-color-hover': 'rgba(255, 255, 255, 0.03)'
  },
  uploader: {
  ...
  voting: {
    ...
    '--theme-voting-registration-steps-activation-steps-indicator-color': '#ffffff',
    '--theme-voting-registration-steps-choose-wallet-error-message-color': '#eb4a22',
    '--theme-voting-registration-steps-choose-wallet-error-message-light-color': '#eb4a22b3',
    ...
    '--theme-voting-registration-steps-description-highlighted-color': '#ffffff',
  ...
  walletImportDialog: {
    ...
    '--theme-wallet-import-description-close-hover-background': 'rgba(0, 0, 0, 0.16)',
    ...
    '--theme-wallet-import-input-background-color-disabled': 'rgba(255, 255, 255, 0.05)',
    ...
    '--theme-wallet-import-stateFolder-button-background-color-hover': 'rgba(255, 255, 255, 0.05)',
    '--theme-wallet-import-stateFolder-button-background-color-active': 'rgba(255, 255, 255, 0.12)',
  ...
  walletRestoreDialog: {
    ...
    '--theme-wallet-restore-dialog-step-walletType-hardwareWalletDisclaimer-text-color': '#ea4c5b'
  },
  walletSettings: {
    '--theme-wallet-settings-section-separator-color': 'rgba(255, 255, 255, 0.15)'
  },
  widgets: {
    '--theme-widgets-asset-token-fingerprint-background-color': 'rgba(255,255,255,0.1)',
