...
export const CARDANO_THEME_OUTPUT = {
  ...
  mithrilBootstrap: {
    ...
    '--theme-mithril-panel-background': 'rgba(14, 16, 19, 0.6)',
    '--theme-mithril-panel-border-color': 'rgba(50, 52, 55, 0.6)',
    '--theme-mithril-context-panel-background': 'rgba(14, 16, 19, 0.42)',
    '--theme-mithril-button-primary-background': '#2cbb69',
    '--theme-mithril-button-primary-background-hover': '#3dcc7a',
    '--theme-mithril-button-primary-text-color': '#0d1410',
    '--theme-mithril-button-secondary-border-color': 'rgba(72, 74, 77, 0.6)',
    ...
    '--theme-mithril-link-color': 'rgba(82, 215, 139, 0.96)',
    '--theme-mithril-link-color-hover': 'rgba(120, 230, 170, 0.98)',
    ...
    '--theme-mithril-step-icon-pending-background': 'rgba(72, 74, 77, 0.35)',
    '--theme-mithril-step-connector-color': 'rgba(72, 74, 77, 0.22)',
    ...
    '--theme-mithril-sub-item-pending-background': 'rgba(72, 74, 77, 0.3)',
    '--theme-mithril-progress-track-color': 'rgba(72, 74, 77, 0.2)',
    '--theme-mithril-progress-complete-color': 'rgba(30, 164, 126, 0.7)',
    '--theme-mithril-progress-meta-color': 'rgba(140, 142, 145, 0.75)',
    '--theme-mithril-scrollbar-thumb-color': 'rgba(72, 74, 77, 0.5)',
    '--theme-mithril-scrollbar-thumb-color-hover': 'rgba(92, 94, 97, 0.7)',
    '--theme-mithril-selector-background': 'rgba(26, 28, 31, 0.9)',
    '--theme-mithril-selector-option-background': 'rgba(38, 40, 43, 0.96)',
    '--theme-mithril-selector-border-color': 'rgba(72, 74, 77, 0.6)',
    '--theme-mithril-selector-button-background': 'rgba(38, 40, 43, 0.95)',
  ...
  governance: {
    ...
    '--theme-gov-search-icon-color': '#5e6066',
    '--theme-gov-search-clear-button-color': '#5e6066',
    '--theme-gov-search-clear-button-background-color': '#5e60660d',
    '--theme-gov-search-clear-button-hover-background-color': '#5e60661a',
    '--theme-gov-badge-neutral-background': '#5e606614',
    '--theme-gov-badge-neutral-color': '#5e6066f2',
  ...
  chainStorage: {
    ...
    '--theme-chain-storage-panel-background': 'rgba(14, 16, 19, 0.6)',
    '--theme-chain-storage-panel-border-color': 'rgba(50, 52, 55, 0.6)',
    '--theme-chain-storage-button-primary-background': '#2cbb69',
    '--theme-chain-storage-button-primary-background-hover': '#3dcc7a',
    '--theme-chain-storage-button-primary-text-color': '#0d1410',
