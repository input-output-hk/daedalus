...
export const CARDANO_THEME_OUTPUT = {
  ...
  appUpdateOverlay: {
    ...
    '--theme-app-update-overlay-button-label-color-hover': 'rgba(32, 34, 37, 1)',
  ...
  automaticUpdate: {
    ...
    '--theme-automatic-update-overlay-button-icon-color': 'rgba(255, 255, 255, 1)',
    '--theme-automatic-update-overlay-button-icon-color-hover': 'rgba(32, 34, 37, 1)',
    '--theme-automatic-update-overlay-button-label-color-hover': 'rgba(32, 34, 37, 1)',
  ...
  buttonDisclaimer: {
    ...
    '--theme-button-disclaimer-border-color-disabled': 'rgba(255, 255, 255, .3)'
  },
  buttonFlat: {
  ...
  dapps: {
    ...
    '--theme-dapp-transaction-request-toggle-button-background-color': 'rgba(94, 96, 102, 0.1)',
    '--theme-dapp-transaction-request-code-background-color': 'rgba(94, 96, 102, 0.05)'
  },
  dataMigration: {
  ...
  delegationSetupWizard: {
    ...
    '--theme-delegation-steps-choose-stake-pool-checkmark-icon-color': '#d2d3d3',
    '--theme-delegation-steps-choose-stake-pool-delegated-pools-label-color': 'rgba(94, 96, 102, 1)',
    '--theme-delegation-steps-choose-stake-pool-ticker-color': '#d2d3d3',
    '--theme-delegation-steps-choose-stake-pool-select-box-placeholder-color': '#d2d3d3',
    ...
    '--theme-delegation-steps-choose-stake-pool-thumb-background-color': '#ffffff',
    '--theme-delegation-steps-choose-stake-pool-thumb-border-color': '#d2d3d3',
    '--theme-delegation-steps-choose-stake-pool-title-color': 'rgba(94, 96, 102, 1)',
    ...
    '--theme-delegation-steps-choose-stake-pool-tooltip-description-color': 'rgba(255, 255, 255, 1)',
    '--theme-delegation-steps-choose-stake-pool-tooltip-ticker-color': 'rgba(255, 255, 255, 0.6)',
    '--theme-delegation-steps-choose-stake-pool-tooltip-table-label-color': 'rgba(255, 255, 255, 1)',
    '--theme-delegation-steps-choose-stake-pool-tooltip-table-value-color': 'rgba(255, 255, 255, 1)',
    '--theme-delegation-steps-choose-stake-pool-tooltip-title-color': 'rgba(255, 255, 255, 1)',
  ...
  hardwareWallet: {
    ...
    '--theme-hardware-wallet-status-passphrase-label-color': 'rgba(94, 96, 102, 0.5)'
  },
  icon: {
  ...
  network: {
    ...
    '--theme-network-window-button-background-color': 'rgba(255, 255, 255, 0.4)',
    '--theme-network-window-button-background-color-hover': 'rgba(255, 255, 255, 0.6)',
    '--theme-network-window-button-background-color-active': 'rgba(255, 255, 255, 0.8)'
  },
  newsFeed: {
    ...
    '--theme-news-feed-incident-overlay-background-color': 'rgba(32, 34, 37, 0.98)',
    ...
    '--theme-news-feed-incident-overlay-button-color-hover': 'rgba(32, 34, 37, 0.98)',
  ...
  notification: {
    ...
    '--theme-legacy-notification-learn-more-button-background-color': 'rgba(255, 255, 255, 0.2)',
    '--theme-legacy-notification-learn-more-button-background-color-hover': 'rgba(255, 255, 255, 0.3)',
    ...
    '--theme-legacy-notification-move-button-background-color-hover': 'rgba(255, 255, 255, 0.9)',
    '--theme-legacy-notification-move-button-background-color-active': 'rgba(255, 255, 255, 0.8)',
    '--theme-legacy-notification-title-color': '#ffffff',
    '--theme-legacy-notification-description-color': '#ffffff'
  },
  paperWallet: {
    '--theme-paper-wallet-create-certificate-dialog-explorer-link-color': '#26ab5f',
  ...
  progressBar: {
    ...
    '--theme-progress-bar-large-progress-light-stripe-2-background-color': '#2cbb69'
  },
  receiveQRCode: {
  ...
  recoveryPhrase: {
    ...
    '--theme-recovery-phrase-warning-background-color': 'rgba(32, 34, 37, 0.05)',
    '--theme-recovery-phrase-attention-background-color': 'rgba(234, 76, 91, .1)',
    '--theme-recovery-phrase-paper-wallet-background-color': 'rgba(32, 34, 37, 0.1)',
    '--theme-recovery-phrase-paper-wallet-question-background-color': 'rgba(32, 34, 37, 0.3)',
  ...
  stakePools: {
    ...
    '--theme-staking-stake-pool-saturation-background-color': 'rgba(94, 96, 102, 0.2)',
    ...
    '--theme-staking-stake-pool-tooltip-background-color': 'rgba(255, 255, 255, 0.97)',
    '--theme-staking-stake-pool-tooltip-border-color': '#d2d3d3',
    '--theme-staking-stake-pool-tooltip-delegate-button-active-background-color': '#239554',
    '--theme-staking-stake-pool-tooltip-delegate-button-background-color': '#2cbb69',
    '--theme-staking-stake-pool-tooltip-delegate-button-border-color': 'transparent',
    '--theme-staking-stake-pool-tooltip-delegate-button-hover-background-color': '#56c887',
    '--theme-staking-stake-pool-tooltip-delegate-button-inverse-text-color': '#ffffff',
    ...
    '--theme-staking-stake-pools-search-clear-button-background-color': 'rgba(32, 34, 37, 0.1)',
    '--theme-staking-stake-pools-search-clear-button-color': '#5e6066',
    '--theme-staking-stake-pools-search-clear-button-hover-background-color': 'rgba(32, 34, 37, 0.05)',
    '--theme-staking-stake-pools-title-color': '#5e6066',
    '--theme-staking-stake-pool-tooltip-neutral-background-color': 'rgba(32, 34, 37, .1)',
  ...
  staking: {
    ...
    '--theme-staking-dropdown-item-background-color-hover': 'rgba(32, 34, 37, 0.07)',
    '--theme-staking-delegation-center-gear-icon-fill-color': 'rgba(94, 96, 102, 0.5)',
    '--theme-staking-delegation-center-gear-icon-fill-color-active': '#5e6066',
    '--theme-staking-delegation-center-no-wallets-instructions-color': '#5e6066',
    ...
    '--theme-staking-countdown-widget-background-color': 'rgba(32, 34, 37, 0.07)',
  ...
  transactions: {
    ...
    '--theme-transactions-state-pending-background-color': 'rgba(94, 96, 102, 0.5)',
    ...
    '--theme-transactions-icon-type-pending-regular-background-color': 'rgba(94, 96, 102, 0.5)',
    ...
    '--theme-transactions-date-picker-button-background-color': 'rgba(32, 34, 37, 0.14)',
    '--theme-transactions-date-picker-button-background-color-hover': 'rgba(32, 34, 37, 0.07)',
    ...
    '--theme-transactions-filter-title-button-background-color': 'rgba(32, 34, 37, 0.1)',
    '--theme-transactions-filter-title-button-background-color-hover': 'rgba(32, 34, 37, 0.05)',
    '--theme-transactions-filter-title-button-background-color-active': 'rgba(32, 34, 37, 0.12)',
    '--theme-transactions-transfer-funds-selected-wallet-background-color': '#5e60660d',
  ...
  tokens: {
    ...
    '--theme-tokens-list-header-expanded-background-color': 'rgba(32, 34, 37, 0.05)',
    '--theme-tokens-list-header-expanded-background-color-hover': 'rgba(32, 34, 37, 0.03)'
  },
  uploader: {
  ...
  voting: {
    ...
    '--theme-voting-registration-steps-activation-steps-indicator-color': '#5e6066',
    ...
    '--theme-voting-registration-steps-description-color': 'rgba(94, 96, 102, 0.8)',
    '--theme-voting-registration-steps-description-highlighted-color': '#5e6066',
  ...
  walletImportDialog: {
    ...
    '--theme-wallet-import-description-close-hover-background': 'rgba(0, 0, 0, 0.2)',
  ...
  walletNotRespondingOverlay: {
    ...
    '--theme-wallet-not-responding-description-background-color': 'rgba(32, 34, 37, 0.96)',
    '--theme-wallet-not-responding-description-text-color': 'rgba(255, 255, 255, 0.7)',
  ...
  walletRestoreDialog: {
    '--theme-wallet-restore-dialog-new-label-background-color': 'rgba(32, 34, 37, 0.1)',
  ...
  walletSettings: {
    '--theme-wallet-settings-section-separator-color': 'rgba(94, 96, 102, 0.15)'
  },
  widgets: {
    '--theme-widgets-asset-token-fingerprint-background-color': 'rgba(94,96,102,0.1)',
