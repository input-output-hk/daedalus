...
export const WHITE_THEME_CONFIG = {
  ...
  rpButton: {
    '--rp-button-bg-color': '#ffffff',
    '--rp-button-bg-color-active': '#b3b3b3',
    '--rp-button-bg-color-disabled': '#ffffff',
    '--rp-button-bg-color-hover': '#ffffff',
  ...
  rpSwitch: {
    '--rp-switch-bg-color-off': '#ffffff',
    '--rp-switch-bg-color-on': '#ffffff',
  ...
  blockConsolidation: {
    ...
    '--theme-block-consolidation-indicator-epochs-behind-background-color-2':
      '#ffffff',
    '--theme-block-consolidation-stripe-dark-1-background-color': '#f9f9f9',
    '--theme-block-consolidation-stripe-dark-2-background-color': '#e0e0e0',
    '--theme-block-consolidation-stripe-light-1-background-color': '#ffffff',
    '--theme-block-consolidation-stripe-light-2-background-color': '#fafafa',
    '--theme-block-consolidation-button-background-color': '#e6e6e6',
    '--theme-block-consolidation-button-background-color-hover': '#fdfdfd',
  ...
  borderedBox: {
    ...
    '--theme-bordered-box-border': '1px solid rgba(45, 45, 45, 0.1)',
  ...
  buttonPrimary: {
    '--theme-button-primary-background-color': '#ffffff',
    '--theme-button-primary-background-color-hover': '#ffffff',
    '--theme-button-primary-background-color-active': '#b3b3b3',
    '--theme-button-primary-background-color-disabled': '#ffffff',
    '--theme-button-primary-text-color-disabled': '#fafbfc',
    '--theme-button-primary-text-color': '#fafbfc',
    '--theme-button-primary-outline-color': '#ffffff',
  },
  connecting: {
  ...
  icon: {
    '--theme-icon-nav-color': '#fafbfc',
    '--theme-icon-nav-color-active': '#2d2d2d',
    '--theme-icon-sidebar-color': '#f9f9f9',
    '--theme-icon-toggle-menu-color': '#f9f9f9',
  ...
  navItem: {
    '--theme-nav-item-background-color': '#b3b3b3',
    '--theme-nav-item-background-color-active': '#fdfdfd',
    '--theme-nav-item-background-color-hover': '#cccccc',
    '--theme-nav-item-text-color': '#fafbfc',
    '--theme-nav-item-text-color-active': '#2d2d2d',
  },
  network: {
  ...
  sidebar: {
    ...
    '--theme-sidebar-category-background-color-hover': '#e6e6e6',
    '--theme-sidebar-category-background-color-active': '#cccccc',
    '--theme-sidebar-category-text-color': '#fafbfc',
    '--theme-sidebar-menu-background-color': '#cccccc',
    '--theme-sidebar-menu-item-background-color-hover': '#b3b3b3',
    '--theme-sidebar-menu-item-background-color-active': '#b3b3b3',
    '--theme-sidebar-menu-item-wallet-name-color': '#fafbfc',
    '--theme-sidebar-menu-item-wallet-info-color': '#fafbfc',
    '--theme-sidebar-menu-add-button-background-color': '#b3b3b3',
    '--theme-sidebar-menu-add-button-background-color-active': '#b3b3b3a8',
    '--theme-sidebar-menu-add-button-background-color-hover': '#b3b3b3a8',
  ...
  topBar: {
    '--theme-topbar-background-color': '#b3b3b3',
  ...
  transactions: {
    ...
    '--theme-transactions-state-failed-background-color': '#e0e0e0',
