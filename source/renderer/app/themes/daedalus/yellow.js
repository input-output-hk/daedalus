...
export const YELLOW_THEME_CONFIG = {
  rpAutocomplete: {
    '--rp-autocomplete-bg-color': '#f8f7f3',
    ...
    '--rp-autocomplete-selected-word-box-bg-color': '#fdd786',
  ...
  rpBubble: {
    '--rp-bubble-bg-color': '#f8f7f3',
    '--rp-bubble-border-color': '#e1dac6',
    '--rp-bubble-border-radius': '2px',
    '--rp-bubble-arrow-bg-color': '#eeeae0',
  },
  rpButton: {
    '--rp-button-bg-color': '#fdcd68',
    '--rp-button-bg-color-active': '#eea70e',
    '--rp-button-bg-color-disabled': '#feebc3',
    '--rp-button-bg-color-hover': '#fdd786',
  ...
  rpCheckbox: {
    '--rp-checkbox-border': '1px solid #fdcd68',
    '--rp-checkbox-border-color-disabled': '#fdcd6866',
    '--rp-checkbox-check-bg-color': '#fdcd68',
  ...
  rpInput: {
    '--rp-input-bg-color': '#f8f7f3',
    '--rp-input-bg-color-disabled': '#f5f2ec',
    '--rp-input-border-color': '#e1dac6',
  ...
  rpModal: {
    '--rp-modal-bg-color': '#f8f7f3',
    '--rp-modal-max-height': '90%',
    '--rp-modal-overlay-bg-color': 'rgba(0, 0, 0, 0.4)',
  },
  rpOptions: {
    '--rp-option-bg-color': '#f8f7f3',
    '--rp-option-bg-color-highlighted': '#eeeae0',
    '--rp-option-border-color': '#e1dac6',
    '--rp-option-checkmark-color': '#2d2d2d',
    '--rp-option-line-height': '22px',
    '--rp-option-text-color': '#2d2d2d',
    '--rp-options-border-color': '#e1dac6',
    '--rp-options-shadow': 'none',
  },
  rpSelect: {
    '--rp-select-arrow-bg-color': '#e1dac6',
    '--rp-select-arrow-bg-color-open': '#2d2d2d',
    '--rp-select-input-bg-color': '#f8f7f3',
    '--rp-select-input-border-color': '#e1dac6',
    '--rp-select-input-border-color-focus': '#2d2d2d',
    '--rp-select-input-text-color': '#2d2d2d',
    '--rp-select-input-placeholder-color': '#2d2d2d80',
  },
  rpStepper: {
    '--rp-stepper-bullet-background-color-disabled': '#f8f7f3',
    '--rp-stepper-bullet-border-color': '#fdcd681a',
    ...
    '--rp-stepper-main-color': '#fdcd68',
    '--rp-stepper-main-color-light': '#fdcd681a',
    '--rpstepper-stepper-step-label-bottom-margin': '6px',
    '--rpstepper-steps-bar-color-disabled': '#fdcd681a',
    '--rpstepper-steps-bar-top-position': '6px',
  },
  rpSwitch: {
    '--rp-switch-bg-color-off': '#fdcd68',
    '--rp-switch-bg-color-on': '#fdcd68',
  ...
  rpTextArea: {
    '--rp-textarea-bg-color': '#eeeae0',
    '--rp-textarea-bg-color-disabled': '#eeeae080',
  ...
  aboutWindow: {
    ...
    '--theme-about-window-icon-close-button-color': '#f8f7f3',
    '--theme-about-window-icon-close-hover-background': '#e4b95e',
  },
  adaRedemption: {
  ...
  blockConsolidation: {
    '--theme-block-consolidation-background-color': '#fdcd68',
    '--theme-block-consolidation-title-text-color': '#fafbfc',
    '--theme-block-consolidation-text-color': '#fafbfc',
    '--theme-block-consolidation-text-highlight-color': '#fafbfc',
    '--theme-block-consolidation-epochs-text-color': '#fdcd68',
    ...
    '--theme-block-consolidation-indicator-epochs-behind-background-color-2':
      '#fdcd68',
    '--theme-block-consolidation-stripe-dark-1-background-color': '#eeeae0',
    '--theme-block-consolidation-stripe-dark-2-background-color': '#d6d3ca',
    '--theme-block-consolidation-stripe-light-1-background-color': '#feebc3',
    '--theme-block-consolidation-stripe-light-2-background-color': '#f1eee6',
    '--theme-block-consolidation-button-background-color': '#e4b95e',
    '--theme-block-consolidation-button-background-color-hover': '#f8f7f3',
    '--theme-block-consolidation-button-icon-color': '#fafbfc',
    '--theme-block-consolidation-button-icon-color-hover': '#fdcd68',
    '--theme-block-consolidation-button-text-color-hover': '#fdcd68',
    '--theme-block-consolidation-button-border-color': '#f8f7f3',
  },
  body: {
  ...
  borderedBox: {
    '--theme-bordered-box-background-color': '#f8f7f3',
  ...
  buttonFlat: {
    '--theme-button-flat-background-color': '#f1eee6',
    '--theme-button-flat-background-color-hover': '#f5f2ec',
    '--theme-button-flat-background-color-active': '#eeeae0',
    '--theme-button-flat-background-color-disabled': '#f5f2ec',
    '--theme-button-flat-text-color-disabled': '#2d2d2d',
    '--theme-button-flat-text-color': '#2d2d2d',
    '--theme-button-flat-outline-color': '#d6d3ca',
  },
  buttonPrimary: {
    '--theme-button-primary-background-color': '#fdcd68',
    '--theme-button-primary-background-color-hover': '#fdd786',
    '--theme-button-primary-background-color-active': '#eea70e',
    '--theme-button-primary-background-color-disabled': '#feebc3',
    '--theme-button-primary-text-color-disabled': '#fafbfc',
    '--theme-button-primary-text-color': '#fafbfc',
    '--theme-button-primary-outline-color': '#fdd786',
  },
  connecting: {
    '--theme-connecting-background-color': '#fdcd68',
  ...
  dataMigration: {
    ...
    '--theme-data-migration-layer-button-background-color-hover': '#eeeae0',
  ...
  delegationSetupWizard: {
    ...
    '--theme-delegation-steps-intro-link-color': '#fdcd68',
  ...
  dialog: {
    ...
    '--theme-dialog-border-color': '#e1dac6',
  },
  errors: {
  ...
  input: {
    '--theme-input-background-color': '#f8f7f3',
    '--theme-input-border-color': '#e1dac6',
  ...
  link: {
    '--theme-link-main-color': '#fdcd68',
  },
  loading: {
    '--theme-loading-background-color': '#eeeae0',
    '--theme-loading-no-disk-space-background-color': '#eeeae0',
  ...
  manualUpdate: {
    '--theme-manual-update-overlay-background-color': '#fdcd68f5',
    '--theme-manual-update-overlay-button-background-color': '#e4b95e',
    '--theme-manual-update-overlay-button-background-color-hover': '#fafbfc',
    '--theme-manual-update-overlay-button-icon-color': '#fafbfc',
    '--theme-manual-update-overlay-button-icon-color-hover': '#fdcd68',
    '--theme-manual-update-overlay-button-text-color-hover': '#fdcd68',
  ...
  mnemonic: {
    '--theme-mnemonic-background-color': '#eeeae0',
  ...
  navDropdown: {
    ...
    '--theme-nav-dropdown-item-background-color-hover': '#eeeae012',
  ...
  navItem: {
    ...
    '--theme-nav-item-text-color': '#2d2d2d',
    '--theme-nav-item-text-color-active': '#fafbfc',
  },
  network: {
    '--theme-network-window-background-color': '#fdcd68f5',
    '--theme-network-window-text-color': '#fafbfc',
    '--theme-network-window-icon-close-hover-background': '#e4b95e',
    ...
    '--theme-network-window-button-background-color': '#feebc366',
    '--theme-network-window-button-background-color-hover': '#feebc399',
    '--theme-network-window-button-background-color-active': '#feebc3cc',
  },
  nodeUpdate: {
    '--theme-node-update-background-color': '#eeeae0',
    '--theme-node-update-title-color': '#2d2d2d',
    '--theme-node-update-message-color': '#2d2d2d',
    '--theme-node-sync-info-message-background-color': '#eeeae0',
  ...
  reportIssue: {
    '--theme-report-issue-button-background-color': '#fdcd68',
    '--theme-report-issue-button-background-color-hover': '#fdd786',
    '--theme-report-issue-button-background-color-active': '#eea70e',
    '--theme-report-issue-connecting-background-color': '#eeeae0',
    '--theme-report-issue-icon-color': '#eeeae0',
    '--theme-report-issue-connecting-text-color': '#2d2d2d',
    '--theme-report-issue-syncing-background-color': '#eeeae0',
  ...
  settings: {
    '--theme-settings-body-background-color': '#eeeae0',
    '--theme-settings-pane-background-color': '#f8f7f3',
    '--theme-settings-pane-border': '1px solid #e1dac6',
    '--theme-settings-menu-box-background-color': '#f8f7f3',
    ...
    '--theme-settings-menu-item-background-color-active': '#eeeae0',
    '--theme-settings-menu-item-left-border-color-active': '#fdcd68',
    '--theme-settings-theme-select-title-color': '#2d2d2d',
  },
  sidebar: {
    '--theme-sidebar-background-color': '#fdcd68',
    '--theme-sidebar-category-background-color-hover': '#e4b95e',
    ...
    '--theme-sidebar-menu-item-background-color-hover': '#eea70e',
  ...
  stakePools: {
    ...
    '--theme-staking-stake-pool-tooltip-background-color': '#f8f7f3f7',
    ...
    '--theme-staking-stake-pool-tooltip-link-color': '#e4b95e',
  ...
  staking: {
    '--theme-staking-content-background-color': '#f8f7f3',
    ...
    '--theme-staking-table-head-background-color': '#eeeae0',
    '--theme-staking-table-border-color': '#e1dac6',
    '--theme-staking-link-color': '#fdcd68',
    '--theme-staking-link-color-light': '#fdd786',
    '--theme-staking-progress-bar-background-color': '#eeeae0',
    '--theme-staking-progress-stripe-dark-1-background-color': '#e4b95e',
    '--theme-staking-progress-stripe-dark-2-background-color': '#fdcd68',
    '--theme-staking-table-body-highlighted-text-color': '#e4b95e',
    ...
    '--theme-staking-dropdown-item-background-color': '#f8f7f3',
  ...
  support: {
    ...
    '--theme-support-settings-link-color': '#fdcd68',
    '--theme-support-settings-text-color': '#2d2d2d',
  },
  syncing: {
    '--theme-syncing-background-color': '#eeeae0',
  ...
  transactions: {
    '--theme-transactions-list-background-color': '#f8f7f3',
    ...
    '--theme-transactions-priority-color': '#eeeae0',
    ...
    '--theme-transactions-search-background-color': '#eeeae0',
  ...
  uploader: {
    ...
    '--theme-uploader-border-color': '#e1dac6',
  },
  utxo: {
    '--theme-utxo-background-color': '#eeeae080',
    '--theme-utxo-title-text-color': '#2d2d2d',
    '--theme-utxo-title-description-color': '#2d2d2db3',
    '--theme-utxo-bar-color': '#e4b95e80',
    '--theme-utxo-label-text-color': '#2d2d2d73',
    '--theme-utxo-tick-text-color': '#2d2d2d73',
    '--theme-utxo-cursor-background-color': '#feebc333',
    '--theme-utxo-tooltip-background-color': '#a7a49d',
    '--theme-utxo-tooltip-shadow-color': 'rgba(0, 0, 0, 0.18)',
    '--theme-utxo-tooltip-text-color': 'dfafbfc',
  },
};
