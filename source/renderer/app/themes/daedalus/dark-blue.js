...
const rpCheckbox = {
  ...
  '--rp-checkbox-label-color-disabled': 'rgba(233, 244, 254, 0.3)',
};
...
const rpFormfield = {
  ...
  '--rp-formfield-label-color-disabled': '#e9f4fe',
...
const rpSwitch = {
  ...
  '--rp-switch-accent-color-off': '#536370',
  '--rp-switch-accent-color-on': '#536370',
