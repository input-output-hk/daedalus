...
export default {
  ...
  '--theme-utxo-backgroune-color': 'rgba(83, 99, 112, 0.5)',
  '--theme-utxo-title-text-color': '#e9f4fe',
  '--theme-utxo-title-description-color': 'rgba(233, 244, 254, 0.7)',
  '--theme-utxo-bar-color': 'rgba(83, 99, 112, 0.7)',
  '--theme-utxo-text-color': 'rgba(194, 202, 212, 0.8)',
  '--theme-utxo-tooltip-background-color': '#4b5a68',
  '--theme-utxo-tooltip-shadow-color': 'rgba(0, 0, 0, 0.18)',
  '--theme-utxo-tooltip-text-color': '#fafbfc',
  '--theme-utxo-tick-text-color': '#c2cad4',
  '--theme-utxo-cursor-background-color': 'rgba(83, 99, 112, 0.3)',
};
