...
export const WHITE_THEME_OUTPUT = {
  ...
  analytics: {
    '--theme-analytics-toc-details-background': 'rgba(94, 96, 102, 0.07)',
  },
  appUpdate: {
  ...
  mithrilBootstrap: {
    ...
    '--theme-mithril-body-text-color': 'rgba(80, 85, 95, 0.9)',
    '--theme-mithril-secondary-text-color': 'rgba(110, 115, 125, 0.9)',
    '--theme-mithril-bright-text-color': 'rgba(45, 45, 50, 0.95)',
    '--theme-mithril-detail-label-color': 'rgba(120, 128, 140, 0.85)',
    '--theme-mithril-panel-background': 'rgba(235, 235, 238, 0.6)',
    '--theme-mithril-panel-border-color': 'rgba(200, 202, 208, 0.6)',
    '--theme-mithril-context-panel-background': 'rgba(235, 235, 238, 0.42)',
    '--theme-mithril-button-primary-background': '#29b595',
    '--theme-mithril-button-primary-background-hover': '#3bc5a5',
    '--theme-mithril-button-primary-text-color': '#ffffff',
    '--theme-mithril-button-secondary-border-color': 'rgba(160, 165, 175, 0.6)',
    '--theme-mithril-button-secondary-border-color-hover':
      'rgba(130, 135, 145, 0.9)',
    '--theme-mithril-button-secondary-text-color': 'rgba(60, 64, 72, 0.92)',
    '--theme-mithril-button-secondary-text-color-hover':
      'rgba(30, 30, 30, 0.98)',
    '--theme-mithril-link-color': 'rgba(30, 160, 130, 0.96)',
    '--theme-mithril-link-color-hover': 'rgba(20, 140, 110, 0.98)',
    '--theme-mithril-completion-title-color': 'rgba(30, 30, 30, 0.98)',
    '--theme-mithril-completion-detail-color': 'rgba(85, 92, 105, 0.92)',
    '--theme-mithril-step-active-label-color': 'rgba(45, 48, 55, 0.98)',
    '--theme-mithril-step-pending-label-color': 'rgba(130, 140, 155, 0.75)',
    '--theme-mithril-step-completed-label-color': 'rgba(30, 164, 126, 0.85)',
    '--theme-mithril-step-error-label-color': 'rgba(200, 50, 50, 0.95)',
    '--theme-mithril-step-icon-success-color': 'rgba(30, 164, 126, 0.95)',
    '--theme-mithril-step-icon-error-color': 'rgba(200, 50, 50, 0.95)',
    '--theme-mithril-step-icon-spinner-color': 'rgba(60, 64, 72, 0.92)',
    '--theme-mithril-step-icon-pending-background': 'rgba(180, 185, 195, 0.35)',
    '--theme-mithril-step-connector-color': 'rgba(180, 185, 195, 0.22)',
    '--theme-mithril-step-connector-completed-color':
      'rgba(30, 164, 126, 0.55)',
    '--theme-mithril-step-connector-error-color': 'rgba(200, 50, 50, 0.35)',
    '--theme-mithril-sub-item-active-color': 'rgba(55, 62, 72, 0.9)',
    '--theme-mithril-sub-item-pending-color': 'rgba(130, 140, 155, 0.72)',
    '--theme-mithril-sub-item-completed-color': 'rgba(80, 145, 120, 0.8)',
    '--theme-mithril-sub-item-error-color': 'rgba(200, 50, 50, 0.85)',
    '--theme-mithril-sub-item-icon-success-color': 'rgba(30, 164, 126, 0.8)',
    '--theme-mithril-sub-item-icon-spinner-color': 'rgba(55, 62, 72, 0.88)',
    '--theme-mithril-sub-item-icon-error-color': 'rgba(200, 50, 50, 0.88)',
    '--theme-mithril-sub-item-pending-background': 'rgba(180, 185, 195, 0.3)',
    '--theme-mithril-progress-track-color': 'rgba(180, 185, 195, 0.2)',
    '--theme-mithril-progress-complete-color': 'rgba(30, 164, 126, 0.7)',
    '--theme-mithril-progress-meta-color': 'rgba(120, 130, 145, 0.75)',
    '--theme-mithril-scrollbar-thumb-color': 'rgba(180, 185, 195, 0.5)',
    '--theme-mithril-scrollbar-thumb-color-hover': 'rgba(150, 155, 165, 0.7)',
    '--theme-mithril-selector-background': 'rgba(242, 242, 244, 0.9)',
    '--theme-mithril-selector-option-background': 'rgba(252, 252, 253, 0.96)',
    '--theme-mithril-selector-border-color': 'rgba(180, 185, 195, 0.6)',
    '--theme-mithril-selector-button-background': 'rgba(242, 242, 244, 0.95)',
    '--theme-mithril-selector-button-background-hover':
      'rgba(232, 232, 234, 0.98)',
    '--theme-mithril-icon-color': 'rgba(45, 48, 55, 0.95)',
    '--theme-mithril-error-background': 'rgba(220, 80, 80, 0.12)',
    '--theme-mithril-error-border-color': 'rgba(200, 90, 95, 0.3)',
    '--theme-mithril-error-input-border-color': 'rgba(200, 90, 95, 0.65)',
    '--theme-mithril-error-text-color': 'rgba(160, 40, 45, 0.96)',
  ...
  governance: {
    ...
    '--theme-gov-badge-neutral-background': '#2d2d2d14',
    '--theme-gov-badge-neutral-color': '#2d2d2df2',
    '--theme-gov-badge-success-background': '#2dc06c1f',
    '--theme-gov-badge-success-color': '#007226',
    '--theme-gov-badge-warning-background': '#f2a2181f',
    '--theme-gov-badge-warning-color': '#945500',
    '--theme-gov-badge-danger-background': '#ea4c5b1f',
    '--theme-gov-badge-danger-color': '#b20732',
  },
  staking: {
  ...
  widgets: {
    ...
    '--theme-widgets-separator-color': 'rgba(45, 45, 45, 0.15)',
  ...
  chainStorage: {
    '--theme-chain-storage-heading-color': 'rgba(30, 30, 30, 0.98)',
    '--theme-chain-storage-body-text-color': 'rgba(80, 85, 95, 0.9)',
    '--theme-chain-storage-secondary-text-color': 'rgba(110, 115, 125, 0.9)',
    '--theme-chain-storage-bright-text-color': 'rgba(45, 45, 50, 0.95)',
    '--theme-chain-storage-card-text-color': 'rgba(60, 64, 72, 0.92)',
    '--theme-chain-storage-panel-background': 'rgba(235, 235, 238, 0.6)',
    '--theme-chain-storage-panel-border-color': 'rgba(200, 202, 208, 0.6)',
    '--theme-chain-storage-button-primary-background': '#29b595',
    '--theme-chain-storage-button-primary-background-hover': '#3bc5a5',
    '--theme-chain-storage-button-primary-text-color': '#ffffff',
    ...
    '--theme-chain-storage-selector-button-background-hover':
      'rgba(232, 232, 234, 0.98)',
    '--theme-chain-storage-icon-color': 'rgba(45, 48, 55, 0.95)',
    '--theme-chain-storage-error-background': 'rgba(220, 80, 80, 0.12)',
    '--theme-chain-storage-error-border-color': 'rgba(200, 90, 95, 0.3)',
    '--theme-chain-storage-error-input-border-color': 'rgba(200, 90, 95, 0.65)',
    '--theme-chain-storage-error-text-color': 'rgba(160, 40, 45, 0.96)',
  },
  walletSettings: {
