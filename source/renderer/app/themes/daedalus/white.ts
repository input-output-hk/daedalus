...
export const WHITE_THEME_OUTPUT = {
  aboutWindow: {
    ...
    '--theme-about-window-icon-close-hover-background': 'rgba(41, 181, 149, 0.1)'
  },
  appUpdate: {
    ...
    '--theme-node-update-deny-button-background-color': 'rgba(41, 181, 149, 0.1)',
    '--theme-node-update-deny-button-background-color-hover': 'rgba(41, 181, 149, 0.05)',
    '--theme-node-update-deny-button-background-color-active': 'rgba(41, 181, 149, 0.12)',
  ...
  automaticUpdate: {
    ...
    '--theme-automatic-update-overlay-button-label-color-light': 'rgba(41, 181, 149, 0.8)',
    '--theme-automatic-update-overlay-close-button-color': 'rgba(45, 45, 45, 1)',
    '--theme-automatic-update-overlay-close-button-hover-background': 'rgba(41, 181, 149, 0.1)'
  },
  backToTopButton: {
  ...
  dapps: {
    ...
    '--theme-dapp-transaction-request-toggle-button-background-color': 'rgba(45, 45, 45, 0.1)',
    '--theme-dapp-transaction-request-code-background-color': 'rgba(45, 45, 45, 0.05)'
  },
  dataMigration: {
  ...
  delegationSetupWizard: {
    ...
    '--theme-delegation-steps-choose-stake-pool-checkmark-icon-color': 'rgba(45, 45, 45, 0.1)',
    '--theme-delegation-steps-choose-stake-pool-delegated-pools-label-color': '#2d2d2d',
    '--theme-delegation-steps-choose-stake-pool-ticker-color': 'rgba(45, 45, 45, 0.1)',
    '--theme-delegation-steps-choose-stake-pool-select-box-placeholder-color': 'rgba(45, 45, 45, 0.1)',
    ...
    '--theme-delegation-steps-choose-stake-pool-thumb-border-color': 'rgba(45, 45, 45, 0.1)',
    '--theme-delegation-steps-choose-stake-pool-title-color': '#2d2d2d',
    '--theme-delegation-steps-choose-stake-pool-tooltip-arrow-color': '#2d2d2de6',
    '--theme-delegation-steps-choose-stake-pool-tooltip-background-color': '#2d2d2de6',
    '--theme-delegation-steps-choose-stake-pool-tooltip-box-shadow': '0 5px 20px 0 rgba(0, 0, 0, 0.25)',
    '--theme-delegation-steps-choose-stake-pool-tooltip-description-color': '#fafbfc',
    '--theme-delegation-steps-choose-stake-pool-tooltip-ticker-color': '#2d2d2d99',
    '--theme-delegation-steps-choose-stake-pool-tooltip-table-label-color': '#fafbfc',
    '--theme-delegation-steps-choose-stake-pool-tooltip-table-value-color': '#fafbfc',
    ...
    '--theme-delegation-steps-choose-wallet-description-highlighted-color': '#2d2d2d',
    '--theme-delegation-steps-choose-wallet-error-message-color': '#ea4c5b',
    '--theme-delegation-steps-choose-wallet-error-message-light-color': '#ea4c5bb3',
    '--theme-delegation-steps-choose-wallet-error-select-options-color': '#2d2d2d',
    ...
    '--theme-delegation-steps-intro-divider-border-color': 'rgba(45, 45, 45, 0.1)',
    ...
    '--theme-delegation-steps-not-available-description-text-color': '#2d2d2dcc',
    '--theme-delegation-steps-not-available-description-highlight-text-color': '#2d2d2d',
  ...
  dialog: {
    ...
    '--theme-dialog-set-wallet-password-background-color': 'rgba(255, 255, 255, 0.96)',
    ...
    '--theme-dialog-set-wallet-password-button-background-color': 'rgba(41, 181, 149, 0.1)',
    '--theme-dialog-set-wallet-password-button-background-color-hover': '#29b595',
  ...
  hardwareWallet: {
    ...
    '--theme-hardware-wallet-status-passphrase-label-color': 'rgba(45, 45, 45, 0.5)'
  },
  icon: {
  ...
  navDropdown: {
    ...
    '--theme-nav-dropdown-item-background-color-hover': 'rgba(45, 45, 45, 0.07)',
  ...
  network: {
    ...
    '--theme-network-window-icon-close-hover-background': 'rgba(41, 181, 149, 0.1)',
    ...
    '--theme-network-window-button-background-color-hover': 'rgba(94, 96, 102, 0.6)',
    '--theme-network-window-button-background-color-active': 'rgba(94, 96, 102, 0.8)'
  },
  newsFeed: {
    ...
    '--theme-news-feed-icon-close-hover-background-color': 'rgba(41, 181, 149, 0.1)',
    ...
    '--theme-news-feed-icon-toggle-hover-background-color': 'rgba(41, 181, 149, 0.1)',
    '--theme-news-feed-no-fetch-color': '#2d2d2d',
    '--theme-news-feed-incident-overlay-background-color': 'rgba(255, 255, 255, 0.98)',
    '--theme-news-feed-incident-overlay-text-color': '#2d2d2d',
    '--theme-news-feed-incident-overlay-button-background': 'rgba(41, 181, 149, 0.1)',
    '--theme-news-feed-incident-overlay-button-color-hover': 'rgba(255, 255, 255, 1)',
    '--theme-news-feed-incident-overlay-button-color': '#29b595',
    '--theme-news-feed-incident-overlay-scrollbar-thumb-background': 'rgba(45, 45, 45, 0.3)',
    '--theme-news-feed-incident-overlay-scrollbar-thumb-background-hove': 'rgba(45, 45, 45, 0.5)',
    '--theme-news-feed-incident-overlay-content-list-color': 'rgba(45, 45, 45, 0.7)',
    '--theme-news-feed-incident-overlay-content-background': 'rgba(41, 181, 149, 0.1)',
  ...
  newsItem: {
    '--theme-news-item-action-button-background-color': 'rgba(41, 181, 149, 0.1)',
  ...
  newsUpdateOverlay: {
    ...
    '--theme-news-overlay-update-button-background-color': 'rgba(41, 181, 149, 0.1)',
  ...
  notification: {
    ...
    '--theme-legacy-notification-learn-more-button-background-color': '#f9f9f933',
    '--theme-legacy-notification-learn-more-button-background-color-hover': '#f9f9f94d',
    '--theme-legacy-notification-learn-more-button-background-color-active': '#f9f9f966',
    '--theme-legacy-notification-move-button-text-color': '#ab1700',
    '--theme-legacy-notification-move-button-background-color': '#fafbfc',
    '--theme-legacy-notification-move-button-background-color-hover': 'rgb(250, 251, 252, 0.9)',
  ...
  paperWallet: {
    '--theme-paper-wallet-create-certificate-dialog-explorer-link-color': '#29b595',
    '--theme-paper-wallet-create-certificate-dialog-explorer-link-background-color': 'rgba(94, 96, 102, 0.07)'
  },
  progressBar: {
    ...
    '--theme-progress-bar-large-progress-light-stripe-2-background-color': '#69cbb4'
  },
  receiveQRCode: {
  ...
  recoveryPhrase: {
    ...
    '--theme-recovery-phrase-attention-background-color': 'rgba(234, 76, 91, .1)',
    '--theme-recovery-phrase-paper-wallet-background-color': 'rgba(45, 45, 45, 0.1)',
    '--theme-recovery-phrase-paper-wallet-question-background-color': 'rgba(45, 45, 45, 0.3)',
  ...
  reportIssue: {
    ...
    '--theme-report-issue-connecting-background-color': 'rgba(45, 45, 45, 0.05)',
  ...
  settings: {
    ...
    '--theme-settings-delete-button-legacy-background-color': 'rgba(41, 181, 149, 0.1)',
    '--theme-settings-delete-button-legacy-background-color-hover': 'rgba(41, 181, 149, 1)',
    ...
    '--theme-settings-undelegate-wallet-divider-border-color': 'rgba(45, 45, 45, 0.1)',
  ...
  sidebar: {
    ...
    '--theme-sidebar-wallets-scrollbar-background-color': 'rgba(45, 45, 45, 0.3)',
    '--theme-sidebar-wallets-scrollbar-background-color-active': 'rgba(45, 45, 45, 0.5)',
    '--theme-sidebar-wallets-scrollbar-background-color-hover': 'rgba(45, 45, 45, 0.5)',
  ...
  splash: {
    ...
    '--theme-splash-network-overlay-button-background-color': 'rgba(41, 181, 149, 0.1)',
    ...
    '--theme-splash-network-scrollbar-thumb-background': 'rgba(45, 45, 45, 0.3)',
    '--theme-splash-network-scrollbar-thumb-background-hover': 'rgba(45, 45, 45, 0.5)',
    '--theme-splash-network-subTitle1-color': 'rgba(45, 45, 45, 0.5)',
    '--theme-splash-network-subTitle2-color': 'rgba(45, 45, 45, 0.5)',
    '--theme-splash-network-description-background-color': 'rgba(41, 181, 149, 0.1)',
  ...
  stakePools: {
    ...
    '--theme-staking-stake-pool-saturation-background-color': 'rgba(45, 45, 45, 0.2)',
    ...
    '--theme-staking-stake-pool-tooltip-delegate-button-background-color': '#29b595',
    '--theme-staking-stake-pool-tooltip-delegate-button-hover-background-color': '#54c4aa',
    '--theme-staking-stake-pool-tooltip-delegate-button-active-background-color': '#25a386',
    ...
    '--theme-staking-stake-pools-search-clear-button-background-color': 'rgba(41, 181, 149, 0.1)',
    '--theme-staking-stake-pools-search-clear-button-color': '#2d2d2d',
    '--theme-staking-stake-pools-search-clear-button-hover-background-color': 'rgba(41, 181, 149, 0.05)',
    '--theme-staking-stake-pool-tooltip-neutral-background-color': 'rgba(45, 45, 45, .1)',
  ...
  staking: {
    ...
    '--theme-staking-delegation-center-no-wallets-instructions-color': '#2d2d2d',
    '--theme-staking-delegation-center-divider-border-color': 'rgba(45, 45, 45, 0.1)',
    '--theme-staking-delegation-center-fees-amount-color': '#ea4c5b',
    '--theme-staking-countdown-widget-background-color': 'rgba(94, 96, 102, 0.07)',
    '--theme-staking-countdown-widget-delimeter-background-color': '#2d2d2d',
    '--theme-staking-countdown-widget-field-label-color': 'rgba(45, 45, 45, 0.7)',
    ...
    '--theme-staking-wallet-row-ticker-background-color': 'rgba(45, 45, 45, 0.07)',
  ...
  transactions: {
    ...
    '--theme-transactions-state-pending-background-color': 'rgba(45, 45, 45, 0.5)',
    ...
    '--theme-transactions-icon-type-pending-regular-background-color': 'rgba(45, 45, 45, 0.5)',
    ...
    '--theme-transactions-date-picker-button-background-color': 'rgba(41, 181, 149, 0.14)',
    '--theme-transactions-date-picker-button-background-color-hover': 'rgba(41, 181, 149, 0.07)',
    ...
    '--theme-transactions-filter-title-button-background-color': 'rgba(41, 181, 149, 0.1)',
    '--theme-transactions-filter-title-button-background-color-hover': 'rgba(41, 181, 149, 0.05)',
    '--theme-transactions-filter-title-button-background-color-active': 'rgba(41, 181, 149, 0.12)',
    '--theme-transactions-transfer-funds-selected-wallet-background-color': '#2d2d2d0d',
  ...
  tokens: {
    ...
    '--theme-tokens-list-header-expanded-background-color': 'rgba(41, 181, 149, 0.05)',
    '--theme-tokens-list-header-expanded-background-color-hover': 'rgba(41, 181, 149, 0.03)'
  },
  uploader: {
  ...
  voting: {
    ...
    '--theme-voting-registration-steps-activation-steps-indicator-color': '#2d2d2d',
    '--theme-voting-registration-steps-choose-wallet-error-message-color': '#ea4c5b',
    '--theme-voting-registration-steps-choose-wallet-error-message-light-color': '#ea4c5bb3',
    ...
    '--theme-voting-registration-steps-description-highlighted-color': '#2d2d2d',
  ...
  walletImportDialog: {
    ...
    '--theme-wallet-import-description-close-hover-background': 'rgba(0, 0, 0, 0.1)',
    ...
    '--theme-wallet-import-input-background-color-disabled': 'rgba(45, 45, 45, 0.05)',
    '--theme-wallet-import-input-border-color': 'rgba(45, 45, 45, 0.3)',
    '--theme-wallet-import-stateFolder-border-color': 'rgba(45, 45, 45, 0.3)',
    '--theme-wallet-import-stateFolder-button-background-color': 'rgba(45, 45, 45, 0.1)',
    '--theme-wallet-import-stateFolder-button-background-color-hover': 'rgba(45, 45, 45, 0.05)',
    '--theme-wallet-import-stateFolder-button-background-color-active': 'rgba(45, 45, 45, 0.12)',
  ...
  walletNotRespondingOverlay: {
    ...
    '--theme-wallet-not-responding-button-background-color': 'rgba(41, 181, 149, 0.1)',
    ...
    '--theme-wallet-not-responding-description-background-color': 'rgba(41, 181, 149, 0.1)',
    '--theme-wallet-not-responding-description-text-color': 'rgba(45, 45, 45, 0.7)',
  ...
  widgets: {
    '--theme-widgets-asset-token-fingerprint-background-color': 'rgba(45,45,45,0.1)',
