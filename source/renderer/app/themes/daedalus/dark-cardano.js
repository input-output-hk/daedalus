...
export const DARK_CARDANO_THEME_CONFIG = {
  rpAutocomplete: {
    '--rp-autocomplete-bg-color': '#a0a1a8',
    ...
    '--rp-autocomplete-selected-word-box-bg-color': '#5e5f71',
  ...
  rpButton: {
    ...
    '--rp-button-bg-color-disabled': '#1fc1c3',
    ...
    '--rp-button-padding': '0',
    '--rp-button-text-color': 'rgba(rgba(18, 19, 38, 1)',
    '--rp-button-text-color-disabled': 'rgba(rgba(18, 19, 38, 0.5)',
    '--rp-button-text-transform': 'none',
    '--rp-button-width': '360px',
  },
  rpCheckbox: {
    '--rp-checkbox-border': '1px solid #36374d',
    '--rp-checkbox-border-color-disabled': '#36374d66',
    '--rp-checkbox-check-bg-color': '#36374d',
  ...
  rpInput: {
    ...
    '--rp-input-bg-color-disabled': '#71717d',
  ...
  rpStepper: {
    '--rp-stepper-bullet-background-color-disabled': '#a0a1a8',
    '--rp-stepper-bullet-border-color': '#36374d1a',
    ...
    '--rp-stepper-main-color': '#36374d',
    '--rp-stepper-main-color-light': '#36374d1a',
    '--rpstepper-stepper-step-label-bottom-margin': '6px',
    '--rpstepper-steps-bar-color-disabled': '#36374d1a',
    '--rpstepper-steps-bar-top-position': '6px',
  },
  rpSwitch: {
    '--rp-switch-bg-color-off': '#36374d',
    '--rp-switch-bg-color-on': '#36374d',
  ...
  aboutWindow: {
    ...
    '--theme-about-window-icon-close-hover-background': '#313245',
  },
  adaRedemption: {
    '--theme-ada-redemption-headline-color': '#ffffff',
    '--theme-ada-redemption-instructions-color': '#ffffff',
    '--theme-ada-redemption-success-overlay-background-color': '#36374d',
    '--theme-ada-redemption-success-overlay-border-color': '#ffffff',
    '--theme-ada-redemption-success-overlay-message-color': '#ffffff',
    ...
    '--theme-ada-redemption-disclaimer-checkbox-color-check': '#a0a1a8',
    '--theme-ada-redemption-disclaimer-checkbox-color-checked': '#a0a1a8',
    '--theme-ada-redemption-disclaimer-checkbox-color-after': '#ea4c5b',
    '--theme-ada-redemption-disclaimer-checkbox-label-color': '#ffffff',
  ...
  button: {
    '--theme-button-spinner-color': '#a0a1a8',
  ...
  buttonFlat: {
    ...
    '--theme-button-flat-background-color-active': '#121326',
    '--theme-button-flat-background-color-disabled': '#71717d',
    '--theme-button-flat-text-color-disabled': '#ffffff',
    '--theme-button-flat-text-color': '#ffffff',
    '--theme-button-flat-outline-color': '#101122',
  },
  buttonPrimary: {
    ...
    '--theme-button-primary-outline-color': '#1fc1c3',
  },
  connecting: {
  ...
  dialog: {
    ...
    '--theme-dialog-big-button-background-color': 'rgba(18, 19, 38, 0.1)',
    '--theme-dialog-big-button-border-color': 'rgba(18, 19, 38, 0.1)',
  ...
  link: {
    '--theme-link-main-color': '#36374d',
  },
  loading: {
    '--theme-loading-background-color': '#121326',
    '--theme-loading-no-disk-space-background-color': '#121326',
  ...
  navItem: {
    ...
    '--theme-nav-item-background-color-hover': '#2b2c3e',
  ...
  nodeUpdate: {
    ...
    '--theme-node-update-deny-button-background-color': '#36374d',
    '--theme-node-update-deny-button-background-color-hover': '#5e5f71',
    '--theme-node-update-deny-button-background-color-active': '#262736',
  ...
  progressBar: {
    '--theme-progress-bar-background-color': '#4142514d',
    '--theme-progress-bar-foreground-color': '#414251b3',
  },
  receiveQRCode: {
  ...
  reportIssue: {
    ...
    '--theme-report-issue-syncing-background-color': '#121326',
  ...
  settings: {
    ...
    '--theme-settings-pane-background-color': '#a0a1a8',
    '--theme-settings-pane-border': '1px solid rgba(255, 255, 255, 0.2)',
    '--theme-settings-menu-box-background-color': '#a0a1a8',
  ...
  stakePools: {
    ...
    '--theme-staking-stake-pool-background-color': '#a0a1a8',
    ...
    '--theme-staking-stake-pool-tooltip-background-color': '#a0a1a8f7',
    ...
    '--theme-staking-stake-pool-tooltip-link-color': '#313245',
  ...
  staking: {
    ...
    '--theme-staking-table-head-background-color': '#121326',
    '--theme-staking-table-border-color': 'rgba(255, 255, 255, 0.2)',
    '--theme-staking-link-color': '#36374d',
    '--theme-staking-link-color-light': '#5e5f71',
    '--theme-staking-progress-bar-background-color': '#121326',
    '--theme-staking-progress-stripe-dark-1-background-color': '#313245',
    '--theme-staking-progress-stripe-dark-2-background-color': '#36374d',
    '--theme-staking-table-body-highlighted-text-color': '#313245',
    '--theme-staking-info-learn-more-button-color': '#a0a1a8',
    '--theme-staking-info-learn-more-icon-color': '#ffffff',
    '--theme-staking-learn-more-button-color': '#a0a1a8',
    '--theme-staking-learn-more-icon-color': '#ffffff',
    ...
    '--theme-staking-dropdown-item-background-color': '#a0a1a8',
    '--theme-staking-dropdown-item-background-color-hover': '#1213261a',
  ...
  transactions: {
    ...
    '--theme-transactions-state-failed-background-color': '#101122',
    '--theme-transactions-state-failed-text-color': '#ffffff',
    '--theme-transactions-state-pending-background-color': '#101122',
    '--theme-transactions-state-pending-stripes-color': '#0e0f1e',
