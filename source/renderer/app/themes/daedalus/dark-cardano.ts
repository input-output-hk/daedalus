...
export const DARK_CARDANO_THEME_OUTPUT = {
  ...
  paperWallet: {
    '--theme-paper-wallet-create-certificate-dialog-explorer-link-color': '#1fc1c3',
  ...
  progressBar: {
    ...
    '--theme-progress-bar-large-progress-light-stripe-2-background-color': '#1fc1c3'
  },
  receiveQRCode: {
  ...
  stakePools: {
    ...
    '--theme-staking-stake-pool-tooltip-delegate-button-background-color': '#1fc1c3',
    '--theme-staking-stake-pool-tooltip-delegate-button-hover-background-color': '#26e7eb',
    '--theme-staking-stake-pool-tooltip-delegate-button-active-background-color': '#1cabad',
  ...
  transactions: {
    ...
    '--theme-transactions-filter-button-shadow-color': 'rgba(31, 193, 195, 0.18)',
