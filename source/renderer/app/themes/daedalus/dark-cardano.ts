...
export const DARK_CARDANO_THEME_OUTPUT = {
  ...
  mithrilBootstrap: {
    ...
    '--theme-mithril-button-primary-background': '#1fc1c3',
    '--theme-mithril-button-primary-background-hover': '#32d2d4',
    '--theme-mithril-button-primary-text-color': '#0a1415',
    ...
    '--theme-mithril-link-color': 'rgba(80, 210, 212, 0.96)',
    '--theme-mithril-link-color-hover': 'rgba(120, 230, 232, 0.98)',
  ...
  chainStorage: {
    ...
    '--theme-chain-storage-button-primary-background': '#1fc1c3',
    '--theme-chain-storage-button-primary-background-hover': '#32d2d4',
    '--theme-chain-storage-button-primary-text-color': '#0a1415',
