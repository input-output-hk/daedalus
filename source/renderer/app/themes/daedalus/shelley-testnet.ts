...
export const SHELLEY_TESTNET_THEME_OUTPUT = {
  ...
  mithrilBootstrap: {
    ...
    '--theme-mithril-panel-background': 'rgba(36, 37, 59, 0.6)',
    '--theme-mithril-panel-border-color': 'rgba(72, 73, 95, 0.6)',
    '--theme-mithril-context-panel-background': 'rgba(36, 37, 59, 0.42)',
    '--theme-mithril-button-primary-background': '#898ee6',
    '--theme-mithril-button-primary-background-hover': '#9a9ef0',
    '--theme-mithril-button-primary-text-color': '#0e0f18',
    '--theme-mithril-button-secondary-border-color': 'rgba(94, 95, 117, 0.6)',
    '--theme-mithril-button-secondary-border-color-hover':
      'rgba(114, 115, 137, 0.9)',
    '--theme-mithril-button-secondary-text-color': 'rgba(225, 233, 242, 0.92)',
    '--theme-mithril-button-secondary-text-color-hover':
      'rgba(255, 255, 255, 0.98)',
    '--theme-mithril-link-color': 'rgba(150, 155, 230, 0.96)',
    '--theme-mithril-link-color-hover': 'rgba(180, 185, 245, 0.98)',
    ...
    '--theme-mithril-step-icon-pending-background': 'rgba(94, 95, 117, 0.35)',
    '--theme-mithril-step-connector-color': 'rgba(94, 95, 117, 0.22)',
    ...
    '--theme-mithril-sub-item-pending-background': 'rgba(94, 95, 117, 0.3)',
    '--theme-mithril-progress-track-color': 'rgba(94, 95, 117, 0.2)',
    '--theme-mithril-progress-complete-color': 'rgba(30, 164, 126, 0.7)',
    '--theme-mithril-progress-meta-color': 'rgba(100, 101, 123, 0.75)',
    '--theme-mithril-scrollbar-thumb-color': 'rgba(94, 95, 117, 0.5)',
    '--theme-mithril-scrollbar-thumb-color-hover': 'rgba(114, 115, 137, 0.7)',
    '--theme-mithril-selector-background': 'rgba(48, 49, 71, 0.9)',
    '--theme-mithril-selector-option-background': 'rgba(60, 61, 83, 0.96)',
    '--theme-mithril-selector-border-color': 'rgba(94, 95, 117, 0.6)',
    '--theme-mithril-selector-button-background': 'rgba(60, 61, 83, 0.95)',
  ...
  staking: {
    ...
    '--theme-staking-progress-bar-background-color':
      'rgba(255, 255, 255, 0.07)',
    '--theme-staking-progress-stripe-dark-1-background-color': '#676ddf',
    '--theme-staking-progress-stripe-dark-2-background-color': '#898ee6',
    '--theme-staking-slider-background-color-1': '#898ee6',
    ...
    '--theme-staking-redeemItnRewards-description-text-color': '#ffffff',
  ...
  chainStorage: {
    ...
    '--theme-chain-storage-panel-background': 'rgba(36, 37, 59, 0.6)',
    '--theme-chain-storage-panel-border-color': 'rgba(72, 73, 95, 0.6)',
    '--theme-chain-storage-button-primary-background': '#898ee6',
    '--theme-chain-storage-button-primary-background-hover': '#9a9ef0',
    '--theme-chain-storage-button-primary-text-color': '#0e0f18',
