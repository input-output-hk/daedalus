...
export const SHELLEY_TESTNET_THEME_OUTPUT = {
  ...
  delegationSetupWizard: {
    ...
    '--theme-delegation-steps-choose-stake-pool-ticker-color': 'rgba(255, 255, 255, 0.2)',
  ...
  dialog: {
    ...
    '--theme-dialog-set-wallet-password-background-color': 'rgba(42, 43, 60, 0.96)',
  ...
  newsItem: {
    ...
    '--theme-news-item-announcement-background-color': 'rgba(137, 142, 230, 0.2)',
  ...
  paperWallet: {
    '--theme-paper-wallet-create-certificate-dialog-explorer-link-color': '#898ee6',
  ...
  progressBar: {
    ...
    '--theme-progress-bar-large-progress-light-stripe-2-background-color': '#898ee6'
  },
  receiveQRCode: {
  ...
  stakePools: {
    ...
    '--theme-staking-stake-pool-tooltip-delegate-button-background-color': '#898ee6',
    '--theme-staking-stake-pool-tooltip-delegate-button-hover-background-color': '#abaeed',
    '--theme-staking-stake-pool-tooltip-delegate-button-active-background-color': '#676ddf',
  ...
  transactions: {
    ...
    '--theme-transactions-filter-button-shadow-color': 'rgba(137, 142, 230, 0.18)',
