...
export const updateTheme = (existingTheme: Record<string, any>, themeUpdates: Record<string, any>) => {
  let updateEntries = [];
  ...
  const updatedTheme = Object.entries(themeUpdates).reduce((theme: Record<string, any>, newEntry: [string, Record<string, any>]) => {
...
export const createReactPolymorphTheme = (themeParts: PartialThemeParts): Record<string, any> => {
  const {
    colors,
    fonts
  } = themeParts;
  ...
  return {
    rpAutocomplete: {
      ...
      '--rp-autocomplete-placeholder-color': `${chroma(text.primary).alpha(0.5)}`,
      ...
      '--rp-autocomplete-required-words-color': `${chroma(text.primary).alpha(0.5)}`,
    ...
    rpBubble: {
      ...
      '--rp-bubble-box-shadow': '0 4px 16px 0 rgba(0, 0, 0, 0.12), 0 0 8px 0 rgba(0, 0, 0, 0.06)',
    ...
    rpCheckbox: {
      ...
      '--rp-checkbox-border-color-disabled': `${chroma(background.secondary.regular).alpha(0.4)}`,
      ...
      '--rp-checkbox-label-text-color-disabled': `${chroma(text.primary).alpha(0.3)}`,
    ...
    rpInput: {
      ...
      '--rp-input-placeholder-color-disabled': `${chroma(text.primary).alpha(0.5)}`,
    ...
    rpStepper: {
      ...
      '--rp-stepper-bullet-border-color': `${chroma(background.secondary.regular).alpha(0.1)}`,
      ...
      '--rp-stepper-main-color-light': `${chroma(background.secondary.regular).alpha(0.1)}`,
      '--rpstepper-stepper-step-label-bottom-margin': '6px',
      '--rpstepper-steps-bar-color-disabled': `${chroma(background.secondary.regular).alpha(0.1)}`,
    ...
    rpTextArea: {
      ...
      '--rp-textarea-bg-color-disabled': `${chroma(background.primary.regular).alpha(0.5)}`,
...
export const createDaedalusComponentsTheme = (themeParts: PartialThemeParts): Record<string, any> => {
  const {
    colors,
    fonts
  } = themeParts;
  ...
  return {
    aboutWindow: {
      '--theme-about-window-background-color': `${chroma(background.secondary.regular).alpha(0.96)}`,
      '--theme-about-window-header-bottom-border-color': `${chroma(text.secondary).alpha(0.3)}`,
      ...
      '--theme-about-window-content-bottom-border-color': `${chroma(text.secondary).alpha(0.3)}`,
    ...
    automaticUpdate: {
      '--theme-automatic-update-overlay-background-color': `${chroma(background.secondary.regular).alpha(0.96)}`,
      ...
      '--theme-automatic-update-overlay-text-color': `${chroma(text.secondary).alpha(0.7)}`,
      ...
      '--theme-automatic-update-overlay-button-label-color-light': `${chroma(text.secondary).alpha(0.8)}`,
    ...
    connecting: {
      ...
      '--theme-connecting-background-color1': `${chroma(background.secondary.regular).alpha(1)}`,
      '--theme-connecting-background-color2': `${chroma(background.secondary.regular).alpha(0.91)}`,
      '--theme-connecting-background-color3': `${chroma(background.secondary.regular).alpha(0.31)}`,
      '--theme-connecting-background-color4': `${chroma(background.secondary.regular).alpha(0)}`,
      '--theme-connecting-background-color5': `${chroma(background.secondary.regular).alpha(0)}`,
      '--theme-connecting-background-color6': `${chroma(background.secondary.regular).alpha(0.31)}`,
      '--theme-connecting-background-color7': `${chroma(background.secondary.regular).alpha(0.91)}`,
      '--theme-connecting-background-color8': `${chroma(background.secondary.regular).alpha(1)}`,
    ...
    delegationSetupWizard: {
      ...
      '--theme-delegation-steps-success-description-color': `${chroma(text.primary).alpha(0.8)}`,
      ...
      '--theme-delegation-steps-choose-stake-pool-thumb-border-color': `${chroma(border).alpha(0.2)}`,
      '--theme-delegation-steps-choose-stake-pool-title-color': `${text.primary}`,
      '--theme-delegation-steps-choose-stake-pool-tooltip-arrow-color': `${chroma(text.primary).alpha(0.9)}`,
      '--theme-delegation-steps-choose-stake-pool-tooltip-background-color': `${chroma(text.primary).alpha(0.9)}`,
      '--theme-delegation-steps-choose-stake-pool-tooltip-box-shadow': '0 5px 20px 0 rgba(0, 0, 0, 0.25)',
      '--theme-delegation-steps-choose-stake-pool-tooltip-description-color': `${text.secondary}`,
      '--theme-delegation-steps-choose-stake-pool-tooltip-ticker-color': `${chroma(text.primary).alpha(0.6)}`,
      ...
      '--theme-delegation-steps-choose-wallet-description-color': `${chroma(text.primary).alpha(0.8)}`,
      ...
      '--theme-delegation-steps-choose-wallet-error-message-light-color': `${chroma(error.regular).alpha(0.7)}`,
      ...
      '--theme-delegation-steps-confirmation-description-color': `${chroma(text.primary).alpha(0.8)}`,
      ...
      '--theme-delegation-steps-intro-content-text-color': `${chroma(text.primary).alpha(0.8)}`,
      ...
      '--theme-delegation-steps-intro-list-optional-label-color': `${chroma(text.primary).alpha(0.5)}`,
      '--theme-delegation-steps-not-available-description-text-color': `${chroma(text.primary).alpha(0.8)}`,
      ...
      '--theme-delegation-steps-not-available-subtitle-text-color': text.primary
    },
    dialog: {
      ...
      '--theme-dialog-set-wallet-password-background-color': `${chroma(background.primary.regular).alpha(0.96)}`,
      '--theme-dialog-set-wallet-password-box-shadow': `${chroma(background.primary.regular).alpha(0.25)}`,
      '--theme-dialog-set-wallet-password-message-color': `${text.primary}`,
      '--theme-dialog-set-wallet-password-title-color': `${text.primary}`,
      '--theme-dialog-set-wallet-password-button-background-color': `${chroma(background.primary.regular).alpha(0.15)}`,
      ...
      '--theme-dialog-fullsize-background-color': `${chroma(background.secondary.regular).alpha(0.96)}`,
      ...
      '--theme-dialog-fullsize-text-color': `${chroma(text.secondary).alpha(0.7)}`,
    ...
    hardwareWallet: {
      ...
      '--theme-hardware-wallet-status-passphrase-label-color': `${chroma(text.secondary).alpha(0.5)}`
    },
    icon: {
    ...
    input: {
      ...
      '--theme-input-right-floating-text-color': `${chroma(text.primary).alpha(0.5)}`,
      '--theme-input-right-floating-text-success-color': `${chroma(text.primary).alpha(1)}`,
    ...
    appUpdateOverlay: {
      '--theme-app-update-overlay-background-color': `${chroma(background.secondary.regular).alpha(0.96)}`,
      ...
      '--theme-app-update-overlay-opacity-text-color': `${chroma(text.secondary).alpha(0.7)}`,
    ...
    navDropdown: {
      ...
      '--theme-nav-dropdown-item-background-color-hover': `${chroma(background.primary.regular).alpha(0.07)}`,
    ...
    network: {
      '--theme-network-window-background-color': `${chroma(background.secondary.regular).alpha(0.96)}`,
      ...
      '--theme-network-window-border-color': `${chroma(text.secondary).alpha(0.7)}`,
      '--theme-network-window-button-text-color': `${text.secondary}`,
      '--theme-network-window-button-background-color': `${chroma(background.secondary.lightest).alpha(0.4)}`,
      '--theme-network-window-button-background-color-hover': `${chroma(background.secondary.lightest).alpha(0.6)}`,
      '--theme-network-window-button-background-color-active': `${chroma(background.secondary.lightest).alpha(0.8)}`
    },
    newsFeed: {
      ...
      '--theme-news-feed-header-box-shadow-color': '0 10px 10px -5px rgba(0, 0, 0, 0.25)',
      ...
      '--theme-news-feed-icon-toggle-hover-background-color': 'rgba(0, 0, 0, 0.1)',
      '--theme-news-feed-no-fetch-color': '#fafbfc',
      '--theme-news-feed-incident-overlay-background-color': `${chroma(background.secondary.regular).alpha(0.96)}`,
      '--theme-news-feed-incident-overlay-text-color': `${text.primary}`,
      '--theme-news-feed-incident-overlay-button-color': `${text.primary}`,
      '--theme-news-feed-incident-overlay-scrollbar-thumb-background': `${chroma(text.primary).alpha(0.3)}`,
      '--theme-news-feed-incident-overlay-scrollbar-thumb-background-hove': `${chroma(text.primary).alpha(0.3)}`,
      '--theme-news-feed-incident-overlay-content-list-color': `${chroma(text.primary).alpha(0.7)}`,
      '--theme-news-feed-incident-overlay-content-background': 'rgba(0, 0, 0, 0.1)',
      '--theme-news-feed-incident-overlay-button-background': 'rgba(0, 0, 0, 0.1)',
      '--theme-news-feed-incident-overlay-button-color-hover': `${chroma(background.secondary.regular).alpha(0.96)}`,
      '--theme-news-feed-incident-grey-overlay-background-color': 'rgba(68, 68, 68, 0.98)',
      ...
      '--theme-news-feed-incident-grey-overlay-scrollbar-thumb-background': `${chroma(text.primary).alpha(0.3)}`,
      '--theme-news-feed-incident-grey-overlay-scrollbar-thumb-background-hove': `${chroma(text.primary).alpha(0.5)}`,
      '--theme-news-feed-incident-grey-overlay-content-list-color': `${chroma(text.primary).alpha(0.7)}`,
      '--theme-news-feed-incident-red-overlay-background-color': 'rgba(171, 23, 0, 0.98)',
      ...
      '--theme-news-feed-incident-red-overlay-scrollbar-thumb-background': `${chroma(text.primary).alpha(0.3)}`,
      '--theme-news-feed-incident-red-overlay-scrollbar-thumb-background-hove': `${chroma(text.primary).alpha(0.5)}`,
      '--theme-news-feed-incident-red-overlay-content-list-color': `${chroma(text.primary).alpha(0.7)}`
    },
    newsItem: {
      ...
      '--theme-news-item-announcement-background-color': 'rgba(234, 76, 91, 0.25)',
    ...
    newsUpdateOverlay: {
      ...
      '--theme-news-overlay-update-subtitle-text-color': 'rgba(250, 251, 252, 0.7)',
      '--theme-news-overlay-update-content-background-color': 'rgba(0, 0, 0, 0.1)',
    ...
    notification: {
      '--theme-notification-message-background-color': `${chroma(background.secondary.regular).alpha(0.95)}`,
      ...
      '--theme-legacy-notification-learn-more-button-background-color': `${chroma(background.primary.regular).alpha(0.2)}`,
      '--theme-legacy-notification-learn-more-button-background-color-hover': `${chroma(background.primary.regular).alpha(0.3)}`,
      '--theme-legacy-notification-learn-more-button-background-color-active': `${chroma(background.primary.regular).alpha(0.4)}`,
      ...
      '--theme-legacy-notification-move-button-background-color-hover': `${chroma(background.primary.regular).alpha(0.9)}`,
      '--theme-legacy-notification-move-button-background-color-active': `${chroma(background.primary.regular).alpha(0.8)}`,
    ...
    progressBar: {
      '--theme-progress-bar-background-color': `${chroma(background.primary.light).alpha(0.3)}`,
      '--theme-progress-bar-foreground-color': `${chroma(background.primary.light).alpha(0.7)}`,
    ...
    recoveryPhrase: {
      ...
      '--theme-recovery-phrase-warning-background-color': 'rgba(68, 91, 124, 0.05)'
    },
    walletImportDialog: {
      ...
      '--theme-wallet-import-description-close-hover-background': `${chroma(background.secondary.regular).alpha(0.16)}`,
      '--theme-wallet-import-description-color': `${chroma(text.primary).alpha(0.7)}`,
      ...
      '--theme-wallet-import-input-border-color': `${chroma(text.primary).alpha(0.3)}`,
      '--theme-wallet-import-title-color': `${text.primary}`,
      '--theme-wallet-import-stateFolder-border-color': `${chroma(text.primary).alpha(0.5)}`,
      '--theme-wallet-import-stateFolder-button-background-color': `${chroma(text.primary).alpha(0.1)}`,
      '--theme-wallet-import-stateFolder-button-background-color-hover': `${chroma(text.primary).alpha(0.05)}`,
      '--theme-wallet-import-stateFolder-button-background-color-active': `${chroma(text.primary).alpha(0.12)}`,
    ...
    settings: {
      ...
      '--theme-settings-menu-item-text-color-disabled': `${chroma(text.primary).alpha(0.5)}`,
    ...
    sidebar: {
      ...
      '--theme-sidebar-menu-add-button-background-color-active': `${chroma(background.secondary.darkest).alpha(0.66)}`,
      '--theme-sidebar-menu-add-button-background-color-hover': `${chroma(background.secondary.darkest).alpha(0.66)}`,
      '--theme-sidebar-menu-add-button-text-color': `${text.secondary}`,
      '--theme-sidebar-wallets-scrollbar-background-color': 'rgba(255, 255, 255, 0.1)',
      '--theme-sidebar-wallets-scrollbar-background-color-active': 'rgba(255, 255, 255, 0.3)',
      '--theme-sidebar-wallets-scrollbar-background-color-hover': 'rgba(255, 255, 255, 0.3)'
    },
    splash: {
      ...
      '--theme-splash-network-scrollbar-thumb-background': `${chroma(text.secondary).alpha(0.3)}`,
      '--theme-splash-network-scrollbar-thumb-background-hover': `${chroma(text.secondary).alpha(0.5)}`,
      '--theme-splash-network-description-background-color': 'rgba(255, 255, 255, 0.1)',
    ...
    stakePools: {
      ...
      '--theme-staking-stake-pool-saturation-background-color': `${chroma(text.secondary).alpha(0.2)}`,
      ...
      '--theme-staking-stake-pools-search-clear-button-background-color': 'rgba(68, 91, 124, 0.05)',
      ...
      '--theme-staking-stake-pool-tooltip-neutral-background-color': `${chroma(background.secondary.regular).alpha(0.1)}`,
      ...
      '--theme-staking-stake-pool-tooltip-delegate-button-border-color': 'transparent',
    ...
    staking: {
      ...
      '--theme-staking-font-color-lighter': `${chroma(text.primary).alpha(0.5)}`,
      ...
      '--theme-staking-slider-box-shadow-color': `${chroma(background.primary.regular).alpha(0.25)}`,
      ...
      '--theme-staking-wallet-row-ticker-ada-icon-fill-color': `${chroma(text.primary).alpha(0.5)}`,
      ...
      '--theme-staking-dropdown-item-background-color-hover': `${chroma(background.primary.regular).alpha(0.1)}`,
      '--theme-staking-delegation-center-gear-icon-fill-color': `${chroma(text.primary).alpha(0.5)}`,
      ...
      '--theme-staking-countdown-widget-field-label-color': `${chroma(background.primary.light).alpha(0.7)}`,
      '--theme-staking-countdown-widget-field-value-color': `${text.primary}`,
      '--theme-staking-export-button-shadow-color': `${chroma(background.primary.regular).alpha(0.18)}`,
      ...
      '--theme-staking-redeemItnRewards-description-text-color': `${chroma(background.primary.light).alpha(0.7)}`,
    ...
    transactions: {
      ...
      '--theme-transactions-header-texct-color': `${chroma(text.primary).alpha(0.5)}`,
      ...
      '--theme-transactions-filter-button-shadow-color': `${chroma(background.primary.regular).alpha(0.18)}`,
      ...
      '--theme-transactions-filter-date-picker-shadow': '0 5px 20px 0 rgba(0, 0, 0, 0.25)',
      ...
      '--theme-transactions-filter-title-button-background-color-hover': `${chroma(background.primary.regular).alpha(0.5)}`,
      '--theme-transactions-filter-title-button-background-color-active': `${background.primary.regular}`,
      '--theme-transactions-transfer-funds-selected-wallet-background-color': `${chroma(focus).alpha(0.05)}`
    },
    uploader: {
    ...
    utxo: {
      '--theme-utxo-background-color': `${chroma(background.primary.regular).alpha(0.5)}`,
      '--theme-utxo-title-text-color': `${text.primary}`,
      '--theme-utxo-title-description-color': `${chroma(text.primary).alpha(0.7)}`,
      '--theme-utxo-bar-color': `${chroma(background.secondary.dark).alpha(0.5)}`,
      '--theme-utxo-label-text-color': `${chroma(text.primary).alpha(0.45)}`,
      '--theme-utxo-tick-text-color': `${chroma(text.primary).alpha(0.45)}`,
      '--theme-utxo-cursor-background-color': `${chroma(background.secondary.lightest).alpha(0.2)}`,
      '--theme-utxo-tooltip-background-color': `${chroma(background.primary.darkest)}`,
    ...
    voting: {
      ...
      '--theme-voting-info-background-color': `${chroma(background.primary.darkest)}`,
      ...
      '--theme-voting-registration-steps-choose-wallet-error-message-light-color': `${chroma(error.regular).alpha(0.7)}`,
      ...
      '--theme-voting-registration-steps-description-color': `${chroma(text.primary).alpha(0.8)}`,
    ...
    walletRestoreDialog: {
      '--theme-wallet-restore-dialog-new-label-background-color': `${chroma(background.primary.regular).alpha(0.1)}`,
    ...
    walletSettings: {
      '--theme-wallet-settings-section-separator-color': `${chroma(text.primary).alpha(0.1)}`
    },
    walletNotRespondingOverlay: {
      '--theme-wallet-not-responding-background-color': `${chroma(background.secondary.regular).alpha(0.96)}`,
    ...
    widgets: {
      '--theme-widgets-asset-token-background-color': `${chroma(background.primary.regular).alpha(0.5)}`,
      '--theme-widgets-asset-token-fingerprint-background-color': `rgba(${chroma(focus).alpha(0.1).rgba()})`,
      '--theme-widgets-asset-token-text-color': `${text.primary}`
    }
  };
};
export const createTheme = (fullThemeParts: CreateThemeParams): Record<string, any> => {
  const {
    colors: themeColors,
    config,
    fonts: themeFonts
  ...
  if (colors && !isEmpty(colors) && fonts && !isEmpty(fonts)) {
    daedalusTheme = { ...createReactPolymorphTheme({
        colors,
        fonts
      }),
