...
const createDaedalusComponentsTheme = (
  ...
  return {
    ...
    buttonFlat: {
      '--theme-button-flat-background-color': `${}`,
      ...
      '--theme-button-flat-text-color-disabled': `${}`,
      '--theme-button-flat-text-color': `${}`,
      '--theme-button-flat-outline-color': `${}`,
    },
    buttonPrimary: {
    ...
    input: {
      ...
      '--theme-input-remove-color-dark': `${}`,
      '--theme-input-remove-color-light': `${}`,
      '--theme-input-remove-color-lighter': `${}`,
      '--theme-input-remove-color-lightest': `${}`,
      '--theme-input-background-color': `${}`,
      '--theme-input-disabled-background-color': `${}`,
