...
exports.createTheme = exports.createDaedalusComponentsTheme = exports.createReactPolymorphTheme = exports.updateTheme = void 0;
const chroma_js_1 = __importDefault(require('chroma-js'));
const lodash_1 = require('lodash');
const createShades_1 = require('./createShades');
const updateTheme = (existingTheme, themeUpdates) => {
  let updateEntries = [];
  for (const key in themeUpdates) {
    if (key && !(0, lodash_1.isEmpty)(themeUpdates[key])) {
  ...
  const updatedTheme = Object.entries(themeUpdates).reduce(
    (theme, newEntry) => {
      ...
      if (keyName && (0, lodash_1.has)(theme, keyName)) {
...
const createReactPolymorphTheme = (themeParts) => {
  ...
  return {
    rpAutocomplete: {
      ...
      '--rp-autocomplete-placeholder-color': `${(0, chroma_js_1.default)(
        text.primary
      ).alpha(0.5)}`,
      ...
      '--rp-autocomplete-required-words-color': `${(0, chroma_js_1.default)(
        text.primary
      ).alpha(0.5)}`,
    ...
    rpCheckbox: {
      ...
      '--rp-checkbox-border-color-disabled': `${(0, chroma_js_1.default)(
      ...
      '--rp-checkbox-label-text-color-disabled': `${(0, chroma_js_1.default)(
        text.primary
      ).alpha(0.3)}`,
    ...
    rpInput: {
      ...
      '--rp-input-border-color-disabled': `${(0, chroma_js_1.default)(
        border
      ).alpha(0.5)}`,
      ...
      '--rp-input-placeholder-color': `${(0, chroma_js_1.default)(
        text.primary
      ).alpha(0.5)}`,
      '--rp-input-placeholder-color-disabled': `${(0, chroma_js_1.default)(
        text.primary
      ).alpha(0.5)}`,
      '--rp-input-text-color': `${text.primary}`,
      '--rp-input-text-color-disabled': `${(0, chroma_js_1.default)(
        text.primary
      ).alpha(0.5)}`,
    },
    rpLink: {
    ...
    rpSelect: {
      ...
      '--rp-select-input-placeholder-color': `${(0, chroma_js_1.default)(
        text.primary
      ).alpha(0.5)}`,
    },
    rpStepper: {
      '--rp-stepper-bullet-background-color-disabled': `${background.primary.lightest}`,
      '--rp-stepper-bullet-border-color': `${(0, chroma_js_1.default)(
        background.secondary.regular
      ).alpha(0.1)}`,
      '--rpstepper-bullet-height': '12px',
      '--rpstepper-bullet-width': '12px',
      '--rp-stepper-label-color': `${text.primary}`,
      '--rp-stepper-label-color-light': `${(0, chroma_js_1.default)(
        text.primary
      ).alpha(0.3)}`,
      '--rp-stepper-main-color': `${background.secondary.regular}`,
      '--rp-stepper-main-color-light': `${(0, chroma_js_1.default)(
        background.secondary.regular
      ).alpha(0.1)}`,
      '--rpstepper-stepper-step-label-bottom-margin': '6px',
      '--rpstepper-steps-bar-color-disabled': `${(0, chroma_js_1.default)(
        background.secondary.regular
      ).alpha(0.1)}`,
    ...
    rpTextArea: {
      ...
      '--rp-textarea-bg-color-disabled': `${(0, chroma_js_1.default)(
        background.primary.regular
      ).alpha(0.5)}`,
      '--rp-textarea-border': `1px solid ${border}`,
      '--rp-textarea-border-color-disabled': `${(0, chroma_js_1.default)(
        border
      ).alpha(0.5)}`,
      ...
      '--rp-textarea-placeholder-color': `${(0, chroma_js_1.default)(
        text.primary
      ).alpha(0.5)}`,
...
exports.createReactPolymorphTheme = createReactPolymorphTheme;
// assigns values to all Daedalus CSS variables & returns them
const createDaedalusComponentsTheme = (themeParts) => {
  const { colors, fonts } = themeParts;
  const { background, border, error, focus, text } = colors;
  return {
    aboutWindow: {
      '--theme-about-window-background-color': `${(0, chroma_js_1.default)(
        background.secondary.regular
      ).alpha(0.96)}`,
      '--theme-about-window-header-bottom-border-color': `${(0,
      chroma_js_1.default)(text.secondary).alpha(0.3)}`,
      ...
      '--theme-about-window-content-bottom-border-color': `${(0,
      chroma_js_1.default)(text.secondary).alpha(0.3)}`,
    ...
    automaticUpdate: {
      '--theme-automatic-update-overlay-background-color': `${(0,
      chroma_js_1.default)(background.secondary.regular).alpha(0.96)}`,
      ...
      '--theme-automatic-update-overlay-text-color': `${(0,
      chroma_js_1.default)(text.secondary).alpha(0.7)}`,
      ...
      '--theme-automatic-update-overlay-button-label-color-light': `${(0,
      chroma_js_1.default)(text.secondary).alpha(0.8)}`,
    ...
    connecting: {
      ...
      '--theme-connecting-background-color1': `${(0, chroma_js_1.default)(
        background.secondary.regular
      ).alpha(1)}`,
      '--theme-connecting-background-color2': `${(0, chroma_js_1.default)(
        background.secondary.regular
      ).alpha(0.91)}`,
      '--theme-connecting-background-color3': `${(0, chroma_js_1.default)(
        background.secondary.regular
      ).alpha(0.31)}`,
      '--theme-connecting-background-color4': `${(0, chroma_js_1.default)(
        background.secondary.regular
      ).alpha(0)}`,
      '--theme-connecting-background-color5': `${(0, chroma_js_1.default)(
        background.secondary.regular
      ).alpha(0)}`,
      '--theme-connecting-background-color6': `${(0, chroma_js_1.default)(
        background.secondary.regular
      ).alpha(0.31)}`,
      '--theme-connecting-background-color7': `${(0, chroma_js_1.default)(
        background.secondary.regular
      ).alpha(0.91)}`,
      '--theme-connecting-background-color8': `${(0, chroma_js_1.default)(
        background.secondary.regular
      ).alpha(1)}`,
    ...
    delegationSetupWizard: {
      ...
      '--theme-delegation-steps-success-description-color': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.8)}`,
      ...
      '--theme-delegation-steps-choose-stake-pool-thumb-border-color': `${(0,
      chroma_js_1.default)(border).alpha(0.2)}`,
      '--theme-delegation-steps-choose-stake-pool-title-color': `${text.primary}`,
      '--theme-delegation-steps-choose-stake-pool-tooltip-arrow-color': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.9)}`,
      '--theme-delegation-steps-choose-stake-pool-tooltip-background-color': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.9)}`,
      ...
      '--theme-delegation-steps-choose-stake-pool-tooltip-ticker-color': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.6)}`,
      ...
      '--theme-delegation-steps-choose-wallet-description-color': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.8)}`,
      ...
      '--theme-delegation-steps-choose-wallet-error-message-light-color': `${(0,
      chroma_js_1.default)(error.regular).alpha(0.7)}`,
      ...
      '--theme-delegation-steps-confirmation-description-color': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.8)}`,
      ...
      '--theme-delegation-steps-intro-content-text-color': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.8)}`,
      ...
      '--theme-delegation-steps-intro-list-optional-label-color': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.5)}`,
      '--theme-delegation-steps-not-available-description-text-color': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.8)}`,
    ...
    dialog: {
      ...
      '--theme-dialog-set-wallet-password-background-color': `${(0,
      chroma_js_1.default)(background.primary.regular).alpha(0.96)}`,
      '--theme-dialog-set-wallet-password-box-shadow': `${(0,
      chroma_js_1.default)(background.primary.regular).alpha(0.25)}`,
      '--theme-dialog-set-wallet-password-message-color': `${text.primary}`,
      '--theme-dialog-set-wallet-password-title-color': `${text.primary}`,
      '--theme-dialog-set-wallet-password-button-background-color': `${(0,
      chroma_js_1.default)(background.primary.regular).alpha(0.15)}`,
      ...
      '--theme-dialog-fullsize-background-color': `${(0, chroma_js_1.default)(
        background.secondary.regular
      ).alpha(0.96)}`,
      ...
      '--theme-dialog-fullsize-text-color': `${(0, chroma_js_1.default)(
        text.secondary
      ).alpha(0.7)}`,
    ...
    hardwareWallet: {
      ...
      '--theme-hardware-wallet-status-passphrase-label-color': `${(0,
      chroma_js_1.default)(text.secondary).alpha(0.5)}`,
    },
    icon: {
    ...
    input: {
      ...
      '--theme-input-placeholder-color': `${(0, chroma_js_1.default)(
        text.primary
      ).alpha(0.5)}`,
      '--theme-input-remove-color-light': `${error.regular}`,
      '--theme-input-right-floating-text-color': `${(0, chroma_js_1.default)(
        text.primary
      ).alpha(0.5)}`,
      '--theme-input-right-floating-text-success-color': `${(0,
      chroma_js_1.default)(text.primary).alpha(1)}`,
    ...
    appUpdateOverlay: {
      '--theme-app-update-overlay-background-color': `${(0,
      chroma_js_1.default)(background.secondary.regular).alpha(0.96)}`,
      ...
      '--theme-app-update-overlay-opacity-text-color': `${(0,
      chroma_js_1.default)(text.secondary).alpha(0.7)}`,
    ...
    navDropdown: {
      ...
      '--theme-nav-dropdown-item-background-color-hover': `${(0,
      chroma_js_1.default)(background.primary.regular).alpha(0.07)}`,
    ...
    network: {
      '--theme-network-window-background-color': `${(0, chroma_js_1.default)(
        background.secondary.regular
      ).alpha(0.96)}`,
      ...
      '--theme-network-window-border-color': `${(0, chroma_js_1.default)(
        text.secondary
      ).alpha(0.7)}`,
      '--theme-network-window-button-text-color': `${text.secondary}`,
      '--theme-network-window-button-background-color': `${(0,
      chroma_js_1.default)(background.secondary.lightest).alpha(0.4)}`,
      '--theme-network-window-button-background-color-hover': `${(0,
      chroma_js_1.default)(background.secondary.lightest).alpha(0.6)}`,
      '--theme-network-window-button-background-color-active': `${(0,
      chroma_js_1.default)(background.secondary.lightest).alpha(0.8)}`,
    },
    newsFeed: {
      ...
      '--theme-news-feed-incident-overlay-background-color': `${(0,
      chroma_js_1.default)(background.secondary.regular).alpha(0.96)}`,
      '--theme-news-feed-incident-overlay-text-color': `${text.primary}`,
      '--theme-news-feed-incident-overlay-button-color': `${text.primary}`,
      '--theme-news-feed-incident-overlay-scrollbar-thumb-background': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.3)}`,
      '--theme-news-feed-incident-overlay-scrollbar-thumb-background-hover': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.3)}`,
      '--theme-news-feed-incident-overlay-content-list-color': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.7)}`,
      '--theme-news-feed-incident-overlay-content-background':
        'rgba(0, 0, 0, 0.1)',
      '--theme-news-feed-incident-overlay-button-background':
        'rgba(0, 0, 0, 0.1)',
      '--theme-news-feed-incident-overlay-button-color-hover': `${(0,
      chroma_js_1.default)(background.secondary.regular).alpha(0.96)}`,
      ...
      '--theme-news-feed-incident-grey-overlay-scrollbar-thumb-background': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.3)}`,
      '--theme-news-feed-incident-grey-overlay-scrollbar-thumb-background-hover': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.5)}`,
      '--theme-news-feed-incident-grey-overlay-content-list-color': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.7)}`,
      ...
      '--theme-news-feed-incident-red-overlay-scrollbar-thumb-background': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.3)}`,
      '--theme-news-feed-incident-red-overlay-scrollbar-thumb-background-hover': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.5)}`,
      '--theme-news-feed-incident-red-overlay-content-list-color': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.7)}`,
    },
    newsItem: {
    ...
    notification: {
      '--theme-notification-message-background-color': `${(0,
      chroma_js_1.default)(background.secondary.regular).alpha(0.95)}`,
      ...
      '--theme-legacy-notification-learn-more-button-background-color': `${(0,
      chroma_js_1.default)(background.primary.regular).alpha(0.2)}`,
      '--theme-legacy-notification-learn-more-button-background-color-hover': `${(0,
      chroma_js_1.default)(background.primary.regular).alpha(0.3)}`,
      '--theme-legacy-notification-learn-more-button-background-color-active': `${(0,
      chroma_js_1.default)(background.primary.regular).alpha(0.4)}`,
      ...
      '--theme-legacy-notification-move-button-background-color-hover': `${(0,
      chroma_js_1.default)(background.primary.regular).alpha(0.9)}`,
      '--theme-legacy-notification-move-button-background-color-active': `${(0,
      chroma_js_1.default)(background.primary.regular).alpha(0.8)}`,
    ...
    progressBar: {
      '--theme-progress-bar-background-color': `${(0, chroma_js_1.default)(
        background.primary.light
      ).alpha(0.3)}`,
      '--theme-progress-bar-foreground-color': `${(0, chroma_js_1.default)(
        background.primary.light
      ).alpha(0.7)}`,
    ...
    walletImportDialog: {
      ...
      '--theme-wallet-import-description-close-hover-background': `${(0,
      chroma_js_1.default)(background.secondary.regular).alpha(0.16)}`,
      '--theme-wallet-import-description-color': `${(0, chroma_js_1.default)(
        text.primary
      ).alpha(0.7)}`,
      ...
      '--theme-wallet-import-input-border-color': `${(0, chroma_js_1.default)(
        text.primary
      ).alpha(0.3)}`,
      '--theme-wallet-import-title-color': `${text.primary}`,
      '--theme-wallet-import-stateFolder-border-color': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.5)}`,
      '--theme-wallet-import-stateFolder-button-background-color': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.1)}`,
      '--theme-wallet-import-stateFolder-button-background-color-hover': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.05)}`,
      '--theme-wallet-import-stateFolder-button-background-color-active': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.12)}`,
    ...
    settings: {
      ...
      '--theme-settings-menu-item-text-color-disabled': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.5)}`,
    ...
    sidebar: {
      ...
      '--theme-sidebar-menu-add-button-background-color-active': `${(0,
      chroma_js_1.default)(background.secondary.darkest).alpha(0.66)}`,
      '--theme-sidebar-menu-add-button-background-color-hover': `${(0,
      chroma_js_1.default)(background.secondary.darkest).alpha(0.66)}`,
    ...
    splash: {
      ...
      '--theme-splash-network-scrollbar-thumb-background': `${(0,
      chroma_js_1.default)(text.secondary).alpha(0.3)}`,
      '--theme-splash-network-scrollbar-thumb-background-hover': `${(0,
      chroma_js_1.default)(text.secondary).alpha(0.5)}`,
    ...
    stakePools: {
      ...
      '--theme-staking-stake-pool-saturation-background-color': `${(0,
      chroma_js_1.default)(text.secondary).alpha(0.2)}`,
      ...
      '--theme-staking-stake-pool-tooltip-neutral-background-color': `${(0,
      chroma_js_1.default)(background.secondary.regular).alpha(0.1)}`,
    ...
    staking: {
      ...
      '--theme-staking-font-color-light': `${(0, chroma_js_1.default)(
        text.primary
      ).alpha(0.7)}`,
      '--theme-staking-font-color-lighter': `${(0, chroma_js_1.default)(
        text.primary
      ).alpha(0.5)}`,
      ...
      '--theme-staking-slider-box-shadow-color': `${(0, chroma_js_1.default)(
        background.primary.regular
      ).alpha(0.25)}`,
      ...
      '--theme-staking-wallet-row-ticker-ada-icon-fill-color': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.5)}`,
      ...
      '--theme-staking-dropdown-item-background-color-hover': `${(0,
      chroma_js_1.default)(background.primary.regular).alpha(0.1)}`,
      '--theme-staking-delegation-center-gear-icon-fill-color': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.5)}`,
      ...
      '--theme-staking-countdown-widget-field-label-color': `${(0,
      chroma_js_1.default)(background.primary.light).alpha(0.7)}`,
      '--theme-staking-countdown-widget-field-value-color': `${text.primary}`,
      '--theme-staking-export-button-shadow-color': `${(0, chroma_js_1.default)(
        background.primary.regular
      ).alpha(0.18)}`,
      ...
      '--theme-staking-redeemItnRewards-description-text-color': `${(0,
      chroma_js_1.default)(background.primary.light).alpha(0.7)}`,
    ...
    transactions: {
      ...
      '--theme-transactions-header-texct-color': `${(0, chroma_js_1.default)(
        text.primary
      ).alpha(0.5)}`,
      ...
      '--theme-transactions-filter-title-button-background-color-hover': `${(0,
      chroma_js_1.default)(background.primary.regular).alpha(0.5)}`,
      '--theme-transactions-filter-title-button-background-color-active': `${background.primary.regular}`,
      '--theme-transactions-transfer-funds-selected-wallet-background-color': `${(0,
      chroma_js_1.default)(focus).alpha(0.05)}`,
    },
    uploader: {
    ...
    utxo: {
      '--theme-utxo-background-color': `${(0, chroma_js_1.default)(
        background.primary.regular
      ).alpha(0.5)}`,
      '--theme-utxo-title-text-color': `${text.primary}`,
      '--theme-utxo-title-description-color': `${(0, chroma_js_1.default)(
        text.primary
      ).alpha(0.7)}`,
      '--theme-utxo-bar-color': `${(0, chroma_js_1.default)(
        background.secondary.dark
      ).alpha(0.5)}`,
      '--theme-utxo-label-text-color': `${(0, chroma_js_1.default)(
        text.primary
      ).alpha(0.45)}`,
      '--theme-utxo-tick-text-color': `${(0, chroma_js_1.default)(
        text.primary
      ).alpha(0.45)}`,
      '--theme-utxo-cursor-background-color': `${(0, chroma_js_1.default)(
        background.secondary.lightest
      ).alpha(0.2)}`,
      '--theme-utxo-tooltip-background-color': `${(0, chroma_js_1.default)(
    ...
    voting: {
      ...
      '--theme-voting-font-color-light': `${(0, chroma_js_1.default)(
        text.primary
      ).alpha(0.7)}`,
      '--theme-voting-font-color-regular': `${text.primary}`,
      '--theme-voting-info-background-color': `${(0, chroma_js_1.default)(
        background.primary.darkest
      )}`,
      '--theme-voting-info-font-color': `${(0, chroma_js_1.default)(
        background.primary.darkest
      )}`,
      ...
      '--theme-voting-registration-steps-choose-wallet-error-message-light-color': `${(0,
      chroma_js_1.default)(error.regular).alpha(0.7)}`,
      ...
      '--theme-voting-registration-steps-description-color': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.8)}`,
      '--theme-voting-registration-steps-description-highlighted-color': `${text.primary}`,
      '--theme-voting-separator-color': `${(0, chroma_js_1.default)(
        text.primary
      ).alpha(0.15)}`,
    },
    walletRestoreDialog: {
      '--theme-wallet-restore-dialog-new-label-background-color': `${(0,
      chroma_js_1.default)(background.primary.regular).alpha(0.1)}`,
      '--theme-wallet-restore-dialog-new-label-color': `${(0,
      chroma_js_1.default)(text.primary)}`,
      '--theme-wallet-restore-dialog-step-walletType-hardwareWalletDisclaimer-text-color': `${error.regular}`,
    },
    walletSettings: {
      '--theme-wallet-settings-section-separator-color': `${(0,
      chroma_js_1.default)(text.primary).alpha(0.1)}`,
    },
    walletNotRespondingOverlay: {
      '--theme-wallet-not-responding-background-color': `${(0,
      chroma_js_1.default)(background.secondary.regular).alpha(0.96)}`,
    ...
    widgets: {
      '--theme-widgets-asset-token-background-color': `${(0,
      chroma_js_1.default)(background.primary.regular).alpha(0.5)}`,
      '--theme-widgets-asset-token-fingerprint-background-color': `rgba(${(0,
      chroma_js_1.default)(focus)
        .alpha(0.1)
        .rgba()})`,
...
exports.createDaedalusComponentsTheme = createDaedalusComponentsTheme;
const createTheme = (fullThemeParts) => {
  const { colors: themeColors, config, fonts: themeFonts } = fullThemeParts;
  let daedalusTheme = {};
  let colors = {};
  let fonts = themeFonts;
  if (themeColors && !(0, lodash_1.isEmpty)(themeColors)) {
    colors = {
      ...themeColors,
      error: (0, createShades_1.createErrorShades)(themeColors.error),
      background: {
        primary: (0, createShades_1.createBackgroundShades)(
          themeColors.background.primary
        ),
        secondary: (0, createShades_1.createBackgroundShades)(
          themeColors.background.secondary
        ),
      },
    };
  }
  if (!themeFonts || (0, lodash_1.isEmpty)(themeFonts)) {
    fonts = {
  ...
  if (
    colors &&
    !(0, lodash_1.isEmpty)(colors) &&
    fonts &&
    !(0, lodash_1.isEmpty)(fonts)
  ) {
    daedalusTheme = {
      ...(0, exports.createReactPolymorphTheme)({
      ...
      ...(0, exports.createDaedalusComponentsTheme)({
  ...
  if (config && !(0, lodash_1.isEmpty)(config)) {
    daedalusTheme = (0, exports.updateTheme)(daedalusTheme, config);
  }
