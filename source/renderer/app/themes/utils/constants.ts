...
import { createReactPolymorphTheme, createDaedalusComponentsTheme } from "./createTheme";
...
export const CREATE_THEME_PARAMS = [['cardano.js', CREATE_CARDANO_THEME_PARAMS], ['dark-blue.js', CREATE_DARK_BLUE_THEME_PARAMS], ['dark-cardano.js', CREATE_DARK_CARDANO_THEME_PARAMS], ['flight-candidate.js', CREATE_FLIGHT_CANDIDATE_THEME_PARAMS], ['incentivized-testnet.js', CREATE_INCENTIVIZED_TESTNET_THEME_PARAMS], ['light-blue.js', CREATE_LIGHT_BLUE_THEME_PARAMS], ['shelley-testnet.js', CREATE_SHELLEY_TESTNET_THEME_PARAMS], ['white.js', CREATE_WHITE_THEME_PARAMS], ['yellow.js', CREATE_YELLOW_THEME_PARAMS]];
export const CREATE_THEME_OBJ = { ...createReactPolymorphTheme(CREATE_THEME_MOCK_PARAMS),
