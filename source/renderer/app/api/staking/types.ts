...
export type DelegationAction = "changeDelegation" | "removeDelegation" | "delegate";
...
export type SmashServerStatuses = "available" | "unavailable" | "unreachable" | "no_smash_configured";
