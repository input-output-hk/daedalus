...
import type { TransactionPaymentData, CoinSelectionAmount, TransactionWithdrawalType, VotingMetadataType } from "../types";
...
export const selectCoins = (config: RequestConfig, {
  walletId,
  data
}: SelectCoinsRequestType): Promise<SelectCoinsResponseType> => {
  return request({
    method: 'POST',
