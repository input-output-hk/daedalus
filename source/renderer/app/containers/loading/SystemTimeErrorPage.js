...
const SystemTimeError_1 = __importDefault(
  require('../../components/loading/system-time-error/SystemTimeError')
);
let SystemTimeErrorPage = class SystemTimeErrorPage extends react_1.Component {
  static defaultProps = {
    stores: null,
    actions: null,
  };
  render() {
    ...
    return react_1.default.createElement(SystemTimeError_1.default, {
...
SystemTimeErrorPage = __decorate(
  [(0, mobx_react_1.inject)('stores', 'actions'), mobx_react_1.observer],
  SystemTimeErrorPage
);
exports.default = SystemTimeErrorPage;
//# sourceMappingURL=SystemTimeErrorPage.js.map
