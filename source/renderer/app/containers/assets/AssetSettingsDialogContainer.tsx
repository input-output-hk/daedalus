...
class AssetSettingsDialogContainer extends Component<Props> {
  ...
  handleSubmit = (asset: AssetToken, decimals: number) => {
    const {
      onAssetSettingsSubmit
    } = this.props.actions.assets;
  ...
  render() {
    ...
    return <AssetSettingsDialog asset={editingsAsset} onSubmit={this.handleSubmit} onCancel={assetsActions.onAssetSettingsCancel.trigger} />;
  }
