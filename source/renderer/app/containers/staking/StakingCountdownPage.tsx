...
class StakingCountdownPage extends Component<Props> {
  ...
  render() {
    ...
    return <StakingCountdown redirectToStakingInfo={redirectToStakingInfo} startDateTime={networkStatus.shelleyActivationTime} onLearnMoreClick={this.handleLearnMoreClick} />;
  }
