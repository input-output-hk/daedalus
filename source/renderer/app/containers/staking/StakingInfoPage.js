...
const StakingInfoCountdown_1 = __importDefault(
  require('../../components/staking/info/StakingInfoCountdown')
);
let StakingInfoPage = class StakingInfoPage extends react_1.Component {
  static defaultProps = {
    actions: null,
    stores: null,
  };
  render() {
    ...
    return react_1.default.createElement(StakingInfoCountdown_1.default, {
...
StakingInfoPage = __decorate(
  [(0, mobx_react_1.inject)('stores', 'actions'), mobx_react_1.observer],
  StakingInfoPage
);
exports.default = StakingInfoPage;
//# sourceMappingURL=StakingInfoPage.js.map
