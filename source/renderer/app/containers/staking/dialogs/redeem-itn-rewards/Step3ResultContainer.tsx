...
class Step3ResultContainer extends Component<Props> {
  ...
  render() {
    ...
    if (redeemSuccess) {
      return <Step3SuccessDialog wallet={redeemWallet} transactionFees={transactionFees} redeemedRewards={redeemedRewards} onClose={onClose} onContinue={onResultContinue.trigger} onBack={onBack} />;
    }
