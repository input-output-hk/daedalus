...
class Step2ConfirmationContainer extends Component<Props> {
  ...
  render() {
    ...
    return <Step2ConfirmationDialog wallet={redeemWallet} transactionFees={transactionFees} isSubmitting={isSubmittingReedem} error={confirmationStepError} onClose={onClose} onContinue={onConfirmationContinue.trigger} onBack={onBack} />;
  }
