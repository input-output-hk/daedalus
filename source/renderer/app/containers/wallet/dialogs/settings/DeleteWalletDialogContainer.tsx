...
class DeleteWalletDialogContainer extends Component<Props> {
  ...
  render() {
    ...
    return <WalletSettingsActionConfirmationDialog isTest={isTest} walletName={activeWallet.name} hasWalletFunds={activeWallet.hasFunds} countdownFn={uiDialogs.countdownSinceDialogOpened} isBackupNoticeAccepted={dialogData.isBackupNoticeAccepted} messages={messages} onAcceptBackupNotice={() => updateDataForActiveDialog.trigger({
      data: {
