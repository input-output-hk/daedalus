...
const SuccessDialog_1 = __importDefault(
  require('../../../../components/wallet/wallet-restore/SuccessDialog')
);
const injectedPropsType_1 = require('../../../../types/injectedPropsType');
const DefaultProps =
  injectedPropsType_1.InjectedDialogContainerStepDefaultProps;
let SuccessDialogContainer = class SuccessDialogContainer extends react_1.Component {
  static defaultProps = DefaultProps;
  render() {
    const { stores, actions } = this.props;
    const { walletKindDaedalus, walletKindYoroi } = stores.wallets;
    const { restoreWalletEnd } = actions.wallets;
    return react_1.default.createElement(SuccessDialog_1.default, {
...
SuccessDialogContainer = __decorate(
  [(0, mobx_react_1.inject)('stores', 'actions'), mobx_react_1.observer],
  SuccessDialogContainer
);
exports.default = SuccessDialogContainer;
//# sourceMappingURL=StepSuccessContainer.js.map
