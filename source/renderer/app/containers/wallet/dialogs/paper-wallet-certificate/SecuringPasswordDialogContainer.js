...
let SecuringPasswordDialogContainer = class SecuringPasswordDialogContainer extends react_1.Component {
  static defaultProps = {
    actions: null,
    stores: null,
    children: null,
  ...
  render() {
    ...
    return react_1.default.createElement(SecuringPasswordDialog_1.default, {
...
SecuringPasswordDialogContainer = __decorate(
  [(0, mobx_react_1.inject)('stores', 'actions'), mobx_react_1.observer],
  SecuringPasswordDialogContainer
);
exports.default = SecuringPasswordDialogContainer;
//# sourceMappingURL=SecuringPasswordDialogContainer.js.map
