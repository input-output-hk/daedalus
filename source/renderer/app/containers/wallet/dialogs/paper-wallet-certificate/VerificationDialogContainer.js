...
let VerificationDialogContainer = class VerificationDialogContainer extends react_1.Component {
  static defaultProps = {
    actions: null,
    stores: null,
    children: null,
  ...
  render() {
    ...
    return react_1.default.createElement(VerificationDialog_1.default, {
...
VerificationDialogContainer = __decorate(
  [(0, mobx_react_1.inject)('stores', 'actions'), mobx_react_1.observer],
  VerificationDialogContainer
);
exports.default = VerificationDialogContainer;
//# sourceMappingURL=VerificationDialogContainer.js.map
