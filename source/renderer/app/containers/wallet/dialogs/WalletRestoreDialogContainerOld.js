...
let WalletRestoreDialogContainer = class WalletRestoreDialogContainer extends react_1.Component {
  static defaultProps = {
    actions: null,
    stores: null,
    children: null,
  ...
  render() {
    ...
    return react_1.default.createElement(WalletRestoreDialog_1.default, {
...
WalletRestoreDialogContainer = __decorate(
  [(0, mobx_react_1.inject)('stores', 'actions'), mobx_react_1.observer],
  WalletRestoreDialogContainer
);
exports.default = WalletRestoreDialogContainer;
//# sourceMappingURL=WalletRestoreDialogContainerOld.js.map
