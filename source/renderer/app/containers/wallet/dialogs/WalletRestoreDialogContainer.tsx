...
class WalletRestoreContainer extends Component<Props> {
  ...
  render() {
    ...
    return <Fragment>
        {restoreWalletShowAbortConfirmation && <ConfirmationDialog onConfirm={() => restoreWalletClose.trigger()} onCancel={() => restoreWalletCancelClose.trigger()} />}
        <CurrentContainer onContinue={() => restoreWalletChangeStep.trigger()} onBack={() => restoreWalletChangeStep.trigger(true)} onClose={() => restoreWalletClose.trigger()} />
      </Fragment>;
  }
