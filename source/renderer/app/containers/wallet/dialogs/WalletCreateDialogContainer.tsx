...
class WalletCreateDialogContainer extends Component<Props> {
  ...
  get shouldDisplayAbortAlert() {
    return this.currentStep !== null && (this.currentStep < 0 || this.currentStep > CREATE_WALLET_STEPS.length);
  }
  ...
  render() {
    ...
    return <Fragment>
        {createWalletShowAbortConfirmation && <CreateWalletAbortConfirmation onAbort={this.onAbort} />}
        <CurrentContainer onContinue={this.onContinue} onBack={this.onBack} onClose={this.onClose} />
      </Fragment>;
  }
