...
class SupportSettingsPage extends Component<InjectedProps> {
  ...
  handleSupportRequestClick = async (event: React.SyntheticEvent<HTMLButtonElement>) => {
  ...
  render() {
    ...
    return <SupportSettings onExternalLinkClick={stores.app.openExternalLink} onSupportRequestClick={this.handleSupportRequestClick} onDownloadLogs={this.handleDownloadLogs} disableDownloadLogs={this.props.stores.app.isDownloadNotificationVisible} />;
  }
