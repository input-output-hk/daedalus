...
class Root extends Component<Props> {
  ...
  render() {
    ...
    const isPageThatDoesntNeedWallets = (isStakingPage || isSettingsPage || isVotingPage) && hasLoadedWallets && isConnected;
    ...
    if (isCurrentLocaleSet && areTermsOfUseAccepted && !app.environment.isTest && isSplashShown) {
    ...
    if (isPageThatDoesntNeedWallets && !isNodeInStoppingSequence || isProfilePage && (isNotEnoughDiskSpace || !isNodeInStoppingSequence)) {
      return children;
    }

    if (!isConnected || !hasLoadedWallets || isNotEnoughDiskSpace || !isSystemTimeCorrect || displayAppUpdateOverlay) {
