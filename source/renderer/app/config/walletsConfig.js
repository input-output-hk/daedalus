...
export const WALLET_RESTORE_TYPES = {
  ...
  YOROI_REWARDS: 'yoroi-rewards', // Yoroi rewards wallet
  YOROI_BALANCE: 'yoroi-balance', // Yoroi balance wallet
};
...
export const RECOVERY_PHRASE_WORD_COUNT_OPTIONS = {
  ...
  [WALLET_RESTORE_TYPES.YOROI_REWARDS]: YOROI_WALLET_RECOVERY_PHRASE_WORD_COUNT,
  [WALLET_RESTORE_TYPES.YOROI_BALANCE]: YOROI_WALLET_RECOVERY_PHRASE_WORD_COUNT,
};
