import type { RedeemItnRewardsStep, SmashServerType, DelegationAction } from "../types/stakingTypes";
...
export const SMASH_SERVERS_LIST: Record<SmashServerType, {
  name: string;
  url: string;
}> = {
  iohk: {
...
export const SMASH_URL_VALIDATOR = new RegExp('^(direct|https://[a-zA-Z0-9-_~.]+(:[0-9]+)?/?)$');
