import type { WalletRecoveryPhraseVerificationStatusesType as Status, WalletRecoveryPhraseVerificationTypesType as Type } from "../types/walletRecoveryPhraseVerificationTypes";
