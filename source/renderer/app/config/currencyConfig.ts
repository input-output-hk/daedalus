...
// Available APIS
import coinMarketCapConfig from './currencyConfig.coinmarketcap';
...
// Definitions
export const currencyConfig = coinMarketCapConfig;
...
): ((...args: Array<any>) => any) => async (payload?: any): Promise<any> => {
