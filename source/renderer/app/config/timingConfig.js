...
export const REPORT_ISSUE_TIME_TRIGGER = isTest ? 8 : 5 * 60; // 5 minutes / 10 seconds (isTest = true) | unit: seconds
...
export const MAX_ALLOWED_STALL_DURATION = isTest ? 10000 : 2 * 60 * 1000; // 2 minutes / 5 seconds (isTest = true) | unit: milliseconds
