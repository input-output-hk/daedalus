...
export const HW_SHELLEY_CONFIG = {
  ...
  DEFAULT_DERIVATION_PATH: [HARDENED + SHELLEY_PURPOSE_INDEX, HARDENED + ADA_COIN_TYPE, HARDENED + DEFAULT_ADDRESS_INDEX, 2, 0],
  ABS_DERIVATION_PATH: [HARDENED + SHELLEY_PURPOSE_INDEX, HARDENED + ADA_COIN_TYPE, HARDENED + DEFAULT_ADDRESS_INDEX]
};
export const HW_BYRON_CONFIG = {
  ...
  DEFAULT_DERIVATION_PATH: [HARDENED + BYRON_PURPOSE_INDEX, HARDENED + ADA_COIN_TYPE, HARDENED + DEFAULT_ADDRESS_INDEX, 2, 0],
  ABS_DERIVATION_PATH: [HARDENED + BYRON_PURPOSE_INDEX, HARDENED + ADA_COIN_TYPE, HARDENED + DEFAULT_ADDRESS_INDEX]
};
