import type { RestoreWalletStep, WalletKind, WalletDaedalusKind, WalletYoroiKind, WalletHardwareKind, WalletByronKind, ImportWalletStep } from "../types/walletRestoreTypes";
const {
  isMainnet
} = global.environment;
export const RESTORE_WALLET_STEPS: Array<RestoreWalletStep> = ['type', 'mnemonics', 'configuration', 'success'];
...
export const WALLET_DAEDALUS_KINDS: EnumMap<string, WalletDaedalusKind> = isMainnet ? {
...
export const WALLET_HARDWARE_WORD_COUNT: Record<WalletHardwareKind, Array<number>> = {
