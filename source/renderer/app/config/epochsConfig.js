// @flow
const { isDevelopment, isIncentivizedTestnetSelfNode } = global.environment;
...
export const SLOTS_TOTAL =
  isDevelopment || isIncentivizedTestnetSelfNode ? 150 : 43200;
...
export const EPOCH_LENGTH_ITN = SLOTS_TOTAL * SLOT_DURATION_ITN; // 1 day / 5 minutes (isDevelopment || isIncentivizedTestnetSelfNode = true) | unit: seconds
