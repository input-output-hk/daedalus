...
export const VOTING_REGISTRATION_CAST_START_DATE = new Date('Oct 7, 2021, 11:00 UTC');
export const VOTING_REGISTRATION_CAST_END_DATE = new Date('Oct 21, 2021, 11:00 UTC');
export const VOTING_REGISTRATION_NEW_START_DATE = new Date('Nov 11, 2021, 11:00 UTC');