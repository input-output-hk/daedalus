...
export const ALLOWED_EXTERNAL_HOSTNAMES = [MAINNET_EXPLORER_URL, STAGING_EXPLORER_URL, TESTNET_EXPLORER_URL, DEVELOPMENT_NEWS_URL, MAINNET_NEWS_URL, TESTNET_NEWS_URL, STAGING_NEWS_URL, DEVELOPMENT_NEWS_HASH_URL, MAINNET_NEWS_HASH_URL, TESTNET_NEWS_HASH_URL, STAGING_NEWS_HASH_URL, currencyConfig.hostname];