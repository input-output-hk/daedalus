...
import type { WalletSyncState, SyncStateStatus, DelegationStatus, WalletUnit, WalletPendingDelegations, Discovery } from "../api/wallets/types";
...
export type HwDeviceStatus = "connecting" | "connecting_failed" | "trezor_bridge_failure" | "launching_cardano_app" | "exporting_public_key" | "exporting_public_key_failed" | "ready" | "verifying_transaction" | "verifying_transaction_failed" | "wrong_firmware" | "wrong_cardano_app_version" | "unsupported_device" | "verifying_transaction_succeeded" | "verifying_address" | "verifying_address_confirmation" | "verifying_address_failed" | "verifying_address_aborted" | "verifying_address_succeeded";
...
export default class Wallet {
  ...
  @action
  update(other: Wallet) {
    Object.assign(this, pick(other, ['id', 'addressPoolGap', 'name', 'amount', 'availableAmount', 'reward', 'assets', 'passwordUpdateDate', 'syncState', 'isLegacy', 'delegatedStakePoolId', 'delegationStakePoolStatus', 'lastDelegatedStakePoolId', 'lastDelegationStakePoolStatus', 'pendingDelegations', 'discovery', 'hasPassword', 'walletNotConnected', 'isHardwareWallet']));
  }
  ...
  get isRestoring(): boolean {
    return get(this, 'syncState.status') === WalletSyncStateStatuses.RESTORING && this.restorationProgress < 100;
  }
  ...
  get isNotResponding(): boolean {
    return get(this, 'syncState.status') === WalletSyncStateStatuses.NOT_RESPONDING;
  }
  ...
  get isDelegating(): boolean {
    return this.lastDelegationStakePoolStatus ? this.lastDelegationStakePoolStatus === WalletDelegationStatuses.DELEGATING : this.delegationStakePoolStatus === WalletDelegationStatuses.DELEGATING;
  }
