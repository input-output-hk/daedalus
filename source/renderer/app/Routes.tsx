...
export const Routes = withRouter(() => <Route path={ROUTES.ROOT}>
    <Root>
      <Switch>
        <Route exact path={ROUTES.ROOT} component={() => <Redirect to={ROUTES.WALLETS.ROOT} />} />
        <Route path={ROUTES.PROFILE.INITIAL_SETTINGS} component={InitialSettingsPage} />
        ...
        <Route path={ROUTES.WALLETS.ROOT}>
          <Wallet>
            <Route exact path={ROUTES.WALLETS.ROOT} component={() => <Redirect to={ROUTES.WALLETS.SUMMARY} />} />
        ...
        <Route path={ROUTES.SETTINGS.ROOT}>
          <Settings>
            <Route exact path={ROUTES.SETTINGS.ROOT} component={() => <Redirect to={ROUTES.SETTINGS.GENERAL} />} />
            <Route path={ROUTES.SETTINGS.GENERAL} component={GeneralSettingsPage} />
            <Route path={ROUTES.SETTINGS.WALLETS} component={WalletsSettingsPage} />
            <Route path={ROUTES.SETTINGS.STAKE_POOLS} component={StakePoolsSettingsPage} />
            <Route path={ROUTES.SETTINGS.TERMS_OF_USE} component={TermsOfUseSettingsPage} />
        ...
        <Route path={ROUTES.PAPER_WALLET_CREATE_CERTIFICATE} component={PaperWalletCreateCertificatePage} />
        <Route path={ROUTES.STAKING.ROOT}>
          <Staking>
            <Route exact path={ROUTES.STAKING.ROOT} component={() => <Redirect to={ROUTES.STAKING.DELEGATION_CENTER} />} />
            <Route path={ROUTES.STAKING.COUNTDOWN} component={StakingCountdownPage} />
            <Route path={ROUTES.STAKING.DELEGATION_CENTER} component={DelegationCenterPage} />
          ...
          <Route path={ROUTES.REDEEM_ITN_REWARDS} component={RedeemItnRewardsContainer} />
        </Route>
        <Route path={ROUTES.VOTING.REGISTRATION} component={VotingRegistrationPage} />
      </Switch>
    </Root>
  </Route>);