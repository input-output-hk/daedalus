...
export const getRequestKeys = (param: string, currentLocale: Locale): Request<string> => {
...
export const hasLoadedRequest = (req: Request) => req.wasExecuted && req.result !== null;
export const isRequestSet = (req: Request) => req.result !== null && req.result !== '';