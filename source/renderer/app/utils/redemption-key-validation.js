...
function isValidBase64Url(code: string) {
  try {
    ...
    //  * convert input data from base64url into base64 - as vending was done in a messy
    // way with both base64 and base64 url
    //  * decode base64 with atob - note that atob usually does base64 validity
...
export const isValidRedemptionKey = (code: string) => (
  ...
  // In ada vending phase we were using base64 configured where '=' was always added at the end.
  //  * length of base64 string should be 44 chars long. Its 32 byte decoded data -
  // but this check is more exact becase of optional '=' in base64. See example:
