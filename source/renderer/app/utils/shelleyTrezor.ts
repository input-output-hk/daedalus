...
import { derivationPathToString, CERTIFICATE_TYPE, groupTokensByPolicyId } from "./hardwareWalletUtils";
...
export const prepareTrezorWithdrawal = (withdrawal: CoinSelectionWithdrawal) => {
  return {
