...
const getShortCpuDescription_1 = require('./getShortCpuDescription');
const appleCpus = [
  'Apple M1',
  'Apple M1 Max',
  'Apple M1 Pro',
...
describe('Formatters/formatCpuInfo', () => {
  it('leaves apple processors unchanged', () => {
    appleCpus.forEach((cpu) =>
      expect((0, getShortCpuDescription_1.getShortCpuDescription)(cpu)).toEqual(
        cpu
      )
    );
  });
  it('labels Intel Core i3-i9 processors"', () => {
    ...
    // future-proofing
    expect(
      (0, getShortCpuDescription_1.getShortCpuDescription)(
        'Intel(R) Core(TM) i13'
      )
    ).toEqual('Intel Core i13');
  });
  ...
  it('labels AMD Ryzen processors"', () => {
    ...
    // future-proofing
    expect(
      (0, getShortCpuDescription_1.getShortCpuDescription)('AMD Ryzen 13 2000')
    ).toEqual('AMD Ryzen 13');
  });
  ...
  it('labels AMD A* processors', () => {
    ...
    expect(
      (0, getShortCpuDescription_1.getShortCpuDescription)('AMD A50-1234')
    ).toEqual('AMD A50');
  });
...
//# sourceMappingURL=getShortCpuDescription.spec.js.map
