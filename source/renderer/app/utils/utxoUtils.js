...
exports.getWalletUtxosTotalAmount = exports.getUtxoWalletPrettyAmount = exports.getUtxoChartData = void 0;
const lodash_1 = require('lodash');
const formatters_1 = require('./formatters');
const getUtxoChartData = (histogram) =>
  Object.entries(histogram)
    .sort()
    .reduce((data, [lovelaceWalletAmount, walletUtxosAmount]) => {
      const walletAmount = (0, formatters_1.formattedLovelaceToAmount)(
        parseInt(lovelaceWalletAmount, 10)
      );
      if (walletAmount > 100000) {
        let lastItem = (0, lodash_1.last)(data);
        ...
        data.push({
          ...
          walletAmount: (0, exports.getUtxoWalletPrettyAmount)(walletAmount),
          // @ts-ignore ts-migrate(2345) FIXME: Argument of type 'number' is not assignable to par... Remove this comment to see the full error message
...
exports.getUtxoChartData = getUtxoChartData;
const getUtxoWalletPrettyAmount = (amount) => {
...
exports.getUtxoWalletPrettyAmount = getUtxoWalletPrettyAmount;
const getWalletUtxosTotalAmount = (histogram) => {
...
exports.getWalletUtxosTotalAmount = getWalletUtxosTotalAmount;
