...
export const downloadPaperWalletCertificate = async (
  ...
  // TODO: refactor pdf generation to main process and expose it via ipc channel
  ...
  //
  // const loadAssetFromPath = async (path) => await loadAssetChannel.send({ fileName: path });
  //
