...
export default ((time: number, currentLocale: string, configOverride: Record<string, any> = {}) => {
  const customLocaleConfig = get(configOverride, ['localeConfig', currentLocale]);
