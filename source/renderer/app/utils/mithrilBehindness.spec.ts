...
describe('computeBehindByEpochs', () => {
  ...
  it('falls back to certifiedEpoch when networkTip is missing/non-finite', () => {
  ...
  it('returns undefined when both networkTip and certifiedEpoch are absent', () => {
    expect(computeBehindByEpochs(tip(5), null)).toBeUndefined();
  ...
  it('returns undefined when certifiedEpoch is finite but <= localTip.epoch', () => {
    expect(computeBehindByEpochs(tip(12), null, 12)).toBeUndefined();
    expect(computeBehindByEpochs(tip(12), null, 5)).toBeUndefined();
  });

  it('returns undefined when localTip.epoch is non-finite regardless of anchor', () => {
