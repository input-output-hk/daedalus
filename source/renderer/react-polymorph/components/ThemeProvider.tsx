...
type Props = {
  ...
  isRoot: boolean;
  themeOverrides: Record<string, any>; // custom css/scss from user that adheres to shape of ROOT_THEME_API
};
type State = {
  theme: Record<string, any>;
};
export class ThemeProvider extends Component<Props, State> {
  ...
  _applyThemeOverrides = (
    ...
    componentThemeOverrides: Record<string, any>,
    componentThemeAPI: Record<string, any>
  ) => {
