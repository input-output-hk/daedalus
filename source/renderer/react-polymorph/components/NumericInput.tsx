...
type State = {
  ...
  fallbackInputValue: string | null | undefined;
};
...
class NumericInputBase extends Component<NumericInputProps, State> {
  ...
  onChange = (newValue, event: React.SyntheticEvent<Element<'input'>>) => {
  ...
  isSameValue(
    first: BigNumber.Instance | null | undefined,
    second: BigNumber.Instance | null | undefined
  ) {
