...
module.exports = {
  ...
  plugins: [new webpack.DefinePlugin(Object.assign({
    ...
    'process.env.MOCK_TOKEN_METADATA_SERVER_PORT': process.env.MOCK_TOKEN_METADATA_SERVER_PORT || 0,
    ...
    'process.env.KEEP_LOCAL_CLUSTER_RUNNING': process.env.KEEP_LOCAL_CLUSTER_RUNNING === 'true'
