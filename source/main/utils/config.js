...
exports.readLauncherConfig = void 0;
 ...
 */
const readLauncherConfig = (configPath) => {
  const inputYaml = configPath
    ? (0, fs_1.readFileSync)(configPath, 'utf8')
    : '';
  const parsed = yamljs_1.default.parse(inputYaml);
...
exports.readLauncherConfig = readLauncherConfig;
