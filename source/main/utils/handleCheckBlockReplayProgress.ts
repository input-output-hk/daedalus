...
export const handleCheckBlockReplayProgress = (mainWindow: BrowserWindow, logsDirectoryPath: string) => {
  const checkBlockReplayProgress = async () => {
    ...
    getBlockReplayProgressChannel.send(finalProgressPercentage, mainWindow.webContents);
  };
