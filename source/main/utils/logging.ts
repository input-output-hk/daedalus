...
import type { FormatMessageContextParams, Logger } from "../../common/types/logging.types";
...
const logToLevel = (level: string) => (message: string, data: Record<string, any> | null | undefined) => log[level](formatContext({ ...messageContext,
  level
}), {
  message,
  data,
