...
export const decodeKeystore = async (bytes: Buffer): Promise<EncryptedSecretKeys> => {
...
const toEncryptedSecretKey = ([encryptedPayload, passphraseHash]: [Buffer, Buffer]): EncryptedSecretKey => {
