...
export const winLinuxMenu = (app: App, window: BrowserWindow, actions: MenuActions, translations: {}, locale: string, isNavigationEnabled: boolean, translation: (...args: Array<any>) => any = getTranslation(translations, id)) => [{
  ...
  }, */
  {
    ...
    click() {
      const supportRequestLinkUrl = translation('helpSupport.supportRequestUrl');
