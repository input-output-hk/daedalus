...
export const ALLOWED_NODE_LOGS = new RegExp(/^node\.log\.[1-3]$/);
export const ALLOWED_WALLET_LOGS = new RegExp(/^cardano-wallet\.log\.[1-3]$/);
export const ALLOWED_WATCHDOG_LOGS = new RegExp(/^watchdog\.log\.[1-3]$/);
