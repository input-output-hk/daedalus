...
export const DISK_SPACE_REQUIRED = 2 * 1073741274; // 2Gb | unit: bytes
...
export const DISK_SPACE_CHECK_SHORT_INTERVAL = environment.isTest ? 1000 : 10 * 1000; // 10 seconds | unit: milliseconds
