...
import type { GenerateVotingPDFRendererRequest, GenerateVotingPDFMainResponse } from "../../common/ipc/api";
...
MainIpcChannel<GenerateVotingPDFRendererRequest, GenerateVotingPDFMainResponse> = new MainIpcChannel(GENERATE_VOTING_PDF_CHANNEL);
export const handleVotingPDFRequests = () => {
  generateVotingPDFChannel.onReceive((request: GenerateVotingPDFRendererRequest) => new Promise((resolve, reject) => {
    // Prepare params
    const {
      title,
      currentLocale,
