...
//       // END of try
      ...
      console.debug('>>> getHardwareWalletTransportChannel:: PATH: ', { path, transportList });

      if (!path) return;
      const hw = devicesMemo[path].transport;
      const deviceConnection = devicesMemo[path].AdaConnection;
