...
import type { SubmitBugReportRequestMainResponse, SubmitBugReportRendererRequest } from "../../common/ipc/api";
import { logger } from "../utils/logging";

/* eslint-disable consistent-return */
export const bugReportRequestChannel: // IpcChannel<Incoming, Outgoing>
MainIpcChannel<SubmitBugReportRendererRequest, SubmitBugReportRequestMainResponse> = new MainIpcChannel(SUBMIT_BUG_REPORT_REQUEST_CHANNEL);
export const handleBugReportRequests = () => {
  bugReportRequestChannel.onReceive((request: SubmitBugReportRendererRequest) => new Promise((resolve, reject) => {
