...
import type { CompressLogsRendererRequest, CompressLogsMainResponse } from "../../common/ipc/api";
export const compressLogsChannel: MainIpcChannel<CompressLogsRendererRequest, CompressLogsMainResponse> = new MainIpcChannel(COMPRESS_LOGS_CHANNEL);
export default (() => {
