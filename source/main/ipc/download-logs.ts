...
import type { DownloadLogsRendererRequest, DownloadLogsMainResponse } from "../../common/ipc/api";
import { DOWNLOAD_LOGS_CHANNEL } from "../../common/ipc/api";
export const downloadLogsChannel: MainIpcChannel<DownloadLogsRendererRequest, DownloadLogsMainResponse> = new MainIpcChannel(DOWNLOAD_LOGS_CHANNEL);
export default (() => {
