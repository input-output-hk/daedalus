...
export const privilegedIpcManifest: PrivilegedIpcManifestEntry[] = [
  ...
  ...entries(['WALLET_APPROVAL_RENDER_CHANNEL'], {
    constructorOwner: 'source/main/ipc/walletApproval.ts',
    rendererOwner: 'source/renderer/app/ipc/walletApproval.ts',
    registrationOwner: null,
    capability: 'wallet-approval',
    direction: 'main-to-renderer',
    receive: 'none',
    settlement: 'awaited',
  ...
  ...entries(['WALLET_TRANSACTION_APPROVAL_CHANNEL'], {
    ...
    rendererOwner: 'source/renderer/app/ipc/nativeTransactionApproval.ts',
    registrationOwner: 'source/main/ipc/nativeTransactionApproval.ts',
    capability: 'wallet-approval-control',
  }),
  ...entries(['NATIVE_TRANSACTION_EXECUTE_CHANNEL'], {
    constructorOwner: 'source/main/ipc/nativeTransactionApproval.ts',
    rendererOwner: 'source/renderer/app/ipc/nativeTransactionApproval.ts',
    registrationOwner: null,
    capability: 'native-transaction-executor',
    direction: 'main-to-renderer',
    receive: 'none',
    settlement: 'awaited',
    callerOwners: ['source/main/ipc/nativeTransactionApproval.ts'],
    callerCount: 1,
  }),
