...
const SETTINGS_PAGE_STATUS_SELECTOR = '.WalletRecoveryPhraseWidget_validationStatus';
const SETTINGS_PAGE_BUTTON_SELECTOR = `${SETTINGS_PAGE_STATUS_SELECTOR} .WalletRecoveryPhraseWidget_validationStatusButton`;
