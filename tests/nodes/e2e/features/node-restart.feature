...
Feature: Node Restart
  ...
  Scenario Outline: I restart Cardano Node from the "Diagnostics" screen
    ...
    Then I should not see the "Diagnostic" screen anymore
    Then I should see the loading screen with "Starting Cardano node"
