...
Feature: Wallet currency display settings
  ...
  Scenario: User hits toggle button to show/not show ada wallet balance in other currencys
    ...
    And I am on the "Test Wallet" wallet "summary" screen
    Then The wallet summary screen does not show ada balance in other currencys placeholder
    When I am on the General Settings "wallets" screen
    And I toggle the button on to change if I want to see my ada balance in other currencys
    When I am on the General Settings "wallets" screen
    Then the currency selection box is visible
    And I am on the "Test Wallet" wallet "summary" screen
    Then The wallet summary screen does show ada balance in other currencys placeholder
