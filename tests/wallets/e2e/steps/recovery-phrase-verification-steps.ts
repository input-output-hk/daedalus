...
const SETTINGS_PAGE_STATUS_SELECTOR =
  '.WalletRecoveryPhraseVerificationWidget_status';
...
const DIALOG_VERIFY_BUTTON_SELECTOR =
  '.WalletRecoveryPhraseStepDialogs_dialog button.primary';
Given(
...
When(
  /^I enter the recovery phrase mnemonics (correctly|incorrectly)$/,
...
When(
  /^I enter the "([^"]*)" recovery phrase mnemonics$/,
  async function (_recoveryPhrase) {
