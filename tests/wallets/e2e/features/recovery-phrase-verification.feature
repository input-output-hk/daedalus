...
Feature: Wallet Settings - Recovery Phrase Verification
  ...
  # Scenario Outline: Recovery phrase verification for all wallet kinds
    @watch
  Scenario: Recovery phrase verification for all wallet kinds
    Given I have restored the following wallets:
    ...
    #   | Daedalus-Balance-12 | prison census discover give sound behave hundred cave someone orchard just wild                                                                                                  |
    #   | Daedalus-Rewards-15 | combine mouse cool skirt truck outer result speed fringe sugar there usage lucky wild tail                                                                                       |
    #   | Daedalus-Paper-27   | season nice police near blame dress deal congress unusual more giggle pull general list crash gravity fashion notable voice resemble auto smart flat party thought unique amused |
    #   | Yoroi-Balance-15    | defense brush fiscal cactus rotate trouble mean quantum shrug slight dignity corn immense first citizen                                                                          |
    #   | Yoroi-Rewards-15    | defense brush fiscal cactus rotate trouble mean quantum shrug slight dignity corn immense first citizen                                                                          |
    #   | Hardware-Ledger-12  | struggle section scissors siren garbage yellow maximum finger duty require mule earn                                                                                             |
    #   | Hardware-Ledger-18  | vague wrist poet crazy danger dinner grace home naive unfold april exile relief rifle ranch tone betray wrong                                                                    |
    #   | Hardware-Ledger-24  | recall grace sport punch exhibit mad harbor stand obey short width stem awkward used stairs wool ugly trap season stove worth toward congress jaguar                             |
    #   | Hardware-Trezor-12  | walk license firm dwarf hundred pride ensure midnight unit keen warfare east                                                                                                     |
    #   | Hardware-Trezor-18  | hen idea mimic frog second magnet egg indicate jar girl broccoli heart verify person present toe vibrant unable                                                                  |
    #   | Hardware-Trezor-24  | slot young shoot surround equal trouble rice update rare dinosaur drastic kitten mom actress salon abuse happy satisfy                                                           |
