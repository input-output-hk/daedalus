...
export default {
  ...
  '--theme-transactions-state-failed-background-color': '#3c4c63',
  '--theme-transactions-state-failed-text-color': '#556c8d',
  '--theme-transactions-state-pending-background-color': '#3c4c63',
  '--theme-transactions-state-pending-stripes-color': '#4e6280',
