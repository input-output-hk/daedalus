...
export default class SettingsStore extends Store {
  ...
  constructor(...args) {
    super(...args);
    this.actions.startEditingSettingsField.listen(this._startEditingSettingsField);
    this.actions.stopEditingSettingsField.listen(this._stopEditingSettingsField);
    this.actions.cancelEditingSettingsField.listen(this._cancelEditingSettingsField);
  }
